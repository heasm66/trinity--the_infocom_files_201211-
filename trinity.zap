...
?L7:	CALL2 QUEUED?,I-BEE >STACK
	ZERO? STACK /?L9
	PRINTR "swollen from the bee sting."
...
?L3:	EQUAL? PRSA,V?COVER \?L5
	EQUAL? PRSO,GIRL \?L6
	FSET? PLANES,SEEN \?L8
	PRINTR "You try your best to shield the girl."
?L8:	CALL1 GIRL-SHIES
	RTRUE
...
?L1:	EQUAL? PRSA,V?EXAMINE,V?LOOK-ON,V?SEARCH \?L18
	PRINTI "Aside from your London vacation outfit, you're "
...
?L3:	PRINTR "to do that?"
	...
	EQUAL? PRSA,V?EXAMINE,V?LOOK-ON \?L1
	CALL1 CTHE-PRINT
	PRINTR " below is dark with shadow."
...
?L5:	EQUAL? PRSO,BAG /?L8
	...
	FIRST? PRSO >STACK \?L7
?L8:	CALL YOUD-HAVE-TO,STR?30,PRSO
	RTRUE
...
?L4:	PRINTI "You'll have to take it out of "
	PRINTD POCKET
	PRINTR " first."
...
?L19:	PRINTC CHAR
	...
	PRINTI "["
	PRINT CANT
	PRINTR "tell characters to do that.]"
...
?L6:	CALL2 THE-PRINT,THING
	...
	CALL ALREADY-AT,STR?31,OBJ
	RTRUE

	.FUNCT ALREADY-AT-BOTTOM,OBJ=0
	CALL ALREADY-AT,STR?32,OBJ
	RTRUE
...
?L1:	CALL2 THIS-IS-IT,OBJ
	...
	.FUNCT CANT-SEE-MUCH
	PRINTI "Little can be seen from where you're "
...
?L6:	PRINTD THING
	...
	PRINTI "You couldn't do that from "
...
?L9:	EQUAL? PRSA,V?EXAMINE,V?LOOK-INSIDE \FALSE
	...
	PRINTI "It puffs like steam in the cold air"
	JUMP ?L13
?L11:	PRINTI "It's not cold enough to see "
	PRINTD BREATH
?L13:	PRINT PERIOD
	RTRUE

	.FUNCT TAKE-A-MOMENT-TO,OBJ,STR=0
	PRINTI "Perhaps you should take a moment to examine the "
	ZERO? STR /?L1
	PRINT STR
	JUMP ?L3
?L1:	PRINTD OBJ
?L3:	PRINT PERIOD
	...
	.FUNCT WHICH-WAY-IN
	CALL2 WHICH-WAY,STR?34
	RFALSE

	.FUNCT WHICH-WAY-OUT
	CALL2 WHICH-WAY,STR?35
	RFALSE

	.FUNCT WHICH-WAY-DOWN
	CALL2 WHICH-WAY,STR?36
	RFALSE
...
?L1:	PUT P-LEXV,PTR,WRD
	...
	CALL2 ITALICIZE,STR?37
	PRINTI " manual for the correct way to address characters.]"
	CRLF
	RETURN 2
...
?L160:	EQUAL? I,0,DORY,POCKET /?L156
	...
	LOC I >STACK
	IN? STACK,DORY /?L156
?L158:	PRINTI "You couldn't do that while you're in the dory."
	CRLF
	SET 'V,1
...
?L22:	CALL2 LOOKS-PUZZLED,WINNER
	...
	.FUNCT TALK-TO-SELF
	CALL1 PCLEAR
	PRINTR "[You must address characters directly.]"
	...
	CALL TO-DO-THING-USE,STR?40,STR?39
	RTRUE
...
?L25:	EQUAL? VERB,ACT?FIND \?L26
	PRINTI "You'll have to do that yourself."
	CRLF
	RFALSE
...
?L1:	SET 'VERBOSITY,0
	...
	ZERO? STACK /?L1
	RETURN 2
?L1:	PRINTR "You feel much as you'd expect, considering what you've been through."
...
?L37:	PRINTI "r "
	JUMP ?L46
?L18:	PRINTI "not holding anything, "
	ZERO? WORN? /?L40
...
?L1:	CALL1 PCLEAR
	...
	RETURN 2
?L6:	EQUAL? X,1 \?L10
	CALL2 COMPLETED,STR?45
	RETURN 2
?L10:	CALL2 COMPLETED,STR?44
	CRLF
	CALL1 V-LOOK
	RETURN 2
...
?L1:	PRINTI "[Your score is "
	...
	EQUAL? SCORE,1 /?L6
	PRINTI "s"
?L6:	PRINTI " out of 100, in "
	PRINTN MOVES
	PRINTI " move"
	EQUAL? MOVES,1 /?L9
	PRINTI "s"
?L9:	PRINTI ". This gives you the rank of "
	LESS? SCORE,15 \?L12
	PUSH STR?46
	JUMP ?L16
...
?L1:	LESS? DO-SCORE?,2 \?L5
	...
	JUMP ?L6
?L5:	SET 'DO-SCORE?,1
?L6:	PRINTI "[Score notification o"
	EQUAL? DO-SCORE?,2 \?L7
	PRINTI "ff"
	JUMP ?L9
?L7:	PRINTI "n"
...
?L6:	CALL2 VISIBLE?,WRISTWATCH >STACK
	...
	RTRUE
?L8:	PRINTR "There aren't any clocks visible."
...
?L7:	CRLF
	...
	.FUNCT COPYRIGHT
	PRINTI "Copyright (C)1986 Infocom, Inc. All rights reserved."
	RTRUE
...
?L1:	CALL1 V-BURN-WITH
	...
	EQUAL? PRSI,SHARD \?L1
	CALL1 CTHEI-PRINT
	PRINTI " is phosphorescent. It couldn't possibly "
	PRINTB P-PRSA-WORD
	PRINTR " anything."
?L1:	PRINTI "With "
	CALL2 PRINTA,PRSI
...
?L1:	EQUAL? PRSI,BWOMAN /?L5
	...
	PRINTI " that "
	CALL1 THEI-PRINT
	PRINTR " could sell you anything."
?L5:	FSET? PRSO,BUYABLE /?L6
	PRINT CANT
	PRINTI "possibly buy "
	CALL2 PRINTA,PRSO
...
?L14:	PRINTI "You couldn't charge "
	...
	PRINTI "Your "
	PRINTD CREDIT-CARD
	PRINTR " wouldn't be accepted here."
...
?L3:	PRINT CANT
	...
	PRINTI "You couldn't possibly open "
	CALL2 PRINTA,PRSO
	PRINT PERIOD
	RTRUE
...
?L1:	PRINTR "You only see one."
	...
	CALL1 AXE-HURT
	RTRUE
?L1:	PRINTI "You couldn't possibly cut "
	CALL1 THE-PRINT
	PRINTI " with "
	CALL1 THEI-PRINT
	PRINT PERIOD
	...
	.FUNCT AXE-HURT
	PRINTI "Better not. The axe might "
	FSET? PRSO,LIVING \?L1
	PRINTI "hurt "
	JUMP ?L3
?L1:	PRINTI "ruin "
?L3:	CALL1 THE-PRINT
	...
	CALL1 AXE-HURT
	RTRUE
?L1:	PRINTI "You couldn't possibly rip "
	CALL1 THE-PRINT
	EQUAL? PRSI,HANDS /?L4
	PRINTI " with "
	CALL1 THEI-PRINT
...
?L3:	EQUAL? HERE,IN-JEEP \?L5
	CALL1 HOW?
	RTRUE
?L5:	PRINTR "There's nothing here to drive."
...
?L23:	MOVE OBJ,HERE
	PRINTR "floats quietly on the water."
?L21:	SET 'P-IT-OBJECT,NOT-HERE-OBJECT
	MOVE OBJ,UNDER-WATER
	PRINTI "disappear"
	FSET? OBJ,PLURAL /?L25
	PRINTI "s"
?L25:	PRINTR " beneath the dark water."
...
?L1:	CALL1 LOOK-INTDIR? >STACK
	ZERO? STACK \TRUE
	PRINTI "[Presumably, you mean LOOK AT "
	CALL1 THE-PRINT
...
?L14:	PRINTI " right here"
	JUMP ?L15
?L12:	PRINTI "n't visible at the moment"
?L15:	PRINT PERIOD
	RTRUE
...
?L3:	EQUAL? PRSO,EBAG,SOGGY \FALSE
	PRINTR "The crumbs are all gone."
...
?L3:	CALL NOT-LIKELY,PRSI,STR?59
	RTRUE

	.FUNCT V-SELL
	EQUAL? WINNER,PLAYER /?L1
	CALL NOT-LIKELY,WINNER,STR?60
	RTRUE
?L1:	EQUAL? PRSI,PRSO,ME,WINNER \?L3
	CALL1 IMPOSSIBLE
	RTRUE
?L3:	FSET? PRSI,PERSON /?L4
	CALL NOT-LIKELY,PRSI,STR?61
	RTRUE
?L4:	CALL2 NOT-A,STR?62
	RTRUE
...
?L6:	CALL2 ITS-CLOSED,PRSO
	RTRUE
?L5:	PRINTI "There's nothing behind "
	CALL1 THE-PRINT
	PRINT PERIOD
	RTRUE
...
?L14:	CALL NOT-LIKELY,PRSI,STR?38
	RTRUE
?L12:	PRINTI "You point at "
	...
	.FUNCT V-SHINE-AT
	PRINT CANT
	PRINTI "illuminate anything with "
	CALL2 PRINTA,PRSO
	PRINT PERIOD
	RTRUE
...
?L1:	EQUAL? PRSO,POCKET \?L5
	CALL YOUD-HAVE-TO,STR?71,CLOTHES
	RTRUE
...
?L9:	SET 'P-MULT?,0
	...
	.FUNCT V-PULL
	CALL2 HACK-HACK,STR?72
	RTRUE

	.FUNCT V-PUSH
	CALL2 HACK-HACK,STR?73
	RTRUE
...
?L16:	EQUAL? PRSI,POCKET \TRUE
	...
	CRLF
	CALL1 CTHE-PRINT
	PRINTR " squirms uncomfortably for a moment, then lies still."
...
?L1:	FSET? PRSO,READABLE /?L5
	CALL1 HOW-READ
	PRINTR "?"
?L5:	PRINTR "There's nothing written on it."
...
?L5:	EQUAL? WINNER,PLAYER \?L6
	CALL NOT-LIKELY,PRSI,STR?76
	RTRUE
?L6:	PRINTR "Maybe you ought to do it."
...
?L9:	CALL1 CTHE-PRINT
	CALL1 ISNT-ARENT
?L11:	PRINTR "confined by anything."
...
?L3:	PRINTR "in need of repair."
	...
	.FUNCT V-HELP
	PRINTI "[If you're really stuck, maps and InvisiClues(TM) Hint Booklets are available at most Infocom dealers, or use the order form included in your "
	CALL2 ITALICIZE,STR?37
	PRINTR " package.]"
...
?L9:	PRINTR "n't need any help."
	...
	.FUNCT V-RIDE
	FSET? PRSO,LIVING \?L1
	CALL NOT-LIKELY,PRSO,STR?77
	RTRUE
?L1:	PRINT CANT
	PRINTR "ride that."

	.FUNCT V-TOUCH
	CALL2 HACK-HACK,STR?78
	RTRUE
...
?L3:	CALL1 WASTE-OF-TIME
	...
	.FUNCT V-SHOOT
	PRINT DONT
	PRINTR "have any weapons."

	.FUNCT V-SIT
	EQUAL? PRSO,0,ROOMS \?L1
	EQUAL? HERE,IN-JEEP \?L3
	PRINTR "You're already sitting."
?L3:	EQUAL? HERE,N75 \?L5
	CALL YOUD-HAVE-TO,STR?81,JEEP
	RTRUE
...
?L3:	PRINTI "It smells just like "
	...
	PRINTR "There's barely enough room."
?L3:	PRINTR "You begin to feel a little dizzy."
?L1:	PRINT CANT
	PRINTR "spin that."
...
?L3:	EQUAL? HERE,W100 \?L5
	CALL1 WAKE-DOG
	RTRUE
?L5:	PRINTR "You begin to get a sore throat."
?L1:	CALL NOT-LIKELY,PRSO,STR?38
	RTRUE
...
?L1:	EQUAL? WINNER,PLAYER \TRUE
	...
	CALL1 WONT-HELP
	RTRUE
?L6:	PRINTI "There's no need to thank "
	CALL1 THE-PRINT
	PRINT PERIOD
	RTRUE
...
?L3:	CALL1 IMPOSSIBLE
	...
	ZERO? STACK \TRUE
	EQUAL? PRSO,BAG \?L3
	PRINTR "Better not. The bread crumbs might fall out."
?L3:	EQUAL? PRSO,CRANE,OCRANE,BAD-CRANE /?L5
	EQUAL? PRSO,SOGGY /?L5
	EQUAL? PRSO,EBAG \?L4
	FIRST? PRSO >STACK /?L4
?L5:	CALL NOT-LIKELY,PRSO,STR?84
	RTRUE
...
?L1:	FSET? RBOOT,WORN \?L4
	...
	PRINTI "You put one boot forward"
	PRINT PCR
	CALL2 ITALICIZE,STR?86
	PRINTI " The "
	PRINTD GDESERT
	PRINTI " streaks past in a dizzy rush of color"
	PRINT PCR
	RTRUE
...
?L5:	CALL2 VISIBLE?,PRSO >STACK
	...
	CALL1 IS-ARE
	PRINTR "already here."
?L10:	PRINTR "You may be waiting quite a while."
...
?L6:	PRINTI "You take "
	...
	PRINTI " out of "
	JUMP ?L10
?L7:	FSET? L,SURFACE \?L9
	PRINTI " off "
	JUMP ?L10
?L9:	PRINTI " from "
?L10:	CALL2 THE-PRINT,L
	PRINT PERIOD
	JUMP ?L12
?L5:	RANDOM 100 >STACK
	LESS? 50,STACK /?L11
	...
	JUMP ?L12
?L11:	PRINTI "You "
	EQUAL? P-PRSA-WORD,W?GRAB,W?SEIZE,W?SNATCH \?L13
	PRINTB P-PRSA-WORD
	PRINTC 32
	JUMP ?L16
...
?L4:	SET 'BREATH-HELD?,4
	...
	.FUNCT CLUTCH-THROAT
	PRINTR "You gasp and clutch your throat in the surrounding vacuum."
...
?L1:	ZERO? BREATH-HELD? \?L3
	PRINTR "You'd have to inhale first."
...
?L5:	SET 'BREATH-HELD?,0
	CALL2 DEQUEUE,I-HOLD-BREATH
	PRINTR "You begin to breathe normally."

	.FUNCT NOT-RECOMMENDED
	PRINTR "Not recommended here."

	.FUNCT V-SURFACE
	EQUAL? HERE,UNDER-WATER \?L1
	CALL2 DO-WALK,P?UP
	RTRUE
?L1:	PRINTR "You're not underwater."
...
?L1:	PRINT CANT
	...
	ZERO? TR? \?L3
	FSET? HERE,WINDY /?L1
?L3:	CALL VOICE-MUTTERS,STR?87,0
	RTRUE
?L1:	PRINTR "[Sigh.]"
	...
	ZERO? TR? \?L3
	FSET? HERE,WINDY /?L1
?L3:	CALL VOICE-MUTTERS,STR?88,0
	RTRUE
?L1:	PRINTR "[Yes, this story does recognize crudity.]"
...
?L5:	RETURN FLG
	...
	FSET JWOMAN,NODESC
	CRLF
	PRINTI "A strong gust of wind snatches the "
	PRINTD PARASOL
	PRINTI " out of the "
	PRINTD JWOMAN
	PRINTI "'s hands and sweeps it into the branches of the tree.

The woman circles the tree a few times, gazing helplessly upward. That "
	PRINTD PARASOL
	PRINTI " obviously means a lot to her, for a wistful tear is running down her cheek. But nobody except you seems to notice her loss.

After a few moments, the "
	PRINTD JWOMAN
	PRINTI " dries her eyes, gives the tree a vicious little kick and shuffles away down the "
	PRINTD LNWALK
	PRINT PERIOD
	ZERO? TR? /TRUE
	CRLF
	...
	ZERO? RAID? \?L4
	PRINT PCR
	PRINTI "Passersby begin to gather, craning to see what everyone else is looking at. You hardly notice them. Even when the sirens begin "
	JUMP ?L6
?L4:	PRINTI " for a few moments. Even as the sirens continue "
?L6:	PRINTI "to howl, and the crowd scatters like leaves in the "
	PRINTD EWIND
	PRINTI ", you can't take your eyes off the "
	PRINTD PARASOL
	PRINTI " swaying in the branches, back and forth.
...
?L12:	CRLF
	...
	PRINTD MEEP
	PRINTI " waiting impatiently at your feet"
...
?L21:	PRINTI " to find a "
	PRINTD PRAM
	JUMP ?L24
?L13:	PRINTI ", then hurry off to find a "
	PRINTD BALL
?L24:	PRINTI ". But that slogan keeps echoing over and over in your mind..."
	CALL1 CARRIAGE-RETURNS
	SET 'HERE,THE-END
	MOVE PLAYER,HERE
	CALL1 V-$0024PRAMS
	CRLF
	PRINTI "You've completed the story of "
	CALL2 ITALICIZE,STR?89
	CRLF
	CALL1 FINISH
	RTRUE
...
?L3:	CALL2 DEQUEUE,I-CRANE-APPEARS
	...
	PRINTI " on the "
	PRINTD RPOND
	PRINTI " catches your eye. The "
	CALL1 SAY-WIND
	PRINTI " blows it closer, and you realize that the white sails are actually wings. It's a folded "
	PRINTD CRANE
	PRINTR ", floating just within reach."
...
?L33:	PRINTI ". ""Keep "
	...
	JUMP ?L36
?L34:	PRINTI "it"
?L36:	PRINTR " myself,"" she mutters."
?L25:	FSET BWOMAN,SEEN
	CRLF
	EQUAL? LAYAWAY,1 \?L38
	CALL2 CTHE-PRINT,BWOMAN
	PRINTI " tugs your sleeve impatiently. "
?L38:	PRINTI """Take yer "
	ZERO? COIN? /?L41
	ZERO? BAG? /?L43
...
?L1:	CALL2 VISIBLE?,RUBY >STACK
	ZERO? STACK /FALSE
	ZERO? CR \?L5
	PRINTI "As you start to move away "
	JUMP ?L7
?L5:	CRLF
	PRINT ALLATONCE
?L7:	CALL1 MEEP-GETS-RUBY
	...
	CALL QUEUE,I-MEEP,-1
	SET 'P-IT-OBJECT,NOT-HERE-OBJECT
	PRINTI "a very large bird races out "
	EQUAL? HERE,WABE \?L1
	PRINTI "of the "
	PRINTD THICKET
	JUMP ?L3
...
?L3:	PRINTI ". It "
	IN? RUBY,PRAM \?L4
	PRINTI "leaps into the open pram, "
?L4:	PRINTI "snatches away the "
	...
	PRINT STACK
	JUMP ?L10
?L9:	PRINTI ", scoots between your legs"
?L10:	MOVE RUBY,MEEP
	CALL1 MOVE-MEEP
...
?L11:	FSET? EWIND,SEEN \TRUE
	...
	PRINTR " softens to a whisper and dies away.
...
Blowing leaves settle to the ground, and the trees are still. Then a fresh gust blows in from the west."
	...
	IN? MEEP,HERE \FALSE
	CRLF
	PRINTI "The large bird you saw before is here! You catch a glimpse of the "
	PRINTD RUBY
...
?L5:	FSET? TREE,BORING /?L9
	FSET TREE,BORING
	PRINTI ". If you didn't know better, you'd swear that bird was a "
	PRINTD MEEP
?L9:	PRINT PERIOD
	RTRUE
	...
	CRLF
	PRINT CTHEMEEP
	PRINTI "gives you a curt nod of acknowledgement. Then it flutters off the "
	PRINTD TS6
	PRINTR ", prances through the open door and disappears."
...
?L7:	DEC 'RAID?
	...
	EQUAL? RAID?,9 \?L10
	FSET TREE,TOUCHED
	PRINTI "A steady drone begins to rise above the "
	CALL1 SAY-WIND
	PRINTI ". As it grows louder and more insistent, you recognize a "
	PRINTD SOUND
	PRINTI " you've heard only in old war movies. Air-raid sirens."
	CRLF
	GET QUOTES,THOREAU >DO-WINDOW
	RTRUE
?L10:	EQUAL? RAID?,8 \?L12
	PRINTI "Another siren joins the first"
	ZERO? Q \?L13
	PRINTI ". Tourists search the sky, eyes wide with apprehension"
?L13:	PRINT PERIOD
	EQUAL? HERE,AT-TERRACE \?L16
	IN? BOY,HERE \?L16
	CRLF
	PRINTI "The boy slowly pulls his "
	PRINTD SPHONES
	PRINTI " off and glances furtively around. Then he picks up the dish and races off between the prams."
	CRLF
	CALL1 LAST-BUBBLE
?L16:	CALL1 BOY-SCRAMS
	RTRUE
?L12:	EQUAL? RAID?,7 \?L19
	PRINTI "Sirens are howling all around you"
	ZERO? Q \?L20
	PRINTI ". Children, sensing fear in the air, begin to whimper for their "
	PRINTD NANNIES
?L20:	PRINT PERIOD
	RTRUE
?L19:	EQUAL? RAID?,6 \?L23
	PRINTI "Confused shouts can be heard in the distance"
	ZERO? Q \?L24
	PRINTI ". Worried "
	PRINTD NANNIES
	PRINTI " turn their "
...
?L23:	EQUAL? RAID?,5 \?L27
	PRINTI "Police and fire alarms join in the rising din"
	ZERO? Q \?L28
	PRINTI " as the crowd rushes to escape the open sky of the Gardens"
?L28:	PRINT PERIOD
	RTRUE
?L27:	EQUAL? RAID?,4 \?L31
	PRINTI "Distant megaphones can be heard barking orders"
	ZERO? Q \?L32
	PRINTI ". Frightened "
	PRINTD TOURISTS
...
?L31:	EQUAL? RAID?,3 \?L35
	PRINTI "A round of gunfire drowns out the wailing "
	PRINTD SIRENS
	ZERO? Q \?L36
	PRINTI ". Tourists cover their heads and trample one another in blind panic"
?L36:	PRINT PERIOD
	RTRUE
?L35:	EQUAL? RAID?,2 \?L39
	CALL2 CTHE-PRINT,GROUND
	PRINTI " trembles with the roar of jet interceptors"
	ZERO? Q \?L40
...
?L39:	EQUAL? RAID?,1 \TRUE
	...
	PRINTI "The "
	CALL1 SAY-WIND
	PRINTI " falls silent, and a new star flashes to life over the doomed city."
	CALL1 JIGS-UP
	RTRUE
...
?L3:	EQUAL? HCNT,6 \?L5
	...
	PRINTR " is still. Everything is very quiet."
?L5:	EQUAL? HCNT,5 \?L7
	PUTP LONG-WATER,P?OVERHEAD,MISSILE
	PUTP IN-WATER,P?OVERHEAD,MISSILE
	FSET MISSILE,TOUCHED
	SET 'P-IT-OBJECT,MISSILE
	PRINTI "A gleam overhead catches your eye.

Oh, dear. A "
	PRINTD MISSILE
	PRINTR " is hanging motionless in the sky."
?L7:	EQUAL? HCNT,4 \?L8
	FSET LWDOOR,TOUCHED
	...
	PRINTI " isn't completely motionless. It's falling very, very slowly towards the "
	PRINTD LWATER
	PRINT PCR
	PRINTI "Your eyes follow the "
	PRINTD MISSILE
	PRINTI "'s trajectory downward, where you notice another peculiar phenomenon. It looks like a "
	PRINTD LWDOOR
	PRINTI ", suspended just above the "
	PRINTD CSURFACE
	PRINTR " of the water."
?L8:	EQUAL? HCNT,3 \?L9
	PRINTI "A flock of ravens glides into view! They circle over the "
	PRINTD LWATER
	PRINTI " and disappear through the open "
	PRINTD LWDOOR
	PRINT PCR
	CALL2 CTHE-PRINT,MISSILE
	PRINTR " continues its slow descent."
?L9:	EQUAL? HCNT,2 \?L10
	PRINTI "Swans and ducks paddle through the open "
	PRINTD LWDOOR
	PRINTI ", vanishing without a trace"
	PRINT PCR
	CALL2 CTHE-PRINT,MISSILE
	PRINTR " is only a few dozen yards above the door."
?L10:	EQUAL? HCNT,1 \?L11
	PRINTI "A log is being pushed across the "
	PRINTD LWATER
	PRINTI " by a pair of mallards. Its "
	PRINTD CSURFACE
	PRINTI " is crowded with squirrels, chipmunks and other inhabitants of the "
	PRINTD GARDENS
	PRINTI ", including the "
	PRINTD MEEP
	PRINTI " you met before"
	CALL1 ENTICINGLY
	PRINTI " as the log sails through the "
	PRINTD LWDOOR
	PRINT PCR
	CALL2 CTHE-PRINT,MISSILE
	PRINTR " is closing in fast."
?L11:	CALL2 CTHE-PRINT,MISSILE
	PRINTI "'s nose nudges into the "
	PRINTD LWDOOR
	PRINTI ". Then a searing glare envelops the "
	PRINTD LWATER
	PRINTI ", and you discover what it feels like to be vaporized in extreme slow motion."
	CALL1 JIGS-UP
	RTRUE
...
?L5:	SET 'BREATH-HELD?,0
	...
	PRINTI "You claw your way to the "
	PRINTD CSURFACE
	PRINTI " as "
	PRINTD BREATH
	PRINTI " gives out"
	...
	CALL2 GOTO,IN-CIST
	RTRUE
?L8:	PRINTR "With an involuntary gasp, you begin to breathe normally."
...
?L3:	CALL1 RESET-SHDIRS
	ZERO? V /?L7
	PRINTI "clicks into place at the dial's "
...
?L18:	GET OSIGN-DOORS,OSIGN >DOOR
	...
	PRINTI " on the "
	PRINTD BDIAL
	PRINTI " rotates with a sudden "
	CALL2 ITALICIZE,STR?99
	CRLF
...
?L76:	SET 'P-IT-OBJECT,NOT-HERE-OBJECT
	...
	PRINTI "in the stem "
?L77:	PRINTI "swings shut with a faint creak"
	EQUAL? DOOR,TS0-DOOR /?L82
	FSET? HERE,SHADOWY /?L80
?L82:	FSET DOOR,NOALL
	PRINTI ". You stare in wonder as the door shimmers and fades from view."
	CRLF
...
?L3:	CALL1 EDGE-OF
	...
	CRLF
	FSET? SUN,TOUCHED /?L1
	PRINTI "Shadows lengthen in the gathering dusk. "
?L1:	PRINTI "You pause to watch as the sun touches the "
	ZERO? BW \?L4
	CALL1 SAY-WEST
	JUMP ?L6
?L4:	CALL1 SAY-EAST
?L6:	PRINTI "ern "
	PRINTD HORIZON
	FSET? SUN,TOUCHED \?L7
	PRINTI " and sinks from view, while its mirror image rises in the "
	ZERO? BW \?L9
	CALL1 SAY-EAST
	JUMP ?L11
?L9:	CALL1 SAY-WEST
?L11:	PRINT PERIOD
	RTRUE
?L7:	FSET SUN,TOUCHED
	PRINTI ", painting the clouds with a fiery glow that spreads across the sky.

Wait a minute.

The sky is getting "
	CALL2 ITALICIZE,STR?100
	PRINTI " You rub your eyes and blink as the "
	PRINTD DMOUNTS
	PRINTI " and "
	PRINTD TREETOPS
	PRINTI " magically emerge from darkness, suffused in a golden light swelling somewhere behind you...
...
Another sun is rising! You turn east and west, gaping with astonishment as the twin orbs rise and set in perfect synchronization. For a moment, both are bisected by the "
	...
	PRINTD DSHADOW
	PRINTI "s that cross the ground in fantastic patterns. Then the "
	ZERO? BW \?L13
	CALL1 SAY-WEST
	JUMP ?L15
?L13:	CALL1 SAY-EAST
?L15:	PRINTI "ern sun sinks from view, and the "
	ZERO? BW \?L16
	CALL1 SAY-EAST
	JUMP ?L18
?L16:	CALL1 SAY-WEST
?L18:	PRINTR "ern sun rises to command the morning."

	.FUNCT I-DROP-OAK
	FSET OAK,TOUCHED
	EQUAL? HERE,AT-CHASM \FALSE
	CRLF
	PRINTI "With a leafy whoosh, the "
	PRINTD OAK
	PRINTR " topples away from the chasm and crashes to the ground."
...
?L7:	INC 'ORBCNT
	...
	PRINTI " around you freezes instantly, but remains intact"
	PRINT PCR
?L12:	CALL2 CTHE-PRINT,TS1-DOOR
	PRINTR " drops away behind you."
?L10:	EQUAL? ORBCNT,2 \?L15
	SET 'P-IT-OBJECT,NOT-HERE-OBJECT
	PRINTI "You watch helplessly as the "
	PRINTD TS1-DOOR
	PRINTR " dwindles to a distant speck, vanishing at last between the horns of the rising moon."
...
?L16:	EQUAL? ORBCNT,4 \?L17
	...
	PRINTI "You feel the "
	PRINTD LUMP
	PRINTI " tug in your arms. It's pulling you towards the "
	PRINTD XRAY
	PRINTR "!"
?L17:	EQUAL? ORBCNT,5 \?L21
	...
	PRINTI " twists in your arms as the "
	PRINTD XRAY
	PRINTI " glides past. "
	ZERO? SUITED? \?L24
	PRINTI "It"
...
?L24:	SET 'ON?,1
	...
	PRINTI "You find "
	PRINTD ME
	PRINTI " being yanked out of your old trajectory, into what is obviously a collision course"
	PRINT PCR
	CALL2 ITALICIZE,STR?101
	PRINTI " The "
	PRINTD FILM
	PRINTI " bounces against the "
	PRINTD XRAY
	PRINT PTHE
	PRINTD LUMP
	CALL1 CLANGS
	PRINTI "anchoring the film securely"
?L26:	PRINT PCR
	CALL2 VOICE-MUTTERS,STR?102
?L22:	CALL2 CTHE-PRINT,XRAY
	ZERO? ON? \?L28
	SET 'P-IT-OBJECT,XRAY
	PRINTR " begins to drift away."
?L28:	SET 'P-THEM-OBJECT,THRUSTERS
	PRINTI "'s "
	PRINTD THRUSTERS
	PRINTR " fire briefly to compensate for your added momentum."
...
?L32:	PRINTI "back in the "
	...
	PRINTR " reappears far ahead of you."
?L31:	EQUAL? ORBCNT,7 \?L38
	SET 'P-IT-OBJECT,ICBM
	FSET ICBM,TOUCHED
	PRINTI "A red flash draws your eyes to the ground below, where the contrail of a "
	PRINTD ICBM
	PRINTI " is climbing into the stratosphere."
	CRLF
	ZERO? DOOR /TRUE
	CRLF
	CALL2 CTHE-PRINT,XRAY
	PRINTI " is heading straight for the "
	PRINTD TS1-DOOR
	PRINT PERIOD
	RTRUE
?L38:	EQUAL? ORBCNT,8 \?L42
	...
	PRINTI "distant "
?L43:	PRINTD XRAY
	PRINTI " fire, turning the nose until it faces the ascending "
	PRINTD ICBM
	PRINT PERIOD
	ZERO? DOOR /TRUE
	SET 'P-IT-OBJECT,TS1-DOOR
...
?L42:	CALL2 CTHE-PRINT,XRAY
	PRINTI " erupts in a savage glare that lights up the ground below"
	CALL1 STAR-WARS
	RTRUE

	.FUNCT STAR-WARS
	PRINT PA
	PRINTI "beam of violet radiation flashes downward, obliterating the distant "
	PRINTD ICBM
	PRINTI ". Unfortunately, you have little time to admire this triumph of engineering before the "
	PRINTD XRAY
	PRINTI "'s blast incinerates you."
	CALL1 JIGS-UP
	RTRUE

	.FUNCT CLANGS
	PRINTI " leaps from your grasp and fastens itself to the metal hull, "
	RTRUE
	...
	PRINTI "A "
	PRINTD SBUBBLE
	PRINTI " appears high overhead. It hovers for a moment before it"
	CALL1 SAY-POP
	PRINT PERIOD
	RTRUE
...
?L3:	ZERO? BACTION \?L4
	...
	PRINTI ". Trapped in a whirlpool of suds, you cling helplessly to the boy's wand"
	PRINT PCR
	CALL1 BOY-BLOWS-BUBBLE
	PRINTI ". You find "
	PRINTD ME
	PRINTI " slowly drifting to the ground, enveloped in a "
	PRINTD FILM
...
?L7:	CALL1 BOY-WAITS
	...
	PRINTI " dips the "
	PRINTD WAND
	PRINTI " in the dish and swishes it around"
	RTRUE
	...
	PRINTI " pulls the "
	PRINTD WAND
	PRINTI " out of the dish, puts it to his lips and blows a big "
	PRINTD SBUBBLE
	RTRUE
...
?L8:	EQUAL? VACUUM,2 \?L11
	CALL1 ICE-VAC
	CRLF
	PRINTI "The total lack of air pressure is making you uncomfortable"
	ZERO? X /?L13
	PRINT PTHE
	PRINTD X
	PRINTI " isn't looking too happy, either"
?L13:	PRINT PERIOD
	RTRUE
?L11:	CRLF
	EQUAL? VACUUM,1 \?L17
	PRINTI "Hmm. It seems that your blood is beginning to boil"
	ZERO? X /?L19
	PRINTI ". So is the "
	PRINTD X
	PRINTI "'s, from the look of it"
?L19:	PRINT PERIOD
	RTRUE
?L17:	PRINTI "You lose consciousness just as your internal organs begin to rupture."
	CALL1 JIGS-UP
	RTRUE
...
?L3:	DEC 'SUITED?
	...
	PRINTI " around you"
	EQUAL? SUITED?,3 \?L5
	PRINTR " shimmers with iridescent color."
?L5:	EQUAL? SUITED?,2 \?L7
	PRINTR " is sagging a bit."
?L7:	EQUAL? SUITED?,1 \?L8
	PRINTR " won't hold up much longer."
...
?L25:	PRINTD ICE
	ZERO? GOT \?L28
	PRINTR " slowly melts away. Soon there's nothing left of it."
?L28:	PRINTI " slips from your grasp and "
...
?L31:	EQUAL? HERE,PROM \?L33
	ZERO? IN-DISH? /?L33
	PRINTR "disappears in the water."
?L33:	PRINTR "shatters to bits at your feet."
?L21:	ZERO? SEE /FALSE
	EQUAL? ILIFE,3 \?L37
	CRLF
	PRINTI "The warm air makes the "
	PRINTD ICE
	PRINTR " glisten."
?L37:	EQUAL? ILIFE,2 \?L38
	...
	PRINTD ICE
	PRINTR " is starting to melt."
?L39:	PRINTI "It's getting hard to hold the slippery "
	PRINTD ICE
	PRINT PERIOD
	RTRUE
?L38:	EQUAL? ILIFE,1 \FALSE
	...
	PRINTI " is "
	ZERO? GOT \?L43
	PRINTR "melting away as you watch."
?L43:	PRINTR "almost too slippery to hold."
...
?L8:	FSET? LEM,CHILLY \?L11
	...
	FSET LEM,SEEN
	PRINT CTHELEM
	PRINTI "squirms violently in "
	PRINTD HANDS
	PRINT PERIOD
	RTRUE
?L11:	PRINTI "With a desperate lurch, the "
	PRINTD LEM
	PRINTI " wiggles from your grasp and "
	ZERO? LIT? \?L14
	PRINTI "falls with a "
?L14:	CALL1 FREE-LEM
	RTRUE
...
?L47:	PRINTD LEM
	...
	FSET LEM,SEEN
	FCLEAR LEM,TOUCHED
	PRINTR " cowers in the cage, trembling violently."
?L48:	FSET? LEM,TOUCHED \?L50
	...
	JUMP ?L53
?L51:	PRINTI "s"
?L53:	PRINTR " uneasily around the cage."
?L50:	PRINTI " scramble"
	ZERO? LIT? /?L55
	PRINTI "s"
?L55:	PRINTI " out of the cage and "
	CALL1 FREE-LEM
	RTRUE
...
?L81:	CALL1 FREE-LEM
	...
	.FUNCT SNAKE-LUNCH
	PRINTI "scrambles through the open "
	PRINTD CLOSET-DOOR
	PRINTI ", straight into the fangs of the "
	PRINTD SNAKE
	PRINT PCR
	CALL2 CTHE-PRINT,LEM
	PRINTI " twitches for a while as the venom takes effect. Then the snake drags its prize across the floor, shakes its tail once for effect"
	CALL1 SNAKE-LEAVES
	CALL1 EXIT-LEM
...
?L1:	EQUAL? HERE,CLIFF-EDGE,TOWER-PLAT,ON-TOWER \?L6
	CALL1 EXIT-LEM
	PRINTI "flings itself joyfully off the "
...
?L11:	EQUAL? HERE,IN-GARDEN \?L18
	...
	CALL1 EXIT-LEM
	PRINTI "scurries through the open "
	PRINTD TS4-DOOR
	PRINT PERIOD
	RTRUE
?L19:	CALL2 OUT-THE-DOOR,GARDEN-DOOR
	...
	CRLF
	PRINTI "You hear a faint creak in the "
	PRINTD COTTAGE
	PRINT PERIOD
	RTRUE
?L18:	EQUAL? HERE,SEROOM \?L25
	PRINTI "races"
	PRINT TON
	PRINTI " exit. It skids to a stop at the threshold, flips over and "
...
?L28:	EQUAL? HERE,NWROOM \?L29
	CALL2 SCAMPER-OFF-TO,STR?91
	RTRUE
?L29:	EQUAL? HERE,IN-BATH \?L30
	CALL2 SCAMPER-OFF-TO,STR?98
	RTRUE
...
?L33:	CALL1 EXIT-LEM
	...
	PRINTI ", where you hear a faint creak"
?L1:	PRINT PERIOD
	RTRUE
...
?L1:	FSET? RODENTS,TOUCHED \?L3
	...
	ZERO? CR /?L4
	CRLF
?L4:	PRINTI "Something touches your sneaker.
...
?L11:	PRINTI "north"
	...
	PRINTI "east"
?L14:	PRINTR ", oblivious to you or anything else in their path."
?L7:	ZERO? CR /?L20
...
?L20:	SET 'P-THEM-OBJECT,RATS
	...
	PRINTI "A glare lights up the sky! You look up just in time to see a "
	PRINTD METEOR
...
?L1:	FSET METEOR,SEEN
	...
	PRINTI " disappears below the "
	PRINTD HORIZON
	PRINT PCR
	PRINTI "You feel the ground shudder, and hear a roar like thunder"
	CALL1 ALL-IS-STILL
	RTRUE
...
?L16:	PRINT PERIOD
	...
	RTRUE
?L7:	CRLF
	PRINTI "The bee hovers near the "
	PRINTD TRAP
	PRINTR " for a moment, drawn by the tantalizing aroma. Finding no means of entry, it shrugs its little shoulders and buzzes back to annoy you."
...
?L12:	ZERO? SUITED? /?L13
	...
	PRINTI " hovers uncertainly outside the "
	PRINTD FILM
	PRINTI " for a moment. Then it buzzes with exasperation and launches an assault with its three-inch stinger"
	PRINT PCR
	CALL2 ITALICIZE,STR?103
	CRLF
	RTRUE
...
?L14:	FSET? BEE,SEEN \?L15
	...
	CRLF
	CALL2 CTHE-PRINT,BEE
	PRINTI " evades your flying hands, and plants a second sting right in the middle of your forehead. You scream with blinding agony"
	PRINT PCR
	CALL VOICE-MUTTERS,STR?104,0
	RTRUE
?L15:	CRLF
	PRINTI "With a triumphant buzz, the "
	PRINTD BEE
	PRINTI " sinks its stinger deep into the back of your neck.
...
Your muscles convulse for a while as the accumulated venom eats away at your central nervous system."
	...
	REMOVE BEE
	CRLF
	PRINTI "The sweet smell of the "
	PRINTD TRAP
	PRINTI " stops the bee in mid-buzz. Forgetting its anger, the insect hovers above the open jaws, then touches down to sample the glistening ichor.

"
	CALL2 ITALICIZE,STR?105
	PRINTI " The "
	PRINTD TRAP
	PRINTR " snaps shut. After a few minutes, the faint buzzing dies away."
...
?L4:	EQUAL? L,TUN3 \?L9
	...
	MOVE SKINK,CREVICE
	SET 'P-IT-OBJECT,NOT-HERE-OBJECT
	PRINTI "With a nimble leap, the "
	PRINTD SKINK
	PRINTI " scrambles into the dark "
	PRINTD CREVICE
	PRINT PERIOD
	RTRUE
...
?L15:	FSET? SKINK,SEEN /?L17
	...
	PUT STACK,1,2
	PRINTI " squints forlornly down the east "
	PRINTD TUNNEL
	PRINTI ", blinks and"
?L17:	FSET SKINK,SEEN
...
?L13:	SET 'P-IT-OBJECT,NOT-HERE-OBJECT
	...
	PRINTI " winces in the stab of the "
	PRINTD LAMP
	PRINTI ", and"
...
?L9:	EQUAL? L,CREVICE \?L23
	...
	PRINTI " scrambles out of the lighted "
	PRINTD CREVICE
	PRINTI ", slips between your legs and"
	CALL1 SKINK-TO-TUN2
	IN? LAMP,TUN2 \?L26
...
?L36:	MOVE SKINK,STACK
	CRLF
	CALL2 CTHE-PRINT,SKINK
	PRINTI " blinks helplessly in the "
	CALL2 VISIBLE?,LAMP >STACK
	ZERO? STACK /?L37
...
?L37:	PRINTI "glow of the "
	PRINTD SHARD
?L39:	PRINTI ", and scrambles away down the west "
	PRINTD CAVERN
	PRINT PERIOD
	RTRUE
...
?L45:	EQUAL? L,PLAYER \?L46
	...
	PRINT PERIOD
	RTRUE
?L47:	PRINTI "With a sudden lurch, the "
	PRINTD SKINK
	PRINTI " wiggles out of your grasp and "
	CALL1 FREE-SKINK
	RTRUE
?L46:	CRLF
	CALL2 CTHE-PRINT,SKINK
	PRINTC 32
	EQUAL? L,CAGE \?L51
	PRINTI "squeezes out of the cage and "
	JUMP ?L54
...
?L54:	CALL1 FREE-SKINK
	...
	.FUNCT SKINK-TO-TUN2
	MOVE SKINK,TUN2
	PRINTI " scurries away into the east "
	PRINTD TUNNEL
	RTRUE
	...
	MOVE SKINK,TUN3
	PRINT PA
	PRINTI "moment later it reappears, blinking helplessly from the glow of the "
	PRINTD LAMP
	PRINT PCR
	PRINTI "With no place to hide, the flummoxed "
	PRINTD SKINK
	PRINTR " runs in circles at your feet."
...
?L14:	EQUAL? HERE,IN-CLOSET \?L16
	PRINTI "disappears"
	ZERO? LIT? /?L17
	PRINTI " through a crack in the "
	PRINTD FLOOR
?L17:	PRINT PERIOD
	RTRUE
?L16:	EQUAL? HERE,PROM \?L21
	ZERO? IN-DISH? /?L21
	PRINTI "swims out of the dish and "
?L21:	PRINTI "scurries"
?L20:	PRINT OUTASITE
	RTRUE
...
?L29:	SET 'P-HIM-OBJECT,CHARON
	...
	PRINTR " reappears out of the mist."
...
?L44:	SET 'P-HIM-OBJECT,CHARON
	...
	ZERO? DOCK /?L47
	SET 'P-THEM-OBJECT,SHADES
	PRINTI "A puff of wind ripples the water.

Eddies of sand swirl across the "
	PRINTD BEACH
	PRINTI " and coalesce into ghostly figures of dust and vapor. Before you can think or move, you find "
	PRINTD ME
	PRINTI " amid a gathering of human "
	PRINTD SHADES
	PRINTR ", pale and gaunt, silent as death."
...
?L51:	SET 'P-HIM-OBJECT,CHARON
	...
	PRINTI "The ghostly "
	PRINTD SHADES
	PRINTI " begin to converge on the dory. One by one, they step into the vessel, hand the "
	PRINTD CHARON
	PRINTR " a silver coin, and take a seat."
...
?L55:	SET 'P-HIM-OBJECT,CHARON
	...
	PRINTD SHADES
	PRINTR " seats itself in the crowded dory."
...
?L61:	SET 'P-HIM-OBJECT,CHARON
	PRINTI "With practiced skill, the "
	PRINTD CHARON
	PRINTI " pushes his "
	ZERO? DOCK /?L64
	SET 'P-THEM-OBJECT,SHADES
...
?L75:	PRINTR "glide across the river, vanishing at last into obscurity."

	.FUNCT DORY-APPEARS
	CRLF
	PRINTI "As you peer across the river you notice a lone vessel gliding out of the fog"
	RTRUE

	.FUNCT MAKE-OUT-CHARON
	PRINTI ". You can make out a dark "
	PRINTD CHARON
	PRINTR " at the stern."

	.FUNCT SOUNDLESS-LANDING
	CALL2 CTHE-PRINT,CHARON
	PRINTI " guides his dory to a "
	PRINTD SOUND
	PRINTI "less "
	PRINTD LANDING
	RTRUE
	...
	PRINTD SHADES
	PRINTI " slink out of the vessel and drift across the sand like leaves on a breath of wind"
	RTRUE
	...
	CALL2 CTHE-PRINT,CHARON
	EQUAL? PATIENCE,1 \?L4
	PRINTR " stretches out his palm with growing impatience."
?L4:	PRINTI " points you in the "
	PRINTD INTDIR
	PRINTI " of the "
	PRINTD BEACH
	PRINT PA
	PRINTI "swift kick encourages you to visit it quickly."
	CRLF
	CALL1 EXIT-DORY
	RTRUE
...
?L1:	ZERO? FCOUNT /?L4
	...
	SET 'P-IT-OBJECT,FIN
	CRLF
	PRINTI "A gray fin is gliding across the "
	PRINTD LAGOON
	PRINT PERIOD
	RTRUE
?L7:	IN? FIN,HERE /?L8
	...
	PRINTR " reappears just offshore."
?L8:	EQUAL? FCOUNT,1 \?L9
	ZERO? CR /?L10
	CRLF
?L10:	PRINTR "The gray fin glides closer."
?L9:	SET 'FCOUNT,0
	REMOVE FIN
	MOVE FLIPPER,HERE
	...
	ZERO? CR /?L14
	CRLF
?L14:	PRINTI "With a sudden splash, the gray fin shoots upward! You shriek and cover your face with "
	PRINTD HANDS
	PRINTI "s as a mouthful of sharp teeth leaps from the "
	PRINTD LAGOON
	PRINTI "...

A friendly chatter encourages you to open your eyes. It's a bottle-nosed "
	PRINTD FLIPPER
	PRINTR ", standing on its tail just offshore."
?L4:	IN? FLIPPER,HERE /?L17
	...
	PRINTR " glides into view nearby."
?L17:	ZERO? CR /?L21
	RANDOM 100 >STACK
	LESS? 50,STACK /FALSE
	CRLF
?L21:	FSET FLIPPER,SEEN
	...
	CRLF
	PRINTI """Five. Four. Three. Two. One."""
	CRLF
?L3:	CRLF
	PRINTI "Your tropical vacation is cut short by a multimegaton thermonuclear detonation, centered in the nearby "
...
?L9:	EQUAL? HERE,ON-SCAFFOLD,AT-SDOORS /?L46
	...
	PRINTI "A wave washes up underfoot. It looks as if the tide is rising."
	CRLF
	JUMP ?L17
?L15:	PRINTI "The "
	ZERO? W /?L18
	...
	JUMP ?L20
?L18:	PRINTD BEACH
?L20:	PRINTI " is shrinking in the rising tide."
	CRLF
...
?L14:	EQUAL? MINUTES,55 \?L21
	...
	CRLF
	PRINTI "A faint "
	CALL2 ITALICIZE,STR?106
	PRINTI " draws your eyes to the "
	PRINTD ISLET
	PRINTI ". There's now a "
	PRINTD COCO
	PRINTR " lying at the water's edge."
?L22:	ZERO? W /FALSE
	EQUAL? SECONDS,45 \FALSE
	CRLF
	PRINTI "The tide creeps towards the "
	PRINTD COCO
	PRINTI " under the distant tree."
	CRLF
	CALL1 BURNS-QUOTED?
	RTRUE
?L21:	EQUAL? MINUTES,56 \?L29
	...
	PRINTI " floats away from the distant "
	PRINTD ISLET
...
?L29:	EQUAL? MINUTES,57 \?L37
	...
	CRLF
	PRINTI "The tide is making the sand squishy."
	CRLF
	ZERO? W /?L40
	FSET? COCO,CHILLY \?L40
	CRLF
	CALL2 CTHE-PRINT,COCO
	PRINTI " floats further away. It's almost"
	PRINT OUTASITE
...
?L53:	EQUAL? MINUTES,59 \?L54
	...
	PRINTR "forty-five seconds."""
?L55:	EQUAL? SECONDS,30 \?L57
	PRINTR "thirty seconds."""
?L57:	PRINTR "fifteen seconds. Personnel not issued protective goggles should face away from Zero at this time."""
...
?L6:	CALL QUEUE,I-NAGASAKI,-1
	...
	PRINTI " below draws closer. You glimpse a river, railroad tracks, streets busy with horses and bicycles, a "
	PRINTD PGROUND
	PRINTI ".."
	PRINT PCR
	ZERO? SUITED? /?L11
	...
	PRINTI "! The "
	PRINTD FILM
	PRINTI " holding you aloft disappears in a spray of color"
...
?L15:	SET 'IN-SAND?,1
	...
	RTRUE
?L4:	PRINTI "The wind in your ears becomes a roar as you plunge faster towards the city below. You close your eyes for the last few hundred feet."
	CALL1 JIGS-UP
	RTRUE
...
?L15:	PRINT ALLATONCE
	...
	JUMP ?L20
?L18:	PRINTD SKY
?L20:	PRINTI " is lit by a terrifying flash of light. You dive "
	IN? GIRL,HERE \?L21
	PRINTI "to cover the screaming "
	PRINTD GIRL
	PRINTI ", and feel the earth shudder beneath a crushing blast wave.
...
Your body absorbs much of the deadly radiation that might otherwise have reached the child. Years later, she recalls to her grand"
	PRINTD CHILDREN
	PRINTI " the tale of a mysterious stranger who shielded her life at "
	PRINTD NAGASAKI
	JUMP ?L23
?L21:	PRINTI "for cover, but never make it to the ground"
?L23:	PRINTI "."
	CALL1 JIGS-UP
	RTRUE
?L14:	EQUAL? MINUTES,1 \FALSE
	...
	CRLF
	PRINTI "You've noticed a faint "
	PRINTD SOUND
	PRINTI " coming from somewhere"
	CALL1 OVER-OR-OUT
	IN? GIRL,HERE \?L26
	FSET GIRL,SEEN
	PRINT PTHE
	PRINTD GIRL
	PRINTI " turns to stare at the "
	ZERO? S /?L28
	PRINTD CEILING
	JUMP ?L30
?L28:	PRINTD SKY
...
?L26:	ZERO? S \?L31
	...
	PRINTI " and "
	PRINTD TEACHERS
	PRINTR " stop to stare at the sky."
?L31:	PRINT PERIOD
	RTRUE
...
?L34:	CALL2 CTHE-PRINT,SOUND
	CALL1 OVER-OR-OUT
	PRINTI " grows louder. There's no mistaking the drone of "
	PRINTD PLANES
	PRINT PERIOD
	IN? GIRL,HERE \?L37
	FSET GIRL,SEEN
	...
	PRINTI " looks at you expectantly and "
	ZERO? S /?L39
	PRINTI "crouches down in a "
	PRINTD CORNER
	PRINTI " of "
	JUMP ?L41
?L39:	PRINTI "tries to pull you towards "
...
?L47:	PRINTI "The drone of the "
	...
	PRINTI " increases. It "
	PRINTD SOUND
	PRINTI "s as if they're in a power dive."
	CRLF
	IN? GIRL,HERE \?L50
	FSET GIRL,SEEN
	CRLF
	CALL2 CTHE-PRINT,GIRL
	PRINTR " covers her ears with her hands and whimpers."
?L50:	ZERO? S \TRUE
	CALL1 TEACHERS-COME
	RTRUE

	.FUNCT GIRL-APPEARS
	PRINTI "A little girl races between the "
	PRINTD SWINGS
	PRINTI ", hot on the trail of a dragonfly. She trips and sprawls across the sand, laughing with hysterical glee. Then she sees you."
	CRLF
	CALL1 GIRL-SEES-YOU
	RTRUE
	...
	CRLF
	PRINTI "At first, you're sure she's going to scream. Her eyes dart back and forth between you and the "
	PRINTD TEACHERS
	PRINTI "; you can see a cry forming on her lips."
	CRLF
	IN? PARASOL,GIRL \?L1
	SET 'P-IT-OBJECT,PARASOL
	MOVE PARASOL,PLAYGROUND
	CRLF
	PRINTI "Suddenly, she remembers the "
	PRINTD PARASOL
	PRINTR " in her hands. Her expression changes from fear to embarrassment. With a red face, she lays the thing at your feet."
...
?L6:	PRINTR " catches her eye. You watch her expression soften from fear to curiosity."
...
?L1:	PRINTI " overhead"
	...
	.FUNCT TEACHERS-COME
	CRLF
	PRINTI "Muttering with exasperation, the "
	PRINTD TEACHERS
	PRINTI " drop their "
	PRINTD SPADE
	PRINTI "s and begin to trudge in the "
	PRINTD INTDIR
	PRINTI " of the "
	PRINTD SHELTER
	PRINT PERIOD
...
?L1:	IN? GIRL,HERE /?L9
	...
	ZERO? S /?L10
	FCLEAR GIRL,CHILLY
	PRINTI " appears in the doorway "
	JUMP ?L12
?L10:	PRINTI " silently follows you out "
?L12:	PRINTI "of the "
	PRINTD SHELTER
	PRINT PERIOD
	RTRUE
?L9:	SET 'P-HER-OBJECT,GIRL
	...
	CRLF
	PRINTI "A little girl is crouched in the "
	PRINTD SPILE
	IN? PARASOL,GIRL \?L16
	PRINTI ", playing with the "
	PRINTD PARASOL
?L16:	PRINTI ". She leaps to her feet as you appear."
	CRLF
	CALL1 GIRL-SEES-YOU
	RTRUE
...
?L26:	PRINTI "towards the "
	PRINTD TEACHERS
	PRINTR " and begins to whimper."
?L25:	PRINTI "With a sudden yelp of fright, the girl races"
	ZERO? S /?L30
...
?L17:	CALL QUEUE,I-MCRANE,-1
	...
	CRLF
	PRINTI "Something twitches in "
	PRINTD HANDS
	PRINT PCR
	CALL2 CTHE-PRINT,CRANE
	PRINTI " is "
	CALL2 ITALICIZE,STR?109
	PRINTR " The wings and tail are unfolding like the petals of a flower, the long neck craning further and further out of the expanding body...
...
You drop the demonic thing with a yelp of dismay. In moments, it opens up into a monstrous construction of folded paper the size of a foreign car."
	...
	CRLF
	PRINTI "A gust of wind outside blows dust into the "
	PRINTD SHELTER
	PRINT PERIOD
	RTRUE
...
?L6:	CALL2 CTHE-PRINT,MCRANE
	PRINTI " looks at you once more with a sad expression. Then, with a stroke of its paper wings, the creature lifts itself into the sky.

When the dust clears, the "
	PRINTD CRANE
	PRINTR " is nowhere to be seen."
...
?L10:	SET 'P-IT-OBJECT,MCRANE
	...
	EQUAL? MCOUNT,1 \?L12
	PRINTI " beats its paper wings a few times, raising a whirlpool of dust"
	PRINT AS-IF
	PRINTR "it's getting ready to fly!"
?L12:	EQUAL? MCOUNT,2 \?L14
	PRINTR " beckons to you with a friendly wing."
?L14:	PRINTR " turns to look at you. Though the paper face is utterly featureless, you somehow get the feeling that it likes you."
...
?L1:	EQUAL? MCOUNT,2 \?L4
	...
	PUTP ON-BIRD,P?OVERHEAD,PLANES
	CALL2 CTHE-PRINT,MCRANE
	PRINTI " soars high over the city, banking left and right with effortless grace. You hear the rhythmic pump of its great wings, wind whipping past your ears... and, far overhead, the drone of approaching "
	PRINTD PLANES
	PRINT PCR
	FSET? TS5-DOOR,OPENED \?L6
	FSET? TS5-DOOR,NOALL /?L6
	PRINTI "A speck in the sky grows into the familiar outline of the "
	PRINTD TS5-DOOR
	PRINT PTHE
	PRINTR "bird circles once, slows to a stall and hovers only a few feet from the threshold."
?L6:	PRINTI "Your companion circles back and forth, searching for a door it cannot find. "
	CALL1 SAY-DRONE-LOUDER
	CRLF
	CALL2 CTHE-PRINT,FATMAN
	PRINTI " disappears in a burst of light that vaporizes the bird, the city and you."
	CALL1 JIGS-UP >STACK
	RSTACK
...
?L9:	CALL2 CTHE-PRINT,FATMAN
	PRINTI " shatters the "
	PRINTD TS5-DOOR
	PRINTI ", then promptly envelops the bird, the city and you in a flash of nuclear fire."
	CALL1 JIGS-UP
	RTRUE
	...
	PRINTD PLANES
	PRINTR " becomes a roaring power dive; and a new object appears in the sky, falling towards you at great speed.
...
?L5:	MOVE MILK,L
	...
	ZERO? CR /?L14
	CRLF
?L14:	PRINTI "Liquid dribbles out of the "
	PRINTD OCOCO
	PRINT PERIOD
	RTRUE
	...
	ZERO? CR /?L5
	CRLF
?L5:	PRINTI "With a deafening blast, the "
	PRINTD CAULDRON
	PRINTI " vomits up a volcano of energy that cremates you instantly."
	CALL1 JIGS-UP
	RTRUE
...
?L15:	CALL2 DEQUEUE,I-EXPLODE
	...
	ZERO? CR /?L21
	CRLF
?L21:	CALL2 ITALICIZE,STR?110
	PRINTR " A powerful concussion sends you sprawling. Your ears ring as you regain your feet."
...
?L29:	PUSH COTTAGE
?L31:	PRINTD STACK
	PRINTI " grows to a shuddering roar that shakes the "
	EQUAL? HERE,IN-COTTAGE \?L32
	PUSH COTTAGE
	JUMP ?L34
?L32:	PUSH GROUND
?L34:	PRINTD STACK
	PRINTR " with power. It feels as if something's about to explode!"

	.FUNCT I-WHOOSH
	SET 'P-IT-OBJECT,RBOOT
	CRLF
	PRINTR "Your boots are tingling with energy."
...
?L5:	SET 'P-IT-OBJECT,LANDING
	...
	EQUAL? LLIFE,1 \?L8
	PRINTR " is sagging dangerously. It's not going to last much longer!"
?L8:	EQUAL? LLIFE,2 \?L10
	PRINTR " emits a wooden moan of discomfort."
?L10:	PRINTR " creaks under your weight. It isn't in very good shape."
...
?L19:	ZERO? FOOD /?L22
	...
	FSET? DOG,WINDY \?L24
	FCLEAR DOG,WINDY
	PRINTI "raises its head and sniffs the air. You stifle a sigh of relief as it abandons the dog, trots back to your side and "
?L24:	CALL1 SAY-PECKS
	RTRUE
...
?L32:	PRINT CTHEMEEP
	...
	FCLEAR MEEP,TOUCHED
	PRINTR "pecks angrily at your fingers with its sharp beak. Ouch!"
?L35:	PRINTI "struggles out of your grasp and "
	CALL1 MEEP-ESCAPES
	RTRUE
...
?L50:	PRINT CTHEMEEP
	CALL1 SEE-SNAKE? >STACK
	ZERO? STACK /?L53
	PRINTR "cowers in a corner of the cage, trembling violently."
?L53:	ZERO? FOOD /?L55
	CALL1 SAY-PECKS
	RTRUE
?L55:	EQUAL? L,CAGE \?L56
	...
	FCLEAR MEEP,TOUCHED
	PRINTR "flutters anxiously around the cage."
...
?L60:	PRINT CTHEMEEP
	CALL1 SEE-SNAKE? >STACK
	ZERO? STACK /?L63
	PRINTI "trembles at the sight of the "
	PRINTD SNAKE
	PRINT PERIOD
	RTRUE
?L63:	ZERO? FOOD /?L65
...
?L122:	FSET SNAKE,BORING
	PRINTI " and freezes. Tension mounts as snake and bird study one another, their eyes bright with familiar hatred.

Suddenly the "
	PRINTD MEEP
	PRINTI " explodes into action! It dances around the snake, fluttering off the walls as it tries to grab the hissing reptile in its beak. But the room isn't big enough to support this style of attack; and after a few very close calls, the "
	PRINTD MEEP
	PRINTI " abandons the fray"
?L124:	PRINTR " and retreats with a squall of frustration."
?L118:	MOVE MEEP,HERE
	CALL1 MEEP-ARRIVES
	RTRUE
...
?L3:	PRINTI "notices the "
	...
	PRINTI ", drops "
	CALL2 THE-PRINT,X
?L4:	PRINTR " and perches on its massive head. You stifle a shriek as the silly bird cocks its head this way and that, wondering what to make of the sleeping monster. Then it gives you a sly glance, ruffles its feathers and begins to peck at the sand fleas behind the dog's ears."
?L1:	PRINTI "remembers an especially tasty sand flea, returns to the dog's head and continues pecking where it left off"
	PRINT PCR
	CALL1 LAST-PECK
	RTRUE

	.FUNCT LAST-PECK
	PRINTI "The shepherd lifts an eyelid and peeks up at the bird"
	FSET? DOG,WINDY \?L1
	PRINTI " perched on its head"
?L1:	PRINTI ". Its expression hardens from sleepy distraction to annoyance... and then to outrage!

In a single motion, the monster bounds to its feet and snaps at the "
	PRINTD MEEP
	PRINT PTHE
	PRINTI "bird digs deep and holds on for dear life as the dog whirls in a frenzied circle, trying to throw off the squalling pest.
...
?L3:	EQUAL? HERE,IN-JEEP \?L4
	MOVE MEEP,N75
	PRINTR "leaps out of the jeep."
?L4:	CALL1 SEE-SNAKE? >STACK
	ZERO? STACK /?L5
	MOVE MEEP,SEROOM
	PRINTI "narrowly escapes the fangs of the "
	PRINTD SNAKE
	PRINTR ". It races away with a fearful squawk."
...
?L19:	ZERO? DOOR /?L21
	...
	PRINTI ". It gives you a sly glance before it "
...
?L11:	EQUAL? HERE,IN-SHACK,TOWER-PLAT,ON-TOWER \?L28
	...
	PRINTI "to the west"
	JUMP ?L31
?L29:	PRINTI "over the side of the "
	PRINTD PLATFORM
?L31:	PRINT PCR
	PRINTR "You hear a flurry of wings that quickly fades."
?L28:	FCLEAR DOG,WINDY
	MOVE MEEP,HERE
	FSET MEEP,SEEN
	SET 'P-IT-OBJECT,MEEP
	ZERO? LIT? \?L33
	PRINTR "scratches around in the darkness."
...
?L6:	FSET? L,OPENED /?L7
	...
	PRINTI " inside "
	CALL2 THE-PRINT,L
	PRINTR ", and blinks at it hungrily."
?L7:	MOVE MEEP,L
...
?L3:	SET 'P-IT-OBJECT,SNAKE
	...
	PRINTI " lurks just outside the open door"
	JUMP ?L9
?L7:	CALL2 PICK-NEXT,SNAKE-DOINGS >STACK
	PRINT STACK
?L9:	PRINT AS-IF
	PRINTR "it's about to strike!"
?L5:	FSET ANKLE,SURFACE
	CALL QUEUE,I-BITTEN,1
	CALL2 CTHE-PRINT,SNAKE
	PRINTI " strikes "
	PRINTD ANKLE
	PRINTI " like lightning, recoils in an instant"
	CALL1 SNAKE-LEAVES
	CRLF
	PRINTI "Sobbing with pain and shock, you peer at the tender wound. "
	CALL2 ITS-ALREADY,STR?111
	RTRUE
	...
	ZERO? CR /?L1
	CRLF
?L1:	PRINTI "The throbbing fire in your ankle overcomes you. Moaning with despair, you sink helplessly to the "
...
?L3:	EQUAL? HERE,TUN1 \?L6
	...
	PRINTI " erupts "
	JUMP ?L8
?L6:	PRINTI "For a brief moment, the "
	PRINTD TUNNEL
	PRINTI " is bathed "
?L8:	PRINTI "in a raw white glare."
	CALL1 JIGS-UP
	RTRUE
...
?L21:	FSET? WTK,SHADOWY /?L24
	FSET WTK,SHADOWY
	PRINTI "A tinny voice, half-buried in static, says "
?L24:	PRINTI """"
	SUB 60,MINUTES >STACK
...
?L1:	FSET? HERE,INDOORS /FALSE
	...
	CALL2 CRACKLES,STR?112
	CALL1 FIVE-MINUTE-WARNING
?L6:	CALL1 FIRST-SEE-FLARE
	PRINTR " curves in a graceful arc and fades."
?L4:	EQUAL? MINUTES,27 \?L9
	EQUAL? HERE,S100,W100 \?L10
	CALL2 CRACKLES,STR?113
	CALL1 TWO-MINUTE-WARNING
	EQUAL? HERE,W100 \?L12
	CALL1 HINGE-SQUEAK
	RTRUE
?L12:	CRLF
	PRINTI "The GIs hurry out of their jeeps and take cover in some "
	PRINTD TRENCHES
	PRINTI " nearby."
	CRLF
...
?L16:	FSET FLARE,CHILLY
	...
	PRINTI "Another "
	PRINTD FLARE
	PRINTI " arcs across the sky,"
?L18:	PRINTR " sputters prematurely and blinks out."
...
?L23:	PRINTI "second "
?L25:	PRINTD FLARE
?L22:	PRINTR " arcs across the sky and disappears."

	.FUNCT HINGE-SQUEAK
	CRLF
	PRINTI "A hinge squeaks on the far side of the "
	PRINTD BHOUSE
	IN? DOG,W100 \?L1
	PRINTI ". ""It's time, Wolf!"" calls a voice"
?L1:	PRINTI ". You stumble down the road, away from the crunch of footsteps."
	CRLF
	CALL1 HOLD-IT
	CALL1 KINDA-SPY
	CALL1 SURROUNDED
	...
	FCLEAR FLARE,NODESC
	CRLF
	PRINTI "A distant glare lights the "
	PRINTD GDESERT
	PRINTI "! You watch as a rocket "
	PRINTD FLARE
	...
	PRINTI "cracks in the north wall are"
	CALL1 BLIGHT
	JUMP ?L14
...
?L14:	PRINTI "! You jam "
	PRINTD HANDS
	PRINTI "s over your eyes in the awful glare; never see the fireball closing in at many times the speed of sound; and never feel the stellar heat that annihilates "
	CALL1 MUCH-OF
	RTRUE

	.FUNCT BLIGHT
	PRINTI " filled with light of startling intensity"
	RTRUE

	.FUNCT DAZZLE
	PRINTI " disappears in a flash of startling brilliance"
	RTRUE
...
?L13:	FSET? BREAKER,SHADOWY \?L18
	ZERO? W /?L19
	CRLF
	PRINTI """Looks like a no-go without X"
	CALL1 BITTER-VOICE
...
?L59:	SET 'V,1
	...
	PRINTI " sweeps back onto the tower."
	CRLF
	JUMP ?L77
...
?L62:	EQUAL? HERE,W75,W50,W25 \?L65
	SET 'V,1
	CALL2 SPOT-SWEEPS,STR?97
	JUMP ?L77
?L65:	EQUAL? HERE,AT-ZERO,ON-TOWER,TOWER-PLAT /?L68
	EQUAL? HERE,IN-SHACK \?L77
?L68:	SET 'V,1
	CRLF
	PRINTI "The harsh light illuminating the "
	PRINTD TOWER
	PRINTI " sweeps away suddenly."
	CRLF
	JUMP ?L77
?L61:	DEC 'MLIVES
	ZERO? MLIVES \?L71
...
?L74:	ZERO? MLIVES \?L77
	...
	SET 'V,1
	CRLF
	PRINTI "A distant gunshot rings across the "
	PRINTD GDESERT
	PRINT PERIOD
?L77:	ZERO? W \?L81
	RETURN V
...
?L90:	EQUAL? MINUTES,27 \?L91
	...
	CRLF
	PRINTR """Ninety seconds to auto-sequencer. Mark."""
...
?L114:	EQUAL? SECONDS,0,30 /FALSE
	...
	CALL1 TWO-MINUTE-WARNING
	CRLF
	PRINTI "A siren wails through the "
	PRINTD WTK
	PRINT PERIOD
	RTRUE
?L119:	EQUAL? MINUTES,24 \?L120
	...
	CRLF
	CALL2 CTHE-PRINT,WTK
	PRINTR " emits a short blast of distortion. It sounded like a siren."
?L120:	PRINTR "."""

	.FUNCT TWO-MINUTE-WARNING
	PRINTI ". All personnel whose duties do not specifically require otherwise will now assume a prone position, with face and eyes directed "
	CALL2 ITALICIZE,STR?114
	PRINTR " from Zero."""

	.FUNCT FIVE-MINUTE-WARNING
	PRINTR ". Personnel, prepare to assume safe positions."""

	.FUNCT DO-28
	EQUAL? SECONDS,45 \?L1
	PRINT Z-MINUS
	PRINTR "one minute. Sequencer will assume control in fifteen seconds."""
?L1:	CRLF
	ZERO? SECONDS \?L4
	PRINTR """Auto-sequencer in sixty.""

""Roger. Six-oh seconds."""
?L4:	EQUAL? SECONDS,15 \?L6
	PRINTR """Forty-five seconds to auto-sequencer."""
?L6:	PRINTI "The music on the "
	PRINTD WTK
	PRINTR " distorts badly. ""Thirty seconds to auto-sequencer."""
	...
	PRINTD BAKER
	PRINTR " to all units. Are we all in on this?"""
?L1:	EQUAL? SECONDS,15 \?L3
	PRINTI """"
	PRINTD ABLE
	PRINTI " to "
	PRINTD BAKER
	PRINTI ". Us cowboys been waitin' all night.""

""Roger, "
	PRINTD ABLE
	PRINTR "."""
?L3:	EQUAL? SECONDS,30 \?L4
	PRINTR """Everything's go at Forbes Field.""

""Roger."" (A pop of static.) ""It's time, gentlemen."""
?L4:	CALL2 CTHE-PRINT,WTK
	PRINTR " emits a burst of interference, followed by faint strains of music. It's ""The Star-Spangled Banner.""
...
""Aw, hell."" You hear a flurry of excited "
	...
	PRINTI ". """
	PRINTD BAKER
	PRINTI " to all units. We have 100% continuity loss towerside. Repeat, "
	CALL2 ITALICIZE,STR?115
	PRINTI " continuity.""
...
""Affirmative, "
	PRINTD ABLE
	PRINTI ". Sequencer's going. Too late to risk it. This is a scrub, everybody. Repeat, scrub it."""
	CRLF
	CALL1 POLICE-CONVERGE
	RTRUE
?L1:	PRINTI "Check your idiot bulb, "
	PRINTD BAKER
	PRINTI ". I replaced two duds last night.""

"""
	PRINTD ABLE
	PRINTI ", my bulb lights up real pretty. Is this a scrub?""

""I dunno. Ask the kid if he reconnected the "
	CALL1 WIRE-ID
	PRINTI " line on X after the continuity check.""
...
?L1:	EQUAL? XWIRE,STR?116 \?L4
	PRINTI "positive"
	RTRUE
?L4:	EQUAL? XWIRE,STR?117 \?L6
	PRINTI "ground"
	RTRUE
?L6:	EQUAL? XWIRE,STR?118 \?L7
	PRINTI "informer"
	RTRUE
?L7:	PRINTI "detonator"
	RTRUE
	...
	.FUNCT KSCRUB,WIN=0
	CRLF
	PRINTI """X-unit just went out"
	FSET? BREAKER,BORING \?L1
	PRINTI " again"
?L1:	ZERO? WIN \?L4
	CALL1 BITTER-VOICE
	RTRUE
?L4:	PRINTI ","" shouts a voice.
...
""Kid's board says it's the "
	CALL1 WIRE-ID
	PRINT PTHE
	PRINTI "others look okay. We're lettin' it go, "
	PRINTD ABLE
	PRINT PTHE
	PRINTI "sequencer's running."""
	CRLF
	CRLF
	CALL2 CTHE-PRINT,WTK
	CALL2 PICK-NEXT,HISSES >STACK
...
"""
	PRINTD BAKER
	PRINTR " to all units. This is a scrub, guys. Repeat, scrub it."""

	.FUNCT NO-TOLERANCE
	CRLF
	PRINTI """"
	PRINTD PITTS
	PRINTI " to all units. We've definitely got something moving on that "
	PRINTD TOWER
	PRINTR "!""
...
""Roger. Attention, all units. Security alert. Scrub the shot and get Anderson out there. This is a scrub. Repeat, scrub."""
	...
	FSET WIGHT,LOCATION
	PRINTI "One of our eyes just caught a movement on the tower. Can you confirm? Over.""
...
""Negative, "
	PRINTD PITTS
	PRINTR ". What're you guys drinking down there?"""
?L1:	FSET? WIGHT,LIGHTED /?L3
	FSET WIGHT,LIGHTED
	PRINTI "We're still seein' spooks up on that tower.""
...
""Har har, "
	...
	PRINTI ". "
	PRINTD PITTS
	PRINTI ", double-check and get back to us on that spook.""

""Roger and out, "
	PRINTD BAKER
	PRINTR "."""
?L3:	PRINTI "More movement towerside.""
...
""Checkin' it twice, "
	...
	PRINTI "Whatever we saw up there went home"
	JUMP ?L6
?L4:	PRINTI "Cancel that spook report"
?L6:	PRINTI ".""
...
""Roger, "
	...
	CRLF
	EQUAL? MLIVES,1 \?L1
	PRINTI "More barking erupts from the "
	PRINTD WTK
	PRINT PCR
	PRINTI """Buzzards, "
	PRINTD PITTS
	PRINTI "?"" smirks a voice.

""(Sigh.) Checkin' it out, "
	PRINTD BAKER
	PRINTR ". Stand by."""
?L1:	PRINTI "A commotion of noise erupts from the "
	PRINTD WTK
	PRINTI ". It sounds like a barking dog.

"""
	PRINTD PITTS
	PRINTI " to all units."" The voice is urgent.
...
""Stand by, "
	PRINTD BAKER
	PRINTI ". Some kinda trouble outside.""

"""
	PRINTD BAKER
	PRINTI ", are we holding?""

""Negative, "
	PRINTD ABLE
	PRINTI ". No hold. "
	PRINTD PITTS
	PRINTI ", get a line on that disturbance and report on the double.""
...
""Will do. "
	...
	PRINTD WTK
	PRINTI " continues for a few moments"
	ZERO? MLIVES \?L1
	PRINTI ". Then you hear a sharp "
	CALL2 ITALICIZE,STR?119
	PRINTR " and the barking stops."
?L1:	PRINTR ", then dies away."
	...
	PRINTI "."
	ZERO? MLIVES \?L1
	PRINTI """ An evil chuckle. ""That buzzard ain't botherin' us again."""
	CRLF
	CRLF
	JUMP ?L3
?L1:	PRINTI " Just some buzzard raisin' hell with the dog. I chased it away.""
...
?L3:	PRINTI """Roger, "
	...
	IN? CAGE,W100 \TRUE
	CRLF
	PRINTI """Er, by the way. We got us a "
	PRINTD CAGE
	PRINTI " out here"
	IN? LEM,CAGE \?L6
	PRINTI " with a hamster inside"
?L6:	PRINTI ". Anybody lose it?""
...
""Nix the clowning, "
	...
	.FUNCT Z-MINUS-45
	PRINT Z-MINUS
	PRINTI "forty-five seconds. Commence auto-sequence.""

""We copy, "
	PRINTD BAKER
	PRINTR ". Sequencer affirmative. Good luck."""

	.FUNCT Z-MINUS-30
	PRINT Z-MINUS
	PRINTI "thirty seconds. All personnel should face "
	CALL2 ITALICIZE,STR?114
	PRINTR " from Zero at this time."""

	.FUNCT Z-MINUS-15
	PRINT Z-MINUS
	PRINTR "fifteen seconds. Fourteen. Thirteen. Twelve. Eleven."""

	.FUNCT FINAL-SECONDS
	PRINT Z-MINUS
	PRINTI "ten seconds. Nine seconds. Eight. Seven. Six. Five seconds. Four. Three. Two.""

You hear a loud "
	CALL2 ITALICIZE,STR?120
	PRINTR " at the word ""One."""
	...
	FSET BIKES,SEEN
	CRLF
	PRINTI "A young couple zooms down the "
	PRINTD LAN-WALK
	PRINTR " on bicycles. You watch them roll across the grass and disappear into the crowd."
	...
	CRLF
	EQUAL? WIGHTER,3 \?L4
	PRINTI "Something is breathing in the darkness."
	CRLF
	CALL1 WIGHT-ID
	JUMP ?L8
?L4:	EQUAL? WIGHTER,2 \?L6
	PRINTI "The breathing is getting closer."
	CRLF
	JUMP ?L8
?L6:	EQUAL? WIGHTER,1 \?L7
	PRINTI "Only a few feet lie between you and the breathing."
	CRLF
	JUMP ?L8
...
?L8:	IN? KEY,KEYHOLE \TRUE
	...
	MOVE KEY,WIGHT
	CRLF
	PRINTI "You hear a noise that sounds suspiciously like a "
	PRINTD KEY
	PRINTR " being drawn from a hole."
...
?L12:	RANDOM 100 >STACK
	...
	PRINTI "Something sharp closes around your throat. It caresses your chin and the nape of your neck, delighting in the living warmth. Then, with a quick, practiced "
	CALL2 ITALICIZE,STR?121
	PRINTI " it breaks your neck at the collarbone."
	CALL1 JIGS-UP
	RTRUE
	...
	FCLEAR SLOPE,OPENED
	CRLF
	PRINTI "With a rusty creak, the "
	PRINTD SLOPE
	PRINTI " behind you retracts into the "
	PRINTD CEILING
	PRINT PA
	PRINTI "clatter and "
	CALL2 ITALICIZE,STR?122
	PRINTI " fill the "
	PRINTD CAVE
	PRINTI " with a sinister echo"
	CALL1 ALL-IS-STILL
	RTRUE
...
?L9:	ZERO? V /FALSE
	EQUAL? BEAM,4 \?L13
	CALL2 LAMPLIGHT,STR?124
	RTRUE
?L13:	EQUAL? BEAM,9 \FALSE
	CALL2 LAMPLIGHT,STR?125
	RTRUE
...
?L3:	RANDOM 100 >STACK
	...
	CALL1 HOLD-IT
	CRLF
	PRINTI "You hear boots stomping up the "
	PRINTD TLADDER
	PRINTI ". Before you can move, an MP is shoving a barrel into the small of your back. "
	CALL1 EXCUSES
	RTRUE
...
?L3:	ZERO? MINUTES \?L5
	...
	CRLF
	PRINTI "You hear a motor revving to life below. One of the "
	PRINTD VOICES
	PRINTI " barks something; there's a squeal of rubber, and "
	EQUAL? HERE,IN-SHACK \?L7
	PRINTI "the motor fades into the distance"
	CALL1 ALL-IS-STILL
	RTRUE
?L7:	PRINTR "a jeep appears on the south road. You watch the headlights dwindle into the distance."
?L5:	EQUAL? MINUTES,58 \?L10
	EQUAL? SECONDS,15 /FALSE
	EQUAL? SECONDS,30 \?L13
	FSET VOICES,SEEN
	CRLF
	PRINTI "A faint sound drifts "
	EQUAL? HERE,IN-SHACK \?L14
	PRINTI "in from somewhere outside"
	JUMP ?L16
?L14:	PRINTI "up from somewhere far below"
?L16:	PRINTR ". It sounded like a man's voice."
?L13:	CRLF
	PRINTI "You hear the voice again, followed by a sharp clatter. There's definitely somebody "
	EQUAL? HERE,IN-SHACK \?L18
	PRINTR "outside."
?L18:	PRINTR "down below."
?L10:	CRLF
	ZERO? SECONDS \?L22
	PRINTI "Another voice joins the first. You strain to listen.

""Towerside breaker closed. Check.""

"""
	PRINTD PITTS
	PRINTR "'s on the line, Lieutenant.""

""Give him to me, Joe."""
?L22:	EQUAL? SECONDS,15 \?L24
	PRINTI "A gust of wind obscures the conversation "
	EQUAL? HERE,IN-SHACK \?L25
	PRINTI "outside"
	JUMP ?L27
?L25:	PRINTI "below"
?L27:	PRINTR " for a few moments. You can pick out the words ""focus,"" ""groves"" and ""surveillance,"" but little else."
?L24:	EQUAL? SECONDS,30 \?L28
	...
	JUMP ?L31
?L29:	PRINTD PLATFORM
?L31:	PRINTI " is filled with light! It seems to be coming from "
	EQUAL? HERE,IN-SHACK \?L32
	PRINTI "somewhere outside"
	JUMP ?L34
?L32:	PRINTI "a point on the southwest "
	PRINTD HORIZON
?L34:	PRINTI ".
...
?L28:	PRINTI "The wind rises again, drowning out the "
	PRINTD VOICES
	PRINTR " altogether."
...
?L3:	EQUAL? HERE,ON-PLATFORM,UNDER-PLAT \?L6
	PRINTI """Pyat, chetirye, tree, dva, adeen,"" barks the "
	PRINTD RSPEAKER
	PRINT PCR
	JUMP ?L8
?L6:	PRINTI "A searing glare engulfs the mountaintops! "
?L8:	EQUAL? HERE,CLIFF-EDGE \?L9
	PRINTI "You turn, and stare in horror at a seething mass of flame billowing above the tundra.

Seconds later, "
	CALL1 HURRICANE
	CALL1 CLIFF-DROWN
	RTRUE
?L9:	PRINTI "For an instant, you see your own "
	PRINTD DSHADOW
	PRINTI " cast in stark silhouette across the "
...
?L52:	EQUAL? MINUTES,40 \?L55
	...
	PRINTD RSPEAKER
	CALL1 SAY-BARKS
	PRINTI " something incomprehensible. It sounded like "
	JUMP ?L57
...
?L1:	PRINTI " intones"
	...
	.FUNCT HURRICANE
	PRINTI "a gale of radioactive debris sweeps you "
	RTRUE
...
?L14:	FSET OPPIE,SEEN
	PRINTI "A "
	PRINTD OPPIE
	PRINTI " steps into view, standing just"
...
?L20:	SET 'P-HIM-OBJECT,NOT-HERE-OBJECT
	FSET OPPIE,SEEN
	PRINTI "With a nervous sigh, the "
	PRINTD OPPIE
...
?L17:	LESS? OSC,4 \FALSE
	...
	CRLF
?L26:	EQUAL? OSC,3 \?L29
	PRINTI "Pushing back his porkpie hat, the "
	PRINTD OPPIE
	PRINTR " peers up at the overcast sky."
?L29:	EQUAL? OSC,2 \?L31
	PRINTI "You notice the "
	PRINTD OPPIE
	PRINTR " glancing at his watch."
?L31:	CALL2 CTHE-PRINT,OPPIE
	PRINTR " draws thoughtfully on his pipe."
...
?L33:	PRINTI " pulling towards the "
	PRINTD LUMP
	PRINT PERIOD
	RTRUE
	...
	PRINTI "You'd never find her in this crowd."
	CRLF
	RETURN 2
...
?L1:	FSET JWOMAN,TOUCHED
	...
	PRINTI "address the "
	PRINTD JWOMAN
	PRINTI ", but suddenly fall silent"
	JUMP ?L13
?L11:	PRINTI "approach the "
	PRINTD JWOMAN
	PRINTI ", but stop in your tracks"
?L13:	PRINT PCR
?L9:	PRINTI "Her face is wrong.

You look a little closer and shudder to "
	PRINTD ME
	PRINT PTHE
	PRINTI "entire left side of her head is scarred with deep red lesions, twisting her oriental features into a hideous mask. She must have been in an accident or something."
	CRLF
	...
	JUMP ?L3
?L1:	PRINTD SIRENS
?L3:	PRINTR " drowns out your words."
...
?L9:	EQUAL? PRSA,V?ASK-FOR \?L13
	EQUAL? PRSO,ME \?L14
	PRINTI """I won't beg from the likes o' you,"" sniffs the "
	PRINTD BWOMAN
	PRINT PERIOD
	RTRUE
...
?L28:	EQUAL? PRSA,V?GIVE,V?SHOW \FALSE
	FSET BWOMAN,SEEN
	ZERO? RAID? /?L31
	PRINTR "She's too frightened to respond."
?L31:	EQUAL? PRSO,COIN \?L33
	...
	MOVE BAG,BWOMAN
	PRINTI """Bless yer,"" coos the "
	PRINTD BWOMAN
	PRINTI ", taking your money with a practiced snatch. ""Twenty p's the change."" She holds out a "
	PRINTD BAG
	PRINTI " and a "
	PRINTD SCOIN
	PRINTI " for you."
...
?L37:	EQUAL? PRSO,CREDIT-CARD \?L38
	PRINTR """I ain't Harrod's, dearie. Thirty p."""
?L38:	EQUAL? PRSA,V?SHOW /FALSE
	CALL1 CTHEI-PRINT
	PRINTR " shakes her head. ""Keep it, dearie."""
...
?L42:	EQUAL? PRSA,V?EXAMINE \?L46
	ZERO? RAID? \?L47
	PRINTR "You get the feeling that she's been selling crumbs on this same bench, year after year, since well before you were born. Her face is lined with care for her feathered charges, who perch on her round shoulders without fear."
?L47:	PRINTR "She's obviously terrified by all the sirens and commotion."
...
?L51:	FSET BWOMAN,SEEN
	...
	PRINTR """A rare bargain at thirty p."""
?L54:	FSET? PRSI,TAKEABLE \?L56
	PRINTI """I ain't got no "
	PRINTD PRSI
	PRINTR ", ducky."""
?L56:	PRINTI """I couldn't give you that!"" laughs the "
	PRINTD PRSO
	PRINT PERIOD
	RTRUE
?L50:	INTBL? PRSA,HURTVERBS,NHVERBS >STACK \FALSE
	...
	.FUNCT BAD-COO
	PRINTI "A threatening coo from the "
	PRINTD PIGEONS
	PRINT CHANGES
	RTRUE

	.FUNCT NOT-A-FARTHING
	PRINTR """Thirty p, not a farthing less."""
...
?L1:	FSET? OBJ,TOLD \?L6
	CALL2 CTHE-PRINT,BWOMAN
	PRINTR " scowls. ""Pay attention, ducky! I told ye once already."""
...
?L14:	DLESS? 'CNT,1 \?L8
	...
	PRINTR " sighs. ""Time."""
?L24:	PRINTR " sniffs. ""Looks cheap."""
?L22:	EQUAL? OBJ,RUBY \?L27
	FSET OBJ,TOLD
	CALL2 CTHE-PRINT,BWOMAN
	EQUAL? RUBYROOM,BROAD-WALK \?L28
	PRINTR " gives you a sad smile. ""Not to worry, dear,"" she sighs. ""Ye'll get it back by and by."""
?L28:	PRINTR " peers at you closely. ""'Ave ye seen one?"" she whispers. ""Wouldn't let it out o' my sight if I was you."""
?L27:	EQUAL? OBJ,MEEP \?L31
	FSET OBJ,TOLD
	CALL2 CTHE-PRINT,BWOMAN
	EQUAL? RUBYROOM,BROAD-WALK \?L32
	PRINTR " giggles. ""Fast, ain't he?"""
?L32:	PRINTR " gives you a sharp look, but doesn't reply."
?L31:	ZERO? V \?L36
...
?L37:	PRINTI """"
	RANDOM 100 >STACK
	LESS? 50,STACK /?L40
	PRINTI "You know as much as I do"
	JUMP ?L42
?L40:	PRINTI "Don't know nothin' you don't"
...
?L35:	RANDOM 100 >STACK
	...
	CALL2 CTHE-PRINT,BWOMAN
	PRINTI " scowls. "
?L51:	PRINTI """Don't know what you're talkin' 'bout, ducky"
	ZERO? Q \?L56
	RANDOM 100 >STACK
	LESS? 50,STACK /?L54
?L56:	PRINTR "."""
...
?L5:	EQUAL? PRSA,V?WRAP-AROUND /FALSE
	...
	MOVE PRSO,PRSI
	FSET PRSO,NODESC
	PRINTI "You awkwardly force the "
	PRINTD PRSO
...
?L1:	SET 'P-IT-OBJECT,GOON
	...
	PRINTI "The solemn dignity of the "
	PRINTD CRYPT
	PRINTI " makes you suspect that the remains may be those of some great missionary or explorer. The shrunken"
	FSET? SHROUD,NODESC \?L17
	PRINTI " body is wrapped in a gray "
	PRINTD SHROUD
	JUMP ?L19
?L17:	PRINTI ", unclothed body is badly decomposed"
?L19:	PRINTI ", and its wrinkled "
	...
	PRINTD BANDAGE
	PRINTI " wrapped around its head"
	JUMP ?L22
...
?L26:	ZERO? R /?L29
	ZERO? G /?L27
	PRINT PA
	PRINTI "pair of boots, one red and one green, completes the ghastly wardrobe"
	JUMP ?L30
?L27:	ZERO? R /?L29
...
?L35:	EQUAL? PRSA,V?UNDRESS \?L40
	...
	RTRUE
?L41:	PRINTR "You've already done that."
?L40:	INTBL? PRSA,MOVEVERBS,NMVERBS >STACK \FALSE
	PRINTI "You struggle briefly with "
	CALL1 THE-PRINT
	PRINTR ", but it's just too awkward."

	.FUNCT ONE-CLAD,BOOT
	PRINTI ". One foot is clad in a "
	PRINTD BOOT
	RTRUE
	...
	PRINTI " is blue and wrinkled"
	FSET? PRSO,OPENED \?L4
	CALL2 SEE-ANYTHING-IN?,PRSO >STACK
	ZERO? STACK /?L4
	PRINTI ". Inside it you can see "
	CALL2 PRINT-CONTENTS,PRSO
?L4:	PRINT PERIOD
	RTRUE
?L3:	EQUAL? PRSA,V?CLOSE \?L7
	FSET? PRSO,OPENED \?L8
	PRINTR "It falls open again horribly."
?L8:	CALL2 ITS-ALREADY,STR?57
	RTRUE
...
?L15:	CALL1 HANDLE-CORPSE? >STACK
	...
	PRINTR " is holding it tightly shut."
...
?L10:	EQUAL? PRSA,V?GIVE,V?SHOW \?L12
	ZERO? IN-DORY? \?L13
	CALL YOUD-HAVE-TO,STR?134,DORY
	RTRUE
?L13:	CALL1 CTHEI-PRINT
	...
	PRINTI " glances at "
	CALL1 THE-PRINT
	PRINTR " you're wearing, but shows no interest."
...
?L22:	EQUAL? PRSO,CREDIT-CARD \?L24
	CALL1 VANISH
	PRINTI " and checks it against a list of delinquent accounts"
	CALL1 SOLEMNLY
	PRINTR ", rips the card in half and throws the pieces in the river."
?L24:	EQUAL? PRSO,SCOIN \?L25
	CALL1 VANISH
	PRINTI ", peers at it carefully and compares it to a "
	PRINTD BCOIN
	PRINTI " given to him by one of the "
	PRINTD SHADES
	PRINT PTHE
	PRINTI "difference is obvious"
	CALL1 SOLEMNLY
	PRINTR " and tosses your coin into the river."
?L25:	MOVE PRSO,HERE
	PRINTI ", glances at it briefly and tosses it onto the "
	PRINTD BEACH
	PRINT PERIOD
	RTRUE
...
?L8:	EQUAL? PRSA,V?EXAMINE,V?SEARCH \?L32
	FSET PRSO,TOUCHED
	CALL1 CTHE-PRINT
	PRINTR "'s face and form are concealed under a hooded cloak. His bent posture suggests great age, but he handles his vessel with a firm, confident hand that commands respect."
?L32:	EQUAL? PRSA,V?WATCH \?L33
	CALL2 I-STYX,0
	RTRUE
?L33:	EQUAL? PRSA,V?WAVE-AT \?L34
	CALL1 CTHEI-PRINT
	PRINTR " doesn't respond to your gesture."
...
?L38:	PRINTI " pretends not"
	JUMP ?L40
?L36:	PRINTI " is probably too far away"
...
?L45:	CALL1 DEMEANOR
	...
	.FUNCT SOLEMNLY
	PRINTI ". He shakes his head solemnly"
	RTRUE
	...
	.FUNCT STYX-TRIP
	PRINTI " and nods at you solemnly."
	CRLF
	CALL1 VANISH
	CALL1 EXIT-DORY
	EQUAL? STICKS,3,4 \?L1
...
?L1:	SET 'STICKS,10
	...
	CRLF
	CALL1 CTHEI-PRINT
	PRINTI " pushes away from the beach.
...
Planes of mist close in around the dory, drawing it deeper into the gloom. The only sound is the rhythmic slurp of the oar as it plies the dark, oily water."
	CALL1 CARRIAGE-RETURNS
	PRINTI "A vague outline emerges beyond the helm. It slowly resolves into a spit of sand, damp and cheerless in the surrounding murk"
	PRINT PCR
	CALL1 CTHEI-PRINT
	PRINTI " swings the dory around and lands it with barely a jolt. "
	CALL1 ONE-BY-ONE
	PRINTI ". Something in the "
	PRINTD PRSI
	PRINTI "'s gaze compels you to follow them"
	PRINT PCR
	CALL2 GOTO,ON-BEACH
	RTRUE
...
?L5:	CALL1 CTHEI-PRINT
	...
	MOVE PRSO,PRSI
	FSET PRSI,CHILLY
	PRINTI "'s mouth opens into a little ""o"" at the magnificence of your gift. She humbly "
	ZERO? X /?L8
	MOVE X,PLAYER
	PRINTI "exchanges "
	CALL2 THE-PRINT,X
...
?L23:	MOVE X,PLAYER
	...
	PRINTI " for "
?L24:	CALL1 THE-PRINT
	PRINTI " with a gracious bow. Her fingers explore the creases in the paper, bending them this way and that. Then, with a few deft maneuvers, she refolds the sheet to its original shape and "
	IN? PARASOL,PRSI \?L25
	MOVE CRANE,PLAYER
	PRINTI "hands it back to you."
	CRLF
	CALL1 START-MCRANE
	RTRUE
?L25:	MOVE CRANE,PRSI
	PRINTR "holds it up for you to see."
...
?L29:	PRINTI " politely "
	...
	PRINTI "accepts "
	CALL1 THE-PRINT
	PRINTI ", looks it over briefly and hands it back to you, keeping the "
	PRINTD X
	PRINTR " for herself."
?L32:	ZERO? X /?L34
	MOVE X,PLAYER
...
?L35:	MOVE PRSO,PRSI
	CALL1 THE-PRINT
	PRINTR ", and toys with it absently."
?L28:	PRINTI " toys with "
	CALL1 THE-PRINT
	PRINTI " for a moment, but quickly tires of "
	FSET? PRSO,PLURAL \?L37
	PRINTI "them"
	JUMP ?L39
?L37:	PRINTI "it"
?L39:	PRINTI " and hands it back to you"
	CALL1 SEE-TWINKLE?
	RTRUE
?L3:	EQUAL? PRSA,V?SHOW \?L40
	...
	PRINTD PARASOL
	PRINTR " with undisguised longing."
...
?L44:	PRINTI " glances at "
	CALL1 THE-PRINT
	PRINTI ", but exhibits only polite interest"
	CALL1 SEE-TWINKLE?
	RTRUE
...
?L46:	EQUAL? PRSA,V?THROW,V?THROW-OVER \FALSE
	...
	PRINTD PRSO
	PRINTI " and looks up at you reproachfully"
	PRINT PCR
	CALL1 CTHE-PRINT
...
?L48:	PRINTI "She catches "
	...
	JUMP ?L53
?L51:	PRINTI "it"
?L53:	PRINTI " with a playful laugh"
...
?L54:	PRINTI " and tosses it back"
	CALL2 VISIBLE?,PARASOL >STACK
	ZERO? STACK /?L58
	PRINTI ", her eyes hardly leaving the "
	PRINTD PARASOL
?L58:	PRINT PERIOD
	RTRUE
?L1:	EQUAL? PRSA,V?EXAMINE,V?SEARCH \?L62
	CALL1 CTHE-PRINT
	PRINTI " is a cute four or five years old"
	CALL2 SEE-ANYTHING-IN?,PRSO >STACK
	ZERO? STACK /?L63
...
?L79:	RANDOM 100 >STACK
	...
	PRINTI " cheerfully "
	JUMP ?L82
?L81:	PRINTI " giggles, then clumsily "
...
?L84:	INTBL? PRSA,HURTVERBS,NHVERBS >STACK \FALSE
	PRINTR "Imagine doing that to a defenseless little girl!"
	...
	PRINTD CRANE
	PRINTR " begin to flicker faintly."

	.FUNCT EYES-BRIGHTEN
	FSET GIRL,TOUCHED
	PRINTI "'s eyes brighten with surprise when she sees the "
	PRINTD PRSO
	PRINTI ". """
	HLIGHT H-ITALIC
	PRINTI "Origami"
	...
	PRINTI ". She didn't seem to notice the weird twinkling"
?L1:	PRINT PERIOD
	RTRUE
...
?L1:	EQUAL? W?BOY,P-NAM,P-XNAM \FALSE
	...
	JUMP ?L5
?L3:	PRINTI "young "
?L5:	PRINTI "boy sits nearby, listening to a pair of "
	PRINTD PHONES
	PRINTI " and idly blowing "
	PRINTD SBUBBLE
	PRINTI "s. There's a dish full of "
	PRINTD SOAPY-WATER
	PRINTI " by his side"
	ZERO? IN-DISH? /?L6
	PRINTI ", in which you're now standing"
?L6:	PRINTC 46
	RTRUE
	...
	PRINTR "The boy is too preoccupied with his music to notice your offer."
?L1:	EQUAL? PRSA,V?FOLLOW,V?WHERE \?L6
	FSET? PRSO,CHILLY \?L6
	PRINTR "You'd never find him in this crowd."
...
?L9:	INTBL? PRSA,TALKVERBS,NTVERBS >STACK \FALSE
	...
	CALL1 CTHE-PRINT
	PRINTR " does his best to ignore you."
?L1:	EQUAL? PRSA,V?LISTEN \?L3
	CALL1 HEAR-GIANT-MUSIC
	RTRUE
?L3:	EQUAL? PRSA,V?SMELL \?L4
	PRINTR "The boy is old enough to use deodorant, but obviously doesn't."
...
?L3:	EQUAL? PRSA,V?THROW,V?THROW-OVER \?L5
	...
	PRINTI " hits the "
	PRINTD PRSI
	PRINTI ", slides off harmlessly and disappears in the dish."
	CRLF
	CRLF
	CALL1 HURT-GIANT
	RTRUE
...
?L1:	EQUAL? PRSA,V?EXAMINE \?L8
	PRINTI "The boy measures approximately forty feet from head to toe, and probably weighs several tons. He's wearing a pair of stereo "
	PRINTD PHONES
	PRINT PERIOD
	RTRUE
...
?L10:	INTBL? PRSA,MOVEVERBS,NMVERBS >STACK \?L13
	PRINTI "Forget it. This kid is "
	CALL2 ITALICIZE,STR?135
	CRLF
	RTRUE
?L13:	EQUAL? PRSA,V?TOUCH,V?KICK,V?CUT /?L15
	EQUAL? PRSA,V?RIP,V?KILL,V?KNOCK /?L15
	EQUAL? PRSA,V?SHAKE,V?SQUEEZE,V?BITE \?L14
?L15:	CALL1 HURT-GIANT
	RETURN 2
?L14:	EQUAL? PRSA,V?WALK-TO,V?CLIMB-ON,V?STAND-ON /?L19
	EQUAL? PRSA,V?SIT,V?CLIMB-UP,V?CLIMB-OVER /?L19
	EQUAL? PRSA,V?RIDE \FALSE
?L19:	ZERO? IN-DISH? /?L20
	CALL1 EXIT-DISH-FIRST
	RTRUE
?L20:	CALL1 CTHE-PRINT
	PRINTI " picks you off his clothes like an insect, and tosses you absently over his shoulder"
	CALL1 THROW-TO-CHASM
	RETURN 2

	.FUNCT BOY-NO-HEED
	CALL1 SAY-BOY-BOPS
	PRINTR ", but pays no attention."

	.FUNCT HURT-GIANT
	CALL2 CTHE-PRINT,GIANT
	PRINTI " brushes at you absently, like a mosquito"
	CALL1 THROW-TO-CHASM
	RTRUE

	.FUNCT EXIT-DISH-FIRST
	PRINTR "You'd have to get out of the dish to do that."
...
?L1:	CALL1 V-LOOK
	...
	SET 'P-HIM-OBJECT,NOT-HERE-OBJECT
	CRLF
	PRINTR "You painfully regain your footing."

	.FUNCT HEAR-GIANT-MUSIC
	PRINTI "You hear faint, rhythmic music coming from the "
	PRINTD PHONES
	PRINT PERIOD
	RTRUE

	.FUNCT RAPE-SCOUT
	PRINTR "There's a name for people who do things like that to boys."
...
?L3:	GET MEEP-TABLE,3 >STACK
	...
	.FUNCT AFTER-YOU
	PRINT CTHEMEEP
	PRINTR "cocks its head as if to say, ""After you."""
...
?L18:	EQUAL? L,PLAYER \?L21
	...
	CALL1 THE-PRINT
	PRINTI " while you're holding it."
	CRLF
	RETURN 2
?L21:	FSET? L,CONTAINER \?L24
	...
	RETURN 2
?L24:	IN? L,PLAYER \?L27
	PRINTI "You probably ought to take "
	CALL1 THE-PRINT
	FSET? L,SURFACE \?L28
	PRINTI " off "
	JUMP ?L30
...
?L50:	EQUAL? PRSA,V?DROP,V?GIVE,V?FEED /?L53
	PRINTI " and looks at you expectantly"
?L53:	PRINT PERIOD
	RETURN 2
...
?L103:	EQUAL? PRSO,BAG \?L106
	PRINTI "hops with excitement at the idea."
	CRLF
	RETURN 2
?L106:	PRINTI "gives you a distasteful look."
	CRLF
	RETURN 2
...
?L115:	PRINTI "carefully, then gives you a quizzical look."
	CRLF
	RETURN 2
...
?L132:	MOVE PRSO,PRSI
	PRINTI "snatches "
	CALL1 THE-PRINT
	PRINTR " away from you with its beak."
?L125:	EQUAL? PRSA,V?FEED \?L135
	IN? PRSI,TS6 \?L136
	CALL1 CANT-FROM-HERE
	RTRUE
?L136:	EQUAL? PRSO,BAG /?L138
	CALL NOT-LIKELY,PRSI,STR?136
	RTRUE
...
?L143:	RANDOM 100 >STACK
	...
	PRINTI "glances at "
	CALL1 THE-PRINT
	PRINTR ", but shows little interest."
...
?L140:	EQUAL? PRSA,V?THROW,V?THROW-OVER \FALSE
	...
	PRINTI "dodges "
	CALL1 THE-PRINT
	PRINTR " and gives you a hurt look."
?L148:	ZERO? X /?L150
	LOC PRSI >STACK
	MOVE X,STACK
	PRINTI "drops "
...
?L150:	PRINTI "retrieves "
	CALL1 THE-PRINT
	PRINTR " and drops it at your feet."
...
?L171:	EQUAL? PRSA,V?EXAMINE \?L172
	PRINT CTHEMEEP
	PRINTI "resembles a gray pheasant, lean and streamlined, with bright eyes and a long tail splashed with color"
	ZERO? X /?L173
	PRINTI ". It's holding "
	CALL2 PRINTA,X
	PRINTI " in its beak"
...
?L173:	ZERO? APPETITE /?L175
	PRINTI ". Right now it's pecking crumbs out of the bag with great contentment"
?L175:	PRINT PERIOD
	RTRUE
...
?L177:	EQUAL? PRSA,V?TOUCH,V?KISS \FALSE
	PRINT CTHEMEEP
	PRINTR "rubs its head against your leg."
	...
	JUMP ?L5
?L3:	PRINTI "cluck"
?L5:	PRINTR "s something in precise Roadrunner."
...
?L6:	PRINTI " beside the "
	...
	.FUNCT SOUR-LOOK
	PRINT CTHEMEEP
	PRINTI "gives you a sour look. It obviously couldn't hold "
	FSET? PRSO,PLURAL \?L1
	PRINTI "all of "
?L1:	CALL1 THE-PRINT
	PRINTR " in its beak."
...
?L3:	PRINT CTHEMEEP
	...
	CALL2 THE-PRINT,X
	PRINTI " and "
?L4:	PRINTI "nods brightly.

You hold "
	PRINTD BREATH
	PRINTI " as a gray torpedo scoots under the jeeps and disappears into the "
	PRINTD SBUNK
	PRINT PTHE
	PRINTI "busy technicians fail to notice the fearless creature plucking the key from its "
	PRINTD PADLOCK
	PRINT PCR
	PRINTI "Triumphantly, the "
	PRINTD MEEP
	PRINTI " prances back to your side and deposits the key at your feet."
	CRLF
	CALL2 UPDATE-SCORE,3
	RTRUE
	...
	.FUNCT BUSY-EATING
	PRINTR "is busy eating right now."
...
?L18:	PRINTI "glances at "
	CALL2 THE-PRINT,OBJ
	PRINTR ", turns back to you and cocks its head as if to say, ""So?"""
...
?L1:	FSET DOG,SEEN
	...
	PRINTR "The sleeping animal exhibits no interest."
?L9:	EQUAL? PRSA,V?GIVE,V?FEED \?L11
	MOVE PRSO,W100
	FCLEAR PRSI,SEEN
	PRINTI "You deposit "
	CALL1 THE-PRINT
	PRINTR " under the sleeping dog's nose."
?L11:	EQUAL? PRSA,V?THROW,V?THROW-OVER \FALSE
	...
	JUMP ?L15
?L13:	PRINTI " at "
?L15:	PRINTI "the sleeping dog. Luckily, your pitching arm is no better than your sense of diplomacy, and "
	CALL2 THE-PRINT,PRSO
	PRINTR " falls short of its target by several feet."
?L7:	EQUAL? PRSA,V?EXAMINE,V?WATCH \?L17
	PRINTI "You're looking at a hundred and ten pounds of hard, flea-bitten muscle, leashed to the "
	PRINTD BHOUSE
	PRINTR " with a chain of the type used to moor ocean liners. Good thing it's sleeping."
...
?L32:	PRINTI "Boldly, fearlessly, you march up to the dozing shepherd and draw back "
...
?L36:	PRINTI " to deal the sleeping monster a mighty blow"
	EQUAL? PRSI,0,HANDS,FEET /?L37
	GETP PRSI,P?SIZE >STACK
	LESS? STACK,3 \?L37
	PRINTI " (or as mighty a blow as you can expect from "
	CALL2 PRINTA,PRSI
	PRINTI ")"
?L37:	PRINTR ". But the dog snorts a bit in its sleep, and you bravely scurry backwards several dozen yards."
?L31:	EQUAL? PRSA,V?LISTEN \?L40
	CALL1 CTHE-PRINT
	PRINTR " slobbers gently in its sleep."
?L40:	EQUAL? PRSA,V?SMELL \?L41
	CALL1 CTHE-PRINT
	PRINTR " could use a bath. Any volunteers?"
?L41:	EQUAL? PRSA,V?RAPE \?L42
	CALL2 VOICE-MUTTERS,STR?137
	CALL2 WAKE-DOG,1
	RTRUE
?L42:	INTBL? PRSA,TOUCHVERBS,NTOUCHES >STACK \FALSE
	PRINTI "A second look at the sleeping brute"
	PRINT CHANGES
	RTRUE
	...
	FSET PRSO,TOUCHED
	CALL2 CTHE-PRINT,DOG
	PRINTI " curls its lip and rumbles"
	ZERO? TOUCH /?L1
	CALL1 AT-YOUR-TOUCH
	JUMP ?L3
?L1:	CALL1 AT-YOUR-VOICE
?L3:	PRINTR "But you didn't wake it up... this time."
	...
	CALL2 CTHE-PRINT,DOG
	PRINTI " lifts a heavy eyelid"
	ZERO? TOUCH /?L1
	CALL1 AT-YOUR-TOUCH
	JUMP ?L3
?L1:	CALL1 AT-YOUR-VOICE
?L3:	PRINTI "It peers at you for a moment, yawns and drifts back to sleep.

You wipe the sweat from your brow"
	PRINT PCR
	CALL2 ITALICIZE,STR?138
	PRINTI " A set of long, white fangs snaps together, an inch shy of your left leg. Looks as if sleepytime is over."
	CRLF
	CALL1 DOG-ALERT
	RTRUE
...
The 110-pound ""puppy"" strains against its chain, opens its toothy maw and starts"
	...
	CALL1 HEAR-BARKING
?L1:	CRLF
	PRINTI "You stumble backwards to hide as the "
	PRINTD SLIGHT
	PRINTI " sweeps across the road."
	CRLF
	CALL1 HOLD-IT
	CALL1 KINDA-SPY
	CALL1 SURROUNDED
	...
	.FUNCT VERY-CLOSE
	PRINTI "You'd have to get uncomfortably close to the "
	PRINTD WIGHT
	PRINTR " to do that."
...
?L12:	PRINTI " the darkness close at hand"
	CALL1 WIGHT-HAS
	PRINTC 46
	RTRUE
	...
	PRINTI " in one of its long, sharp claws"
	RTRUE
...
?L5:	CALL1 CTHEI-PRINT
	...
	PRINTR " winces with pain, and covers its eye with an open claw."
?L8:	PRINTI " scowls at "
	CALL1 THE-PRINT
	PRINTR " with profound disinterest."
?L3:	EQUAL? PRSA,V?GIVE,V?FEED \?L11
	CALL1 CTHEI-PRINT
	FSET? PRSO,LIGHTED \?L12
	PRINTI " growls and backs away as you approach it with "
	CALL1 THE-PRINT
	PRINT PERIOD
	RTRUE
?L12:	EQUAL? PRSO,GARLIC,ICE,SKINK \?L14
	...
	PRINTI " crams "
	CALL1 THE-PRINT
	PRINTR " into its mouth and belches."
?L14:	MOVE PRSO,OSSUARY
	SET 'P-IT-OBJECT,NOT-HERE-OBJECT
	PRINTI " clutches "
	CALL1 THE-PRINT
	PRINTR " in its claws, glares at it briefly and flings it off into the darkness with a snarl."
?L11:	EQUAL? PRSA,V?THROW,V?THROW-OVER,V?PUSH-TO \FALSE
	CALL2 DONT-HAVE?,PRSO >STACK
	ZERO? STACK /?L17
	CALL YOUD-HAVE-TO,STR?139,PRSO
	RTRUE
?L17:	CALL1 CTHEI-PRINT
	...
	MOVE PRSO,HERE
	PRINTI " and kicks it back to you with a fearful screech."
	CRLF
...
?L1:	EQUAL? PRSA,V?EXAMINE,V?WATCH,V?SEARCH \?L27
	PRINTI "One of the "
	PRINTD PRSO
	PRINTI "'s eyes dangles from its socket on a moist pink nerve. The other glares back at you from the darkness of the "
	PRINTD TUNNEL
	CALL1 WIGHT-HAS
	PRINT PERIOD
	RTRUE
?L27:	EQUAL? PRSA,V?WAVE-AT,V?BOW \?L28
	CALL1 CTHE-PRINT
	PRINTR " responds to your gesture with a contemptuous snarl."
...
?L32:	FSET? PRSI,LIGHTED \?L34
	CALL1 CTHE-PRINT
	PRINTR " backs out of your reach, snarling with fear."
...
?L36:	EQUAL? PRSA,V?KISS,V?RAPE \?L39
	PRINTI "Your gesture brings a tear to the "
	PRINTD PRSO
	PRINTI "'s eye as it recalls the tender moments of its former human existence. Then it breaks your neck with a practiced swipe of its claw."
	CALL1 JIGS-UP
	RETURN 2
?L39:	EQUAL? PRSA,V?SMELL \FALSE
	CALL1 CTHE-PRINT
	PRINTR " smells as if it's been dead a long time."
	...
	MOVE OBJ,HERE
	PRINTI "and flings it back at you with a roar. You leap back as it skitters"
	PRINT AGROUND
	PRINT PERIOD
	RTRUE
...
?L1:	RETURN OPPIE
	...
	SET 'P-IT-OBJECT,NOT-HERE-OBJECT
	CALL2 CTHE-PRINT,OBJ
	PRINTR " you saw here before is gone now."
...
?L11:	EQUAL? PRSA,V?EXAMINE \?L13
	...
	PRINTI " near the "
	PRINTD SHELTER
	PRINTI " is drawn and haggard; it looks as if he hasn't slept in days."
	CRLF
...
?L13:	CALL1 HANDLE-GIS? >STACK
	...
	JUMP ?L5
?L3:	PRINTD TRENCHES
?L5:	PRINTI " are obviously under a lot of strain. Their "
	LESS? MINUTES,28 \?L6
	PRINTI "fingers drum impatiently on their steering wheels, and their "
?L6:	PRINTI "eyes dart back and forth between the "
	PRINTD SBUNK
	PRINTI " and the "
	PRINTD HORIZON
	PRINTI ". One of them is training a "
	PRINTD BINOS
	PRINTR " on the road leading south."
...
?L18:	PRINTD GIS
	PRINTI " snap to alert attention, peering into the gloom. Nobody moves for a long moment. Then, one by one, they begin to relax... all but the closest GI, who stares in the "
	PRINTD INTDIR
	PRINTI " of the shed nervously."
	CRLF
	RETURN 2
?L14:	PRINTI " points in your "
	PRINTD INTDIR
	CALL1 AT-YOUR-VOICE
	PRINTI """The shed!"" he cries."
	CRLF
	CALL1 SURROUNDED
	RETURN 2

	.FUNCT AT-YOUR-VOICE
	PRINTI " at the sound of your voice. "
	RTRUE
	...
	PRINTI " surges "
	ZERO? RAID? \?L3
	PRINTI "north along the crowded "
	PRINTD BROAD-WALK
	PRINTI ". Shad"
	JUMP ?L5
?L3:	PRINTI "through the mob around the Gate. "
	PRINTD D0
?L5:	PRINTI "ed glades stretch away"
	PRINT TON
	PRINTI "east, and a hint of color marks the western edge of the "
	PRINTD FLWALK
	PRINT PERIOD
	RTRUE
?L1:	EQUAL? CONTEXT,M-EXIT \FALSE
	...
	FSET EWIND,TOUCHED
	CALL2 CTHE-PRINT,EWIND
	PRINTI " makes it difficult to walk straight"
	PRINT PCR
...
?L13:	PRINTD TOURISTS
	...
	PRINTD BEDS
	PRINTI " line the walks bending north and west, filling the air with a gentle fragrance. A little path leads northwest, between the trees."
	CRLF
...
?L3:	CRLF
	...
	PRINTI "Passing "
	PRINTD TOURISTS
	PRINTI " hoot with laughter at the dreadful sight; "
	PRINTD NANNIES
	PRINTR " hide their faces and roll quickly away."
?L6:	PRINTI "Frightened "
	PRINTD TOURISTS
	PRINTI " are scattering in every "
	PRINTD INTDIR
	PRINT PERIOD
	RTRUE
?L1:	EQUAL? CONTEXT,M-EXIT \FALSE
...
?L1:	CALL1 WHICH-WAY-OUT
	...
	PRINTI "A brooding "
	PRINTD VICTORIA
	PRINTI " faces east, where the waters of the "
	PRINTD RPOND
	PRINTI " sparkle in the afternoon sun. Your eyes follow the crowded "
	PRINTD BROAD-WALK
	PRINTI " north and south until its borders are lost amid the "
	ZERO? RAID? /?L3
	PRINTI "fleeing "
	JUMP ?L5
?L3:	PRINTI "bustle of "
?L5:	PRINTD GPRAM
	PRINTI ". Small paths curve northeast and southeast,"
	CALL1 TWEEN-TREES
	RTRUE
...
?L6:	EQUAL? CONTEXT,M-ENTERED \FALSE
	...
	PRINTI "A cloud of "
	PRINTD PIGEONS
	PRINTR " fills the air! They circle overhead and congregate around a nearby bench, where an aged woman is selling bags of crumbs.

""Feed the birds! Thirty p!"" Her voice quavers with heartbreak."

	.FUNCT ROUND-POND-F,CONTEXT=0
	EQUAL? CONTEXT,M-LOOK \?L1
	PRINTI "Ducks and swans bob on the sparkling "
	PRINTD CSURFACE
	PRINTI " of the "
	PRINTD RPOND
	PRINTI ". They share the water with a"
	ZERO? RAID? /?L3
	PRINTI " deserted"
	JUMP ?L5
...
?L5:	PRINTI " fleet of "
	PRINTD BOAT
	ZERO? RAID? \?L6
	PRINTI ", directed by the excited shouts of "
	PRINTD CHILDREN
?L6:	FIRST? RPOND >STACK \?L9
	PRINTI ". You also see "
	CALL2 PRINT-CONTENTS,RPOND
	PRINTI " floating within reach"
?L9:	PRINTI ".
...
?L1:	EQUAL? CONTEXT,M-EXIT \FALSE
	...
	PRINTI "This grassy "
	PRINTD CLEARING
	PRINTI " is only twenty feet across, and perfectly circular. Paths wander off in many "
	PRINTD INTDIR
	PRINTI "s through the surrounding "
	PRINTD THICKET
	PRINT PERIOD
	RTRUE
?L1:	EQUAL? CONTEXT,M-EXIT \FALSE
...
For a moment, nothing happens. Then the "
	...
	PRINTI " on the "
	PRINTD DIAL
	PRINTR " wobbles with a faint scrape."
	...
	PRINTI " to join the "
	PRINTD GPRAM
	PRINTI " rolling south down the "
	PRINTD BWALK
?L3:	PRINTI ". Less crowded paths wind east along an "
	PRINTD IFENCE
...
?L1:	EQUAL? CONTEXT,M-EXIT \FALSE
	...
	.FUNCT NO-FOOTHOLDS
	PRINT CANT
	PRINTI "find any good footholds."
	CRLF
	RFALSE

	.FUNCT LAN-GATE-F,CONTEXT=0
	EQUAL? CONTEXT,M-LOOK \?L1
	PRINTI "A crooked old tree shades the "
	PRINTD GPRAM
	PRINTI " as they "
	ZERO? RAID? \?L3
	...
	JUMP ?L5
?L3:	PRINTI "flee"
?L5:	PRINTI ". Shady paths lead west along an "
	PRINTD IFENCE
...
?L1:	EQUAL? CONTEXT,M-ENTERED \?L6
	...
	PRINTI "There's an "
	PRINTD JWOMAN
	PRINTI " under the tree, struggling to open an "
	PRINTD PARASOL
	PRINT PTHE
	PRINTI "stiff "
	CALL1 SAY-WIND
	PRINTR " isn't making it easy for her."
?L6:	EQUAL? CONTEXT,M-EXIT \FALSE
	...
	PRINTI "You begin to walk past the "
	PRINTD JWOMAN
	PRINTI ", but "
...
?L4:	PRINTR "pause for a moment."
	...
	PRINTD ENERGY
	PRINTI " of a horse and rider dominates this "
	ZERO? RAID? \?L3
	PRINTI "bustling "
?L3:	PRINTI "intersection. The Walk continues north and south; lesser paths curve off in many "
	PRINTD INTDIR
	PRINTI "s.

A broad field of "
	PRINTD GRASS
	PRINTI ", meticulously manicured, extends"
	PRINT TOE
	PRINTI ". Beyond it you can see the "
	PRINTD LWATER
	PRINTI " glittering"
	CALL1 TWEEN-TREES
	RTRUE
...
?L1:	CALL1 READ-NOTICE-FIRST
	...
	EQUAL? CONTEXT,M-LOOK \?L1
	PRINTI "Crowded walkways lead east and west along an "
	PRINTD IFENCE
	PRINTR ". Narrow paths wander south into the Gardens."
?L1:	EQUAL? CONTEXT,M-EXIT \FALSE
	CALL1 MISSED-MEEP? >STACK
	ZERO? STACK /FALSE
	CRLF
	...
	PRINTI "You're on a shady path that winds along the western shore of the "
	PRINTD LWATER
	PRINTR ". Looking south, you can see the graceful arch of a bridge, and beyond it the cool expanse of the river Serpentine."
	...
	JUMP ?L3
?L1:	PRINTI "wade"
?L3:	PRINTI " into the cool, dark water"
	PRINT PCR
	RETURN IN-WATER

	.FUNCT DONT-MISS-MISSILE
	LESS? HCNT,6 \?L1
	PRINTI "The spectacle on the "
	PRINTD LWATER
	PRINTI " has you frozen "
	JUMP ?L3
?L1:	SET 'HCNT,6
	PRINTI "You begin to move away, but stop dead "
?L3:	PRINTI "in your tracks."
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "You're standing knee-deep in the "
	PRINTD LWATER
	PRINTI ", not far from the western shore"
	FSET? LWDOOR,TOUCHED \?L3
	PRINTI ". Looking east, you can see a "
	PRINTD LWDOOR
	PRINTI " hovering just above the "
	PRINTD CSURFACE
?L3:	PRINT PERIOD
	RTRUE
...
?L1:	CALL1 BEACH-TOO-FAR
	...
	PRINTI " is too far away in that "
	PRINTD INTDIR
	PRINT PERIOD
	RFALSE

	.FUNCT EXIT-WATER
	PRINTI "You wade back to the "
	PRINTD BEACH
	PRINT PCR
	RETURN LONG-WATER
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "Naked slopes veer upward on every side, forming a natural "
	PRINTD HOLLOW
	PRINTI " that is filled to a depth of several inches with human "
	PRINTD BONES
	PRINT PTHE
	...
	PRINTI "A giant "
	PRINTD TS2
	PRINTI " is flourishing in the rich fertilizer"
...
?L5:	PRINT PERIOD
	...
	PRINTI "The slopes around you are too steep to climb"
	FSET? HOLLOW,TOUCHED /?L1
	FSET HOLLOW,TOUCHED
	PRINTI "; the "
	PRINTD BONES
	PRINTI " suggest that you're not the first to discover this"
?L1:	PRINT PERIOD
	RFALSE
...
?L1:	FSET? TS2-DOOR,OPENED \?L3
	...
	ZERO? STACK \FALSE
	PRINTI "You explore the door's edge with a timid foot."
	CALL1 CARRIAGE-RETURNS
	SET 'SECONDS,0
	SET 'MINUTES,50
	SET 'HOURS,17
...
?L3:	CALL2 ITS-CLOSED,TS2-DOOR
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "This crag of rock juts out over the surrounding "
	PRINTD CHASM
	PRINTI ", ending at an abrupt drop several hundred feet deep. Rugged trails wind south and south"
	CALL1 SAY-EAST
	PRINT PERIOD
	RTRUE
...
?L1:	CALL1 WHICH-WAY-OUT
	...
	PRINTD PLATFORM
	PRINTI " of stone, surrounded on every side by a deep "
	PRINTD CHASM
	PRINT PA
	PRINTI "fallen oak bridges the gulf"
	PRINT TOS
	PRINT PCR
	PRINTI "A giant "
	PRINTD TS3
	PRINTI " has somehow taken root in the solid rock"
...
?L3:	CALL2 ITS-CLOSED,TS3-DOOR
	...
	PRINTI " Narrow trails curve southeast and southwest, away from the edge of the bluff.

To the "
	CALL1 SAY-EAST
	PRINTI " stands a little "
	PRINTD COTTAGE
	PRINTI ", nestled in a shady "
	PRINTD COPSE
	PRINT PTHE
	PRINTD COTTAGE-DOOR
	PRINTI " is "
...
?L3:	PRINTR "closed."
	...
	PRINTI "A spectacular crop of "
	PRINTD STOOLS
	PRINTI " extends far and wide across the "
	PRINTD VALLEY
	PRINTI " below."
	RTRUE
	...
	PRINTI ", brown with the crust of years, squats in the middle"
	JUMP ?L5
?L3:	PRINTI " stands amid the scorched remains"
?L5:	PRINTI " of this tiny chamber. "
	FSET? EMERALD,NODESC \?L6
	PRINTI "Coils of steam writhe from its depths, filling the air"
	JUMP ?L8
?L6:	PRINTI "The air is filled"
?L8:	PRINTI " with a greasy stench that makes your nose wrinkle. "
	FSET? COTTAGE-DOOR,OPENED \?L9
	PRINTI "Luckily, the "
	FSET? GARDEN-DOOR,OPENED \?L11
	PRINTI "front and "
	PRINTD GARDEN-DOOR
	PRINTR "s are both wide open."
...
?L9:	FSET? GARDEN-DOOR,OPENED \?L14
	...
	RTRUE
?L14:	PRINTI "Unfortunately, the front and "
	PRINTD GARDEN-DOOR
	PRINTR "s are both closed."

	.FUNCT DOOR-LEADING,OBJ
	PRINTD OBJ
	PRINTI " is wide open. Another door leading "
...
?L3:	PRINTR " is closed."
	...
	PRINTI "A "
	PRINTD GFENCE
	PRINTI " protects the neat rows of herbs from predators. The only exit is the"
...
?L1:	FSET? TS4-DOOR,OPENED \?L6
	...
	PRINTI " opens wider at your touch, drawing you over the threshold."
	CALL1 CARRIAGE-RETURNS
	RETURN ON-PLATFORM
?L6:	CALL1 WHICH-WAY-IN
	...
	PRINTI "Gloomy "
	PRINTD STATUES
	PRINTI " lie toppled among the "
	PRINTD TOMBS
	PRINTI ", their "
	PRINTD LIMBS
	PRINTI " and heads scattered like the carnage of a ghastly battle.

A granite "
	PRINTD CRYPT
	PRINTI " lies"
	PRINT AGROUND
	PRINTI ". Beyond it rises the mound of an ancient "
	PRINTD BARROW
	FSET? BARROW-DOOR,OPENED \?L3
	PRINT PA
	PRINTI "black "
	PRINTD TUNNEL
	PRINTI " leads north, into the "
	PRINTD BARROW
	JUMP ?L5
?L3:	PRINTI ", sealed with an iron door"
?L5:	PRINTI ".
...
?L3:	CALL2 VISIBLE?,SHARD >STACK
	...
	JUMP ?L6
?L5:	PRINTI "dim light from outside"
?L6:	PRINTI " does little to dispel the gloom of this subterranean passage. Craggy walls bend away"
	PRINT TON
	PRINTI " and south"
	FSET? SLOPE,OPENED \?L7
	PRINTI "; chill vapors rise from a slope that descends into darkness"
?L7:	PRINT PERIOD
	RTRUE
?L1:	EQUAL? CONTEXT,M-ENTERED \FALSE
	...
	CRLF
	PRINTI "A clatter breaks the silence! You turn, and watch helplessly as a "
	PRINTD BARROW-DOOR
	PRINTI " crashes down across the south exit."
	CRLF
	CALL1 SAY-IF-HERE-LIT
?L11:	ZERO? LIT? /TRUE
...
You peer uneasily beyond the pool of light around the "
	...
	JUMP ?L18
?L16:	PRINTD SHARD
?L18:	PRINTI ". Nothing. Then, as your eyes adjust, you descry a vaguely human outline crouched against the "
	PRINTD TUNNEL
	PRINTI " wall"
	CALL1 WIGHT-HAS
	PRINT PERIOD
	...
	CALL2 VISIBLE?,MAGPIE >STACK
	ZERO? STACK /?L4
	PRINTR """Awk! Barrow wight!"""
?L4:	CALL VOICE-MUTTERS,STR?145,0
	RTRUE
...
?L3:	FSET WIGHT,CHILLY
	CALL1 WIGHT-COVERS
	PRINTI "bellows something awful as you pass"
	PRINT PCR
	RETURN OSSUARY
...
?L7:	IN? SHARD,HERE \?L8
	...
	RFALSE
?L8:	PRINTI "You stumble into the lightless "
	PRINTD TUNNEL
	PRINT PCR
	...
	FSET WIGHT,SEEN
	CALL2 CTHE-PRINT,WIGHT
	PRINTI "'s eye grows wide and bold as your "
	PRINTD DSHADOW
	PRINTI " blocks the "
	PRINTD OBJ
	PRINTI ". You hesitate, then slowly retreat until the "
	PRINTD OBJ
	PRINTR " is well within reach."

	.FUNCT WIGHT-COVERS
	CALL2 CTHE-PRINT,WIGHT
	PRINTI " covers its eye with its claws and "
	RTRUE
...
?L1:	CALL2 BLOCKS-YOUR-PATH,BARROW-DOOR
	...
	PRINTI "You slide down into gloom that grows colder and colder...
...
?L1:	PRINT DONT
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "A thick, suffocating miasma lingers among the trees; the black earth is squishy with corruption. "
	CALL1 HEAR-DRIPPING
	CRLF
	PRINTI "Paths wander off in many "
	PRINTD INTDIR
	PRINTI "s. High "
	PRINTD RWALLS
	PRINTI " curve away"
	...
	PRINTI " at your feet is striped with colorful layers of rock. Narrow paths twist northeast and northwest, uneasily close to the edge. Other trails lead off into the forest.

To the north, a rocky "
	PRINTD MESA
	PRINTI " towers like a golf tee from the depths of the "
	PRINTD CHASM
	PRINTI ". Only thirty feet separate you from its flattened summit."
	CRLF
	FSET? OAK,NOALL \?L3
	CRLF
	PRINTR "An oak tree stands at the chasm's brink."
?L3:	FSET? OAK,TOUCHED \TRUE
	CRLF
	PRINTI "An oak tree lies fallen across the "
	FSET? OAK,WINDY \?L6
	PRINTD CHASM
	JUMP ?L8
?L6:	PRINTD GROUND
...
?L1:	CALL1 CHASM-FALL
	...
	.FUNCT OAK-STEP
	PRINTI "You step gingerly across the fallen oak"
	RTRUE
...
?L3:	FSET? HERE,TRYTAKE \?L4
	...
	SET 'P,1
?L6:	PRINTI "You step boldly over the "
	PRINTD X
	PRINTI "'s brink"
	ZERO? SUITED? \?L11
	ZERO? P /?L9
?L11:	PRINTI " and float down, buoyed by the "
	ZERO? SUITED? \?L12
	PRINTI "open "
	PRINTD PARASOL
	PRINTI ". But its cloth panels get tangled"
	JUMP ?L14
?L12:	PRINTD FILM
...
?L15:	PRINTI ", and you "
	JUMP ?L18
?L9:	PRINTI ", and "
?L18:	PRINTI "plummet to a painful end."
	CALL1 JIGS-UP
	RFALSE
...
?L1:	CALL1 CANT-GO
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "Smooth walls of rock vault straight up and then lean inward, forming a natural roof that partially hides the sky. Trails lead out from under the cliff in many "
	PRINTD INTDIR
	PRINTI "s.

A swarm of bees has staked out this formation for itself by "
	PRINTD SCHOOL
	PRINTI " an enormous hive under the arch. "
	CALL1 HEAR-HIVE
	RTRUE
	...
	PRINTD SOUND
	PRINTR " from the hive is magnified by the cliff's acoustics into a loud, frightening drone."

	.FUNCT AT-CRATER-F,CONTEXT=0
	EQUAL? CONTEXT,M-LOOK \FALSE
	SET 'P-IT-OBJECT,CRATER
	CALL2 CTHE-PRINT,FOREST
	PRINTI " around you is bent and splintered, as if a mighty fist had smashed through the branches. Sooty fumes hang in the air; the earth is dark with ashes and "
	PRINTD RUBBLE
	PRINTI ".

The "
	CALL1 SAY-EAST
	PRINTI "ern path ends at the lip of a deep "
	PRINTD CRATER
	PRINTR ", forty or fifty feet across."

	.FUNCT ENTER-CRATER
	PRINTI "You climb down into the "
	PRINTD CRATER
	PRINT PCR
	RETURN IN-CRATER

	.FUNCT IN-CRATER-UP
	PRINTI "The only way up is to the "
	CALL1 SAY-WEST
	PRINT PERIOD
	RFALSE
	...
	PRINTD SMOKE
	PRINTI " fills the air with an acrid, smoldering stench. Blackened "
	PRINTD RUBBLE
	PRINTI " covers the sides and bottom of the "
	PRINTD CRATER
	PRINT PERIOD
	RTRUE
?L1:	EQUAL? CONTEXT,M-ENTERED \FALSE
	...
	.FUNCT EXIT-CRATER
	PRINTI "You scramble out of the "
	PRINTD CRATER
	PRINT PCR
	RETURN AT-CRATER
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "A curtain of water tumbles off the "
	CALL1 SAY-WEST
	PRINTI "ern cliffs into a deep, rocky pool. From there, a mountain stream wanders off into the "
	PRINTD FOREST
	PRINTI ". Footpaths follow the stream "
	CALL1 SAY-EAST
	PRINTI ", past a giant "
	PRINTD TS1
	...
	PRINTI "A flight of "
	PRINTD SSTEPS
	PRINTR " has been hewn into the face of the north cliff."

	.FUNCT AT-FALLS-W
	FSET? CAVE-HOLE,SEEN /?L1
	CALL2 BLOCKS-YOUR-PATH,WATERFALL
	RFALSE
?L1:	PRINTI "You edge around the curtain of water"
	PRINT PCR
	RETURN ICE-CAVE
...
?L3:	CALL2 ITS-CLOSED,TS1-DOOR
	...
	SET 'P-IT-OBJECT,PARASOL
	PRINTI "You'll never fit through the door with that open "
	PRINTD PARASOL
	PRINT PERIOD
	RTRUE
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "You're in a vast underground "
	PRINTD CAVE
	PRINTI ", cold enough to see "
	PRINTD BREATH
	PRINTI ". Icicles on the "
	PRINTD CEILING
	PRINTI " glitter in the light shining in through an "
	PRINTD CAVE-HOLE
	PRINTI " in the "
	CALL1 SAY-EAST
	PRINTI " wall. Beyond it, a curtain of water fills the "
	PRINTD CAVE
	PRINTR " with its splashing roar."

	.FUNCT THROUGH-FALLS
	PRINTI "You edge your way around the "
	PRINTD WATERFALL
	PRINT PCR
	RETURN AT-FALLS
...
?L1:	PRINT CANT
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	CALL2 CTHE-PRINT,GROUND
	PRINTI " is damp and squishy underfoot, especially along the "
	PRINTD STREAM
	PRINTI " that wanders "
	CALL1 SAY-WEST
	PRINTI " and south"
	CALL1 SAY-EAST
	PRINTR " between the black trees."

	.FUNCT GBASE-F,CONTEXT=0
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "The triangular "
	PRINTD STRUCTURE
	PRINTI " before you must be thousands of feet high. It"
	PRINT RAZOR
	PRINTI ", casting a stern, precise "
	PRINTD DSHADOW
	PRINTI " over the surrounding landscape.

A narrow "
	PRINTD STAIR
	PRINTI " climbs north, up the hypotenuse of the triangle. Footpaths converge on the stair from every "
	PRINTD INTDIR
	PRINT PERIOD
	RTRUE
	...
	PRINTI "With a fearful gulp, you ascend the narrow "
	PRINTD STAIR
	PRINT PCR
	RETURN HALFWAY
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "The breeze feels noticeably "
	EQUAL? STAIR-DIR,STR?29 \?L3
	PRINTI "cooler"
	JUMP ?L5
?L3:	PRINTI "warmer"
?L5:	PRINTI " here, about halfway to the "
	EQUAL? STAIR-DIR,STR?29 \?L6
	PRINTD VERTEX
	JUMP ?L8
?L6:	PRINTD GROUND
?L8:	PRINT PTHE
	PRINTI "landscape below is gray in the "
	PRINTD DSHADOW
	...
	JUMP ?L3
?L1:	PRINTI "cold"
?L3:	PRINTI "er as you continue your "
	ZERO? UP? \?L4
	PRINTI "de"
	JUMP ?L6
?L4:	PRINTI "a"
?L6:	PRINTI "scent"
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "The temperature on this tiny "
	PRINTD PLATFORM
	PRINTI " is well below freezing. But it isn't just the cold that makes your teeth chatter when you look down that narrow "
	PRINTD STAIR
	PRINTI ", thousands of feet high.

Far below, the "
	PRINTD DSHADOW
	PRINTI " of the "
	PRINTD STRUCTURE
	PRINTI " stretches across the landscape. From this great altitude it looks like a dark finger, accusing a point on the "
	GET SHDIRS,3 >STACK
	PRINT STACK
	PRINTI " "
	PRINTD HORIZON
	...
	SET 'STAIR-DIR,STR?146
	PRINTI "Fighting back fear, you descend the "
	PRINTD STAIR
	PRINT PCR
	RETURN HALFWAY
	...
	PRINTI "Tall, solemn "
	PRINTD CATS
	PRINTI " line the banks of a great river that flows "
	CALL1 SAY-EAST
	PRINTI "ward across the silent moor. A dense fog on the water obscures your view of the "
	PRINTD OPSHORE
	PRINTI ".

A pair of giant "
	PRINTD TS0
	PRINTI "s is growing among the "
	PRINTD CATS
...
?L1:	FSET? TS5-DOOR,OPENED \?L3
	...
	PRINTI " through "
	JUMP ?L9
?L7:	PRINTI "pass the threshold of "
?L9:	CALL2 THE-PRINT,TS5-DOOR
	PRINTI "..."
	CALL1 CARRIAGE-RETURNS
	PRINTI "... and step into empty air"
	PRINT PCR
	RETURN IN-SKY
?L3:	CALL2 ITS-CLOSED,TS5-DOOR
	...
	PRINTI " you've climbed lies at the south"
	CALL1 SAY-WEST
	PRINTI " edge of a vast wilderness. Towering "
	PRINTD FOREST
	PRINTI "s are broken by long tracts of wasteland, rugged plateaus and marshes shrouded in perpetual mist. A brooding sun fills the distant "
	PRINTD VALLEY
	PRINTI "s with a sad, dusty light the color of antique brass.

A "
	PRINTD DSTRUCT
	PRINTI ", thousands of feet high, rises above the "
	CALL1 SAY-EAST
	PRINTI "ern "
	PRINTD TREETOPS
	PRINTI ". Its vertex casts a long "
	PRINTD DSHADOW
	PRINTI " across the wood.

As your eyes sweep the landscape, you notice more of the giant "
	PRINTD STOOLS
	PRINTI ". "
	CALL1 HUNDREDS-OF-THEM
	PRINTI " Some sprout in clusters, others grow in solitude among the trees. Their "
	PRINTD INTNUM
	PRINTI "s increase dramatically as your gaze moves "
	CALL1 SAY-WEST
	PRINTI "ward, until the "
	PRINTD FOREST
	PRINTR " is choked with pale domes."

	.FUNCT HUNDREDS-OF-THEM
	PRINTI "There must be hundreds of them."
	RTRUE

	.FUNCT FCLEARING-F,CONTEXT=0
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "It must have taken centuries to cultivate the magnificent "
	PRINTD HEDGE
	PRINTI " rising before you. The tightly woven "
	PRINTD ARBS
	PRINTI " stretch "
	CALL1 SAY-EAST
	PRINTI "ward through the "
	PRINTD FOREST
	PRINTI " like a green wall, thirty feet high.

A barren hilltop is visible to the "
	CALL1 SAY-WEST
	PRINTI ". Many footpaths wander off"
	CALL1 TWEEN-TREES
	RTRUE

	.FUNCT AT-TRELS-F,CONTEXT=0
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "A fortresslike wall of "
	PRINTD ARBS
	PRINTI " stretches east and west through the "
	PRINTD FOREST
	PRINT PTHE
	PRINTI "only breach is an identical pair of arched "
	PRINTD TRELS
	PRINT PCR
	PRINTI "A mountain "
	PRINTD STREAM
	PRINTI " trickles"
	CALL2 TWEEN-TREES,0
	PRINTI ". Paths wander from its banks in many "
	PRINTD INTDIR
	PRINTR "s."
	...
	CRLF
	PRINTI "Footpaths wander north, west and northwest. Turning south, you see a magnificent "
	PRINTD HEDGE
	PRINTI " growing in an unbroken wall to the "
	PRINTD STYX
	PRINTR "'s edge."
?L1:	EQUAL? CONTEXT,M-ENTERED \FALSE
	...
	PRINTI "in a dory"
	JUMP ?L3
?L1:	PRINTI "on a lifeless strip of sand"
?L3:	PRINTI " beside a great "
	PRINTD STYX
	PRINT PTHE
	PRINTI "water is unnaturally dark and still; ribbons of mist coil across its "
	PRINTD CSURFACE
	PRINTR " like ghostly fingers, obscuring what lies beyond."
...
?L1:	CALL1 WHICH-WAY-OUT
	...
	PRINTI "An exhausted "
	PRINTD STREAM
	PRINTI " trickles into a river that bends"
	PRINT TOS
	PRINTI " and "
	CALL1 SAY-EAST
	PRINT PTHE
	PRINTD OPSHORE
	PRINTI " is veiled behind a thick mist.

Paths meander off in many "
	PRINTD INTDIR
	PRINTR "s from the river's edge."

	.FUNCT IN-MEADOW-F,CONTEXT=0
	EQUAL? CONTEXT,M-LOOK \?L1
	PRINTI "You've discovered a golden "
	PRINTD MEADOW
	PRINTI ", bordered on every side by a dense "
	PRINTD FOREST
	PRINT PTHE
	PRINTI "air is filled with "
	PRINTD DFLIES
	PRINTI ", and the wood echoes with the cry of mourning doves"
	PRINT PCR
	FSET? IN-MEADOW,SHADOWY \?L3
	PRINTI "A giant "
	PRINTD TS0
	PRINTR " is growing nearby."
?L3:	PRINTI "The door you just stepped from opens into a "
	PRINTD TS0
	PRINTI " of impossible size. Its broad crown towers over your head like a fleshy "
	PRINTD PARASOL
	PRINT PERIOD
	RTRUE
?L1:	EQUAL? CONTEXT,M-ENTERED \?L6
...
?L6:	EQUAL? CONTEXT,M-EXIT \FALSE
	...
	PRINTI "The dense "
	PRINTD FOREST
	PRINTI " is hopelessly impenetrable"
	FSET? IN-MEADOW,SEEN \?L1
	PRINT PERIOD
	RFALSE
?L1:	FSET IN-MEADOW,SEEN
	PRINTI ". But an obscure path winds north, to the summit of a gentle hill."
	CRLF
	RFALSE

	.FUNCT UP-HILL
	PRINTI "You ascend the gentle "
	PRINTD SUMMIT
	PRINT PCR
	RETURN ON-HILL
	...
	PRINTI "Barely eighteen inches separate the thick walls of arborvitae that "
	PRINTD TOWER
	PRINTI " on either side. They form an uncomfortably narrow corridor that bends sharply to the "
	RTRUE

	.FUNCT WHICH-WAY-UP-NS
	CALL2 WHICH-WAY,STR?147
	RFALSE

	.FUNCT WHICH-WAY-IN-NS
	CALL2 WHICH-WAY,STR?148
	RFALSE
	...
	PRINTI " of "
	PRINTD ARBS
	PRINTI " arches over your head like a great green Ferris wheel. Its tangled "
	PRINTD CSURFACE
	PRINTI "s are peculiarly twisted, making it difficult to tell where the inside ends and the outside begins.

"
	CALL1 DESCRIBE-PERGOLA
	PRINTI "Other paths lead east and west, into the surrounding "
	PRINTD HEDGE
	PRINT PERIOD
	RTRUE
...
?L3:	PRINTI "th side of the "
	...
	PRINTI " twists alarmingly as you "
	RTRUE
	...
	PRINTI """ of the "
	PRINTD ARBOR
	PRINTR " curves up and around in an inexplicable way that makes your eyes cross. It seems as if you'd be standing on your head if you went much higher. Little daylight makes its way through the thick walls of arborvitae."
...
?L7:	CALL1 FLOOR-TWISTS
	...
	EQUAL? CONTEXT,M-LOOK \?L1
	PRINTI "The tangled vines and tendrils seem to writhe malignantly in the "
	CALL2 VISIBLE?,LAMP >STACK
	ZERO? STACK /?L3
	FSET? LAMP,LIGHTED \?L3
	PRINTI "faltering glow of the "
	PRINTD LAMP
	JUMP ?L5
?L3:	PRINTI "flickering light of the "
	PRINTD SHARD
?L5:	PRINTI ". "
	CALL1 SMELL-HEDGE
	CRLF
...
?L3:	PRINTI " your path."
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "At first glance, this isolated spit seems hopelessly mired in the fog blowing in off the surrounding river. But the sand looks a bit firmer"
	PRINT TOS
	PRINT PERIOD
	RTRUE
	...
	EQUAL? CONTEXT,M-LOOK \?L1
	PRINTI "It's impossible to see more than a dozen yards on this fogbound islet. The damp air makes your footsteps sound unnaturally loud as you trudge across the sand at the river's edge.

A lone "
	PRINTD TS6
	PRINTI " has found a home at the water's edge"
...
?L4:	IN? MEEP,TS6 \TRUE
	...
	.FUNCT ENTICINGLY
	PRINT PTHE
	PRINTI "ruby in its beak gleams enticingly"
	RTRUE
...
?L1:	FSET? TS6-DOOR,OPENED \?L3
	CALL1 BROLLY-OPEN? >STACK
	ZERO? STACK \FALSE
	PRINTI "You take a deep breath, and step forward."
	CALL1 CARRIAGE-RETURNS
	CALL1 GO-TO-SHACK
	RETURN IN-SHACK
...
?L1:	PUT TBL,0,CNT
	...
	EQUAL? CONTEXT,M-LOOK \?L1
	PRINTI "You're five hundred miles above a sea of ice, hurtling in profound silence over the Arctic atmosphere. Layers of crimson and violet describe the curve of the "
	PRINTD HORIZON
	PRINTR ", blending imperceptibly into a black sky crowded with stars."
...
?L4:	CALL1 DONT-PROPAGATE
	...
	JUMP ?L3
?L1:	PRINTI "Sound"
?L3:	PRINTR "s don't propagate well in a vacuum."

	.FUNCT NO-PROPULSION
	PRINTI "You have no means of propulsion."
	CRLF
	RFALSE
...
?L6:	PRINTI "past "
?L7:	PRINTI "you"
?L3:	PRINTI " is about twenty feet long, and shaped like a beer can"
	EQUAL? HERE,ON-SAT \?L8
	PRINT PTHE
	PRINTD FILM
	PRINTI " around you is anchored to the "
	PRINTD XRAY
...
?L8:	PRINT PERIOD
	...
	PRINTI " is attached"
	PRINT TON
	PRINTI " side of a huge steel "
	PRINTD TBOMB
	PRINTI ", fifty feet high. All around you, a frozen wasteland stretches off to a "
	PRINTD HORIZON
...
?L3:	PRINTI "A"
	...
	PRINTD TBOMB
	PRINTI "'s interior. The topmost rungs of a "
	PRINTD PLADDER
...
?L1:	FSET? TS4-DOOR,OPENED \?L3
	...
	JUMP ?L6
?L4:	PRINTI "You "
?L6:	PRINTI "leap across the jamb of the "
	PRINTD TS4-DOOR
	PRINT PERIOD
...
?L3:	CALL2 ITS-CLOSED,TS4-DOOR
	...
	PRINTI " fades away into the texture of the "
	PRINTD TS0
	PRINT PERIOD
	RTRUE
	...
	PRINTI "A network of "
	PRINTD TCABLES
	PRINTI " snakes down the side of the "
	PRINTD TBOMB
	PRINTI ", then trails southwest across the "
	PRINTD TUNDRA
	PRINTI ". Grim tracts of permafrost greet your eyes every way you turn.
...
A "
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "The frozen earth slopes north to meet a gray wall of "
	PRINTD TMOUNTS
	PRINTI ". "
	PRINT YOU-SEE
	...
	.FUNCT DESOLATION
	PRINTI "There's nothing but cold desolation in "
	PRINTD RIGHT
	PRINT PERIOD
	RFALSE
	...
	PRINTI " range east and west, dark against the frozen ground. The "
	PRINTD TBOMB
	...
	PRINTD PASS
	PRINTI " cuts a narrow pass through the "
	PRINTD TMOUNTS
	PRINTI " rising north and east. The "
	PRINTD TBOMB
	PRINTI " is a gray sentinel on the southwest "
	PRINTD HORIZON
	PRINT PERIOD
	RTRUE

	.FUNCT TO-CLIFF
	PRINTI "You follow the stream of "
	PRINTD RATS
	PRINT PCR
	RETURN CLIFF-EDGE
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "Arctic winds whip across the permafrost in bone-chilling gusts. The distant "
	PRINTD TBOMB
	PRINTI " is outlined against the eastern "
	PRINTD TMOUNTS
	PRINT PERIOD
	RTRUE
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "The barren ground stretches west towards the distant "
	PRINTD TBOMB
	PRINTI " and beyond. Gray "
	PRINTD TMOUNTS
	PRINTI " rise like a fortress"
	PRINT TOE
	PRINT PERIOD
	RTRUE
	...
	PRINTI "The tall "
	PRINTD TBOMB
	PRINTI " is still visible on the northeastern "
	PRINTD HORIZON
	PRINTI ". Thick "
	PRINTD TCABLES
	PRINTI " run southwest across the permafrost, towards a distant "
	PRINTD GROUP
	PRINT PERIOD
	RTRUE
?L1:	EQUAL? CONTEXT,M-ENTERED \FALSE
	...
	PRINTD HORIZON
	PRINTR " breaks the monotony of this frozen plain."
	...
	PRINTI " tower"
	PRINT TOW
	PRINTI " and south in a gray wall. The "
	PRINTD TBOMB
	PRINTI " stands alone on the northwest "
	PRINTD HORIZON
	PRINT PERIOD
	RTRUE
	...
	PRINTI " ends here, on a cliff overlooking an Arctic sea. But where ancient waters once fell, there now pours a living stream of "
	PRINTD RATS
	PRINTI ". Driven by mindless instinct, too stupid or frightened to turn away, they plunge by the hundreds into the crashing waves below"
	EQUAL? RATS,RODENTS \?L3
	PRINTI ". You recognize the species now. Lemmings"
?L3:	PRINTI ".

The "
	PRINTD GROUND
	PRINTI " underfoot is split by a narrow "
	PRINTD FISSURE
	PRINTI ", almost hidden by the scrambling "
	PRINTD LEMMINGS
	PRINT PERIOD
	RTRUE
?L1:	EQUAL? CONTEXT,M-ENTERED \FALSE
	...
	ZERO? STACK /?L1
	CRLF
	CALL2 VOICE-MUTTERS,STR?150
	PRINTI "You tumble "
	CALL1 CLIFF-DROWN
	RFALSE
?L1:	CRLF
	CALL VOICE-MUTTERS,STR?151,0
	RFALSE

	.FUNCT CLIFF-DROWN
	PRINTI "over the edge of the cliff, where you founder for a while in the Arctic waters."
	CALL1 JIGS-UP
	RTRUE

	.FUNCT TO-TUNDRA
	PRINTI "You force a path through the "
	PRINTD RATS
	PRINT PCR
	RETURN CTUN
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "You're in a narrow underground chamber, illuminated by "
	FSET? TS2-DOOR,NOALL /?L3
	FSET? TS2-DOOR,OPENED \?L3
	PRINTI "an open door in the east wall"
	JUMP ?L6
...
?L6:	PRINTI ". "
	...
	PRINTI "A large "
	PRINTD UBOMB
	PRINTI " occupies most of the chamber. The maze of "
	PRINTD UCABLES
	PRINTI " surrounding it trails west, into the depths of a "
	PRINTD CAVERN
	PRINT PERIOD
	...
	PRINTR " in the east wall is closed."
...
?L1:	RETURN TUN2
	...
	PRINTD CEILING
	PRINTR " are gouged with deep spiral ruts; they look as if they've been routed out with heavy machinery."
...
?L3:	CALL2 ITS-CLOSED,TS2-DOOR
	...
	PRINTI " lining the "
	PRINTD CAVERN
	PRINTI "'s walls look like bloated veins and arteries in the "
	CALL2 VISIBLE?,LAMP >STACK
	ZERO? STACK /?L3
	FSET? LAMP,LIGHTED \?L3
	IN? LAMP,PLAYER \?L5
...
?L1:	EQUAL? CONTEXT,M-ENTERED \FALSE
	...
	PRINTD MIKE
	PRINTI " you spot something moving in the corner of your eye. It's... what do you call them?... yes! A "
	PRINTD SKINK
	PRINT PERIOD
	RTRUE
	...
	PRINTD CAVERN
	PRINTI " is sealed off with a "
	PRINTD LANDSLIDE
	PRINTI " of rocks and dirt. Numerous "
	PRINTD UCABLES
	PRINTI " emerge from the "
	PRINTD RUBBLE
	PRINTI ", trailing away to the "
	CALL1 SAY-EAST
	PRINT PCR
	IN? SHARD,CREVICE \?L3
	PRINTI "Feeble light shines from a "
	JUMP ?L6
?L3:	CALL2 VISIBLE?,LAMP >STACK
	ZERO? STACK /?L5
	FSET? LAMP,LIGHTED \?L5
...
?L5:	CALL2 CTHE-PRINT,SHARD
	PRINTI "'s feeble glow reveals a "
?L6:	PRINTI "narrow "
	PRINTD CREVICE
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "Whoever threw this place together wasn't too worried about permanence. Tin walls rise on flimsy studs to a "
	PRINTD CEILING
	PRINTI " that sags under its own weight. It reminds you of a prefab tool shed, several stories high.
...
You're standing beside a monstrous conglomeration of pipes, compressors and pressure valves that fills most of the "
	...
	PRINTI " set into one of the storage tanks"
?L3:	PRINT PCR
	PRINTI "A "
	PRINTD SCAF-STAIR
	PRINTI " leads "
...
?L1:	FSET? TS3-DOOR,OPENED \?L3
	...
	PRINTI "You hesitate for a moment, then step through the "
	PRINTD TS3-DOOR
	PRINT PERIOD
...
?L3:	CALL2 ITS-CLOSED,TS3-DOOR
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "A maze of plumbing rises before you like the back of a giant refrigerator. Stairs lead up to a "
	PRINTD SCAFFOLD
...
?L5:	PRINTI "set of "
	PRINTD SDOORS
	PRINTI ", with a small box and a "
	PRINTD SPEAKER
	PRINTR " mounted on the wall beside them."
	...
	PRINTI "The waters of a peaceful "
	PRINTD LAGOON
	PRINTI " reflect the tropical dawn like a fiery mirror. A few stars are still visible in the rosy sky.

The glorified tool shed dominates this little "
	PRINTD ISLAND
	PRINTI ", leaving room only for a narrow strip of sand that curves"
	PRINT TON
	PRINTI "east and northwest. A "
	PRINTD OBUTTON
	PRINTI " is mounted on the wall beside the"
	...
	PRINTD TUBE
	PRINTI " and "
?L1:	PRINTI "follow the curve of the "
	PRINTD BEACH
	PRINT PCR
	RTRUE
	...
	FSET? LAGOON,SEEN \?L1
	PRINTI "You recall the icky things lurking in the water, and change your mind."
	CRLF
	RFALSE
?L1:	FSET LAGOON,SEEN
	PRINTI "Icky bits of slime wash past as you wade deeper into the "
	PRINTD LAGOON
	PRINTI ". Invisible creatures nip at your toes, and something big and menacing brushes your shin. Enthusiasm dwindles; you hastily return to the shore."
	CRLF
	RFALSE

	.FUNCT ESAND-F,CONTEXT=0
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "Palm trees far across the "
	PRINTD LAGOON
	PRINTI " stand in dark relief against the eastern sky. The "
	PRINTD BEACH
	PRINTI " continues northwest and southwest, around the "
	PRINTD ESHED
	PRINT PERIOD
	RTRUE
	...
	PRINTD TUBE
	PRINTI " juts out of the side of the "
	PRINTD SCHOOL
	PRINTI ", stretching away across the "
	PRINTD LAGOON
	PRINTI " as far as you can see.
...
The beach continues around the "
	...
	EQUAL? CONTEXT,M-LOOK \?L1
	PRINTI "The sand curves northeast and southeast, skirting the dark outline of the "
	PRINTD ESHED
	PRINT PCR
	PRINTI "A tiny "
	PRINTD ISLET
	PRINTR " is visible a short distance offshore."
?L1:	EQUAL? CONTEXT,M-ENTERED \FALSE
	...
	MOVE CRABS,WSAND
	SET 'P-THEM-OBJECT,CRABS
	PRINTI "A bolt of pain engulfs your foot.
...
Another crab joins the first, and another. Soon the water's edge is crowded with snapping claws."
	CRLF
	RFALSE
?L1:	PRINTI "A glance at the snapping "
	PRINTD CRABS
	PRINT CHANGES
	RFALSE
	...
	JUMP ?L5
?L3:	PRINTI "fourteen"
?L5:	PRINTI " hundred feet above a small city, "
	ZERO? SUITED? \?L8
	IN? PARASOL,PLAYER \?L6
	FSET? PARASOL,OPENED \?L6
?L8:	PRINTI "drifting slowly downward as the wind "
	ZERO? SUITED? /?L9
...
?L9:	PRINTI "fills your open "
	PRINTD PARASOL
	JUMP ?L12
?L6:	PRINTI "falling straight down at a velocity of "
...
?L12:	PRINT PCR
	PRINTI "A "
	PRINTD TS5-DOOR
	PRINTR " is dwindling away in the sky overhead."
?L1:	EQUAL? CONTEXT,M-ENTERED \FALSE
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "You're soaring high over the city on a giant "
	PRINTD CRANE
	PRINT PERIOD
	RTRUE
...
?L3:	CALL2 ITS-CLOSED,TS5-DOOR
	...
	PRINTI " Behind them stands a long "
	PRINTD SCHOOL
	PRINTI ", its "
	PRINTD SCHOOL-WINDOWS
	PRINTI " hung with "
	PRINTD FLOWERS
	PRINTI " and birds folded from colored paper.
...
Several small "
	PRINTD KIDS
	PRINTI " are happily chasing "
	PRINTD DFLIES
	PRINTI " north of the swing set. Turning south, you see a group of adults (school"
	PRINTD TEACHERS
	PRINTI ", by the looks of them), wearily digging another "
	PRINTD SHELTER
	PRINTR " like the first."
?L1:	EQUAL? CONTEXT,M-BEG \?L3
	EQUAL? PRSA,V?YELL,V?ALARM \?L3
	PRINTI "You begin to yell hysterically."
	CRLF
	CALL1 TEACHERS-NOTICE
	RTRUE
?L3:	EQUAL? CONTEXT,M-ENTERED \?L4
	...
	FCLEAR SPILE,NODESC
	CRLF
	PRINTI "Somewhat shaken, you rise to your feet in a child's "
	PRINTD SPILE
	CALL1 LOOK-IN-SPILE
	PRINT PERIOD
	RTRUE
...
?L1:	PRINTI "There are no "
	...
	ZERO? IN-SAND? /?L1
	CALL1 EXIT-SPILE
?L1:	PRINTI "You descend into the darkness"
	PRINT PCR
	RETURN IN-SHELTER
	...
	ZERO? IN-SAND? /?L3
	CALL1 EXIT-SPILE
?L3:	PRINTI "You step closer to the group of "
	PRINTD TEACHERS
	PRINT PERIOD
	...
	CRLF
	PRINTI "One teacher, a young woman, sees you "
	ZERO? COMING \?L1
	PRINTI "standing "
	ZERO? IN-SAND? \?L3
	PRINTI "by "
...
?L5:	CALL2 THE-PRINT,SPILE
	JUMP ?L6
?L1:	PRINTI "coming"
?L6:	PRINTI " and shrieks something in Japanese. Her companions quickly surround you, shouting accusations and sneering at your vacation shorts. You respond by pointing desperately at the sky, shouting ""Bomb! Big boom!"" and struggling to escape into the "
	PRINTD SHELTER
	PRINTI ".
...
?L3:	CALL2 CTHE-PRINT,KIDS
	PRINTI " cry out in surprise and fear at your approach."
	CRLF
	CALL2 TEACHERS-NOTICE,1
	RFALSE

	.FUNCT CHICKEN-OUT?,WHO
	PRINTI "You walk a little closer to "
	CALL2 THE-PRINT,WHO
	PRINTI ", but hesitate when it occurs to you that they might not take kindly to your presence"
	PRINT PCR
	CALL1 SAY-SURE
	PRINTI "go that way?"
	CALL1 YES? >STACK
...
?L1:	CALL1 NO-DETECTION
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "You wouldn't want to spend much time in this wretched hole. The bare "
	PRINTD FLOOR
	PRINTI " is damp and filthy, and the "
	PRINTD CORNER
	PRINTI "s reek of "
	PRINTD PEE
	PRINTI ". Luckily, there's an "
	PRINTD SHELHOLE
	PRINT TOW
	PRINT PERIOD
	RTRUE
	...
	.FUNCT EXIT-SHELTER
	PRINTI "You ascend into daylight"
	PRINT PCR
	RETURN PLAYGROUND
	...
	PRINTD SHACK
	PRINTI ", barely twelve feet square. The oak "
	PRINTD FLOOR
	PRINTI " is littered with discarded bits of rope, pulleys and other "
	PRINTD HARDWARE
	PRINT PA
	PRINTI "d"
	...
	JUMP ?L5
?L3:	PRINTI "ark"
?L5:	PRINTI " light bulb hangs from the "
	PRINTD CEILING
...
?L6:	FSET? SPOT,SEEN \?L9
	PRINTI "; harsh light streams in through an "
	JUMP ?L11
?L9:	PRINTI ". You can see an "
?L11:	PRINTI "exit in the west wall.

A five-foot "
	PRINTD GADGET
	PRINTI " rests on a bracket in the middle of the "
	PRINTD FLOOR
	PRINTI ". Its "
	PRINTD CSURFACE
	PRINTI " is studded with "
	PRINTD GBOLTS
	PRINTI " and crossed with electrical "
	PRINTD GCABLES
	PRINTI ", all converging in a boxlike "
	PRINTD X5
	PRINTI " nearby.

A"
	CALL OPEN-CLOSED,TS6-DOOR,1
	PRINTR " is set into the east wall."
...
?L3:	CALL2 ITS-CLOSED,TS6-DOOR
	...
	FCLEAR TS6-DOOR,OPENED
	CALL2 ITALICIZE,STR?152
	PRINTI " The door slams shut at your approach."
	CRLF
	...
	EQUAL? CONTEXT,M-LOOK \?L1
	PRINTI "A metal rail is all that stands between you and a hundred-foot drop.

Miles of barren "
	PRINTD GDESERT
	PRINTI " lie below, gray and still in the gathering dawn. Black roads radiate outward like the hands of a great clock.

This narrow "
	PRINTD TPLAT
	PRINTI " opens east into a metal "
	PRINTD SHACK
	FSET? SPOT,SEEN \?L3
	PRINT PA
	PRINTD SPOT
	...
	PRINTI " floods the "
	PRINTD PLATFORM
	PRINTI " in a raw white glare"
?L3:	PRINT PA
	PRINTD TLADDER
	PRINTI " is sticking up over the "
	PRINTD TPLAT
	PRINTR "'s edge."
?L1:	EQUAL? CONTEXT,M-ENTERED \FALSE
	SET 'STAIR-DIR,STR?36
	RFALSE

	.FUNCT TOWER-PLAT-D
	FSET? VOICES,SEEN \?L3
	PRINTI "You step towards the "
	PRINTD TLADDER
	PRINTI ", but hesitate when you hear the "
	PRINTD VOICES
	PRINTI " below"
	PRINT PCR
	CALL1 SAY-SURE
	PRINTI "go down there right now?"
	CALL1 YES? >STACK
	ZERO? STACK \?L3
	CALL1 NO-DETECTION
	RFALSE
?L3:	FSET? ON-TOWER,TOUCHED /?L7
	PRINTI "You clutch the topmost rung of the "
	PRINTD TLADDER
	PRINTI " with sweating palms. Fighting back vertigo, you begin to feel your way downward.
...
?L7:	RETURN ON-TOWER
	...
	PRINTI "A spiderweb of steel rises from the "
	PRINTD GDESERT
	PRINTI " floor below, tapering up to the "
	PRINTD PLATFORM
	PRINTI " fifty feet overhead. Thick ropes and "
	PRINTD GCABLES
	...
	.FUNCT ON-TOWER-U
	PRINTI "You tighten your grip on the "
	PRINTD TLADDER
	PRINT PCR
	RETURN TOWER-PLAT
...
?L1:	RETURN AT-ZERO
	...
	PRINTI "A steel "
	PRINTD TOWER
	PRINTI " rises overhead, black against the cloudy sky. Your eyes follow the tapered frame up the "
	PRINTD TLADDER
	PRINTI ", past dangling "
	PRINTD TROPES
	PRINTI ", to the "
	PRINTD PLATFORM
	PRINTI " at its summit.

Paved roads and "
	PRINTD ILINES
	PRINTI " lead off into the surrounding "
	PRINTD GDESERT
	PRINT PERIOD
	RTRUE
?L1:	EQUAL? CONTEXT,M-ENTERED \FALSE
	SET 'STAIR-DIR,STR?153
	...
	PRINTI "A familiar "
	PRINTD MEEP
	PRINTI " is eyeing you from its perch on the box's lid. The ruby in its beak gleams in the early dawn.

With a skillful toss, the "
	PRINTD MEEP
	PRINTR " deposits the ruby on the box. Then it leaps off and scampers eagerly around your feet. If you didn't know better, you'd swear it was glad to see you."

	.FUNCT AT-ZERO-U
	PRINTI "You grasp the rungs of the "
	PRINTD TLADDER
	PRINTI " and pull "
	PRINTD ME
	PRINTI " upward."
	...
	PRINTI "Your eyes follow the "
	PRINTD ILINES
	PRINTI " northwest, where a cluster of "
	PRINTD NBUNKERS
	PRINTI " and "
	PRINTD SLIGHT
	...
	PRINTD INTDIR
	PRINTR ", and also leads southwest.
...
Excited shouts ring out as you approach the nearest "
	PRINTD SHELTER
	PRINTI ". One of the giant lights sweeps"
	PRINT AGROUND
	PRINTI " until its beam aims directly into your eyes."
	CRLF
	CALL1 HOLD-IT
	CALL1 SURROUNDED
	RFALSE
?L1:	FSET NBUNKERS,SEEN
	...
	PRINTI " first"
	PRINT BRACKET
?L1:	PRINTI "You climb into the jeep"
	PRINT PCR
	RETURN IN-JEEP

	.FUNCT IN-JEEP-F,CONTEXT=0
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "Comfort was clearly not a consideration in the design of this jeep. The seat is narrow and hard, and your shin is scrunched up against a radio bolted to the "
	PRINTD FLOOR
	PRINT PERIOD
	RTRUE
	...
	.FUNCT EXIT-JEEP
	FSET? JDOOR,OPENED \?L1
	PRINTI "You clamber out of the jeep"
	PRINT PCR
	RETURN N75
?L1:	CALL2 ITS-CLOSED,JDOOR
	...
	PRINTI "A "
	PRINTD PROAD
	PRINTI " leads northwest across the gray "
	PRINTD GDESERT
	PRINTI ", and southeast towards the "
	PRINTD DTOWER
	PRINT PERIOD
	RTRUE
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "Stubby poles draped with "
	PRINTD ILINES
	PRINTI " follow a "
	PRINTD PROAD
	PRINTI " northwest "
	...
	PRINTI " is a dim outline against the southeast "
	PRINTD TMOUNTS
	PRINT PERIOD
	RTRUE
	...
	PRINT TOS
	PRINTI ". It's the only landmark in this empty "
	PRINTD GDESERT
	PRINT PERIOD
	RTRUE
	...
	PRINTI " on the southwest "
	PRINTD HORIZON
	PRINTI " stands alone against the surrounding "
	PRINTD GDESERT
	PRINT PERIOD
	RTRUE
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "You're standing at the edge of a shallow "
	PRINTD TCRATER
	PRINTI " in the "
	PRINTD GDESERT
	PRINTI " floor, a few hundred feet across. The ground within is gray and pulverized, as if by a powerful explosion.

A "
	PRINTD PROAD
	PRINTI " leads southeast "
	PRINT INTO-DESERT
	PRINTI ", and northwest towards the "
	PRINTD DTOWER
	PRINT PERIOD
	RTRUE
	...
	PRINTI "A tall "
	PRINTD FRAME
	PRINTI " of steel has been erected here, cousin to the larger "
	PRINTD TOWER
	PRINTI " visible not far"
	PRINT TOE
	PRINTI ". Suspended within the frame is an enormous metal "
	PRINTD JUMBO
	PRINTI ", at least twenty feet long and ten wide, with rounded end caps. It looks like a king-sized cold capsule.

A "
	PRINTD DTRAIL
	PRINTR " curves north and south."

	.FUNCT W25-F,CONTEXT=0
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "A "
	PRINTD PROAD
	PRINTI " leads northeast towards the "
	PRINTD DTOWER
	PRINTI ", and southwest "
	PRINT INTO-DESERT
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	CALL2 CTHE-PRINT,DTOWER
	PRINTI " is a faint outline on the northeast "
	PRINTD HORIZON
	PRINT PTHE
	PRINTD RANCH-ROAD
	PRINTI " leading from it continues southwest, "
	PRINT INTO-DESERT
	PRINT PERIOD
	RTRUE
	...
	PRINTI "A "
	PRINTD PROAD
	PRINTI " bears off in a straight northeast/southwest line. Another road bends southeast, and a "
	PRINTD DTRAIL
	PRINTI " peters off"
	PRINT TON
	PRINTR "west."
	...
	PRINTI "The military "
	PRINTD BHOUSE
	PRINTI " by the roadside is squat and windowless. A powerful "
	PRINTD SLIGHT
	PRINTI ", mounted on the roof, directs an intense beam "
	ZERO? DISTRACTION /?L3
	PRINTI "onto the road"
	JUMP ?L5
?L3:	PRINTI "towards the northeast horizon"
?L5:	PRINT PERIOD
	RTRUE
...
?L8:	IN? FEATHERS,W100 \FALSE
	...
	FSET FEATHERS,SEEN
	CRLF
	PRINTI "A little pile of gray "
	PRINTD FEATHERS
	PRINTI " lies scattered"
	PRINT AGROUND
	PRINTI ". You watch in silence as the last few blow away across the "
	PRINTD GDESERT
	PRINT PERIOD
	RTRUE

	.FUNCT W100-NW
	PRINTI "You skirt around the "
	PRINTD BHOUSE
	PRINT PCR
	RETURN D5
	...
	CALL2 AIMLESS,D9
	RETURN D9
?L1:	PRINTI "Another look at the shepherd encourages you not to go that way."
	CRLF
	RFALSE

	.FUNCT S25-F,CONTEXT=0
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "A paved road bears north towards the tower, and south "
	PRINT INTO-DESERT
	PRINT PERIOD
	RTRUE
	...
	PRINTI "A "
	PRINTD PROAD
	PRINTI ", straight and level, bears in a north/south line across the "
	PRINTD GDESERT
	PRINT PERIOD
	RTRUE
	...
	PRINTI "A "
	PRINTD PROAD
	PRINTI " bears north and south across the "
	PRINTD GDESERT
	PRINTI ". Another road bends northwest, and a "
	PRINTD DTRAIL
	PRINTI " wanders off"
	PRINT TOS
	PRINTR "east."
	...
	EQUAL? CONTEXT,M-LOOK \?L1
	PRINTI "You're hiding behind a small storage "
	PRINTD SHED
	PRINTI ".

Peeking around the "
	PRINTD CORNER
	PRINTI ", you see a large earth-covered "
	PRINTD SBUNK
	PRINTI " immediately"
	PRINT TON
	PRINTI "east. Several "
	...
	PRINTD GIS
	PRINTI ","
?L3:	PRINTI " are parked around the "
	PRINTD SBUNK
	PRINTI "'s open "
	PRINTD SBENTRY
	PRINT PCR
...
?L1:	EQUAL? CONTEXT,M-ENTERED \?L6
	...
	CRLF
	PRINTI "A pear-shaped man appears at the "
	PRINTD SHELTER
	PRINTI "'s "
	PRINTD SBENTRY
	PRINTR ". He strides up to one of the jeeps and taps the young driver on the shoulder. ""General Groves, soldier. Take me back to Base Camp.""
...
?L13:	PRINTI " at the "
	RANDOM 100 >STACK
	LESS? 50,STACK /?L14
	PRINTI "sound of a nearby voice"
	JUMP ?L16
?L14:	PRINTI "sight of people nearby"
?L16:	PRINT PCR
	RTRUE

	.FUNCT S100-NE
	PRINTI "You start to move towards the "
	PRINTD SHELTER
	CALL2 BUT-HESITATE,STR?154
	RFALSE

	.FUNCT S100-S
	PRINTI "You start to move south"
	CALL2 BUT-HESITATE,STR?155
	RFALSE

	.FUNCT BUT-HESITATE,STR
	PRINTI ", but hesistate when you notice one of the "
	PRINTD GIS
	GRTR? MINUTES,27 \?L1
	PRINTI " in the "
	PRINTD TRENCHES
...
?L4:	CRLF
	CALL1 YOU-MARCH
	PRINTI " away from the safety of the shed.

The GI "
	EQUAL? STR,STR?154 \?L7
	PRINTI "with the rifle"
	JUMP ?L9
?L7:	PRINTI "drops his binoculars and"
?L9:	PRINTI " leaps out of his "
	LESS? MINUTES,28 \?L10
	PRINTD JEEP
	JUMP ?L12
?L10:	PRINTI "trench"
?L12:	PRINTI ". ""Wha... Who the hell is "
...
?L1:	PRINTI "march confidently"
	...
	.FUNCT S100-E
	PRINTI "You slip quietly around the back of the shed"
	PRINT PCR
	RETURN D11
	...
	PRINTI "Muted "
	PRINTD VOICES
	PRINTI " and crackling radios can be heard inside the "
	PRINTD SBUNK
	PRINT PERIOD
	RTRUE
	...
	PRINTI "A "
	PRINTD PROAD
	PRINTI " leads southeast and northwest across the "
	PRINTD GDESERT
	PRINT PERIOD
	RTRUE
	...
	PRINTD GDESERT
	PRINTI " stretches away in every "
	PRINTD INTDIR
	PRINT PERIOD
	RTRUE
...
?L3:	CALL2 AIMLESS,DEST
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "You're surrounded by a vast "
	PRINTD GDESERT
	PRINTR " landscape, utterly barren and featureless."
...
?L4:	CALL2 AIMLESS,DEST
	...
	PRINTD GDESERT
	PRINTI " slopes upward to join the "
	PRINTD FHILLS
	PRINTR " in the east."
...
?L4:	CALL2 AIMLESS,DEST
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "Nothing breaks the monotony of the barren "
	PRINTD GDESERT
	PRINTR " around you."
...
?L4:	CALL2 AIMLESS,DEST
	...
	PRINTI "Gray, empty "
	PRINTD GDESERT
	PRINTR " stretches away on either side of a road that leads southeast."
...
?L4:	CALL2 AIMLESS,DEST
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "Rugged foothills slope eastward, away from the "
	PRINTD GDESERT
	PRINTR " wasteland."
...
?L4:	CALL2 AIMLESS,DEST
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "A range of foothills slopes up to meet the "
	PRINTD TMOUNTS
	PRINTR " in the east."
...
?L5:	CALL2 AIMLESS,DEST
	...
	PRINTI "The distant "
	PRINTD DTOWER
	PRINTI " is the only point of reference in this bleak "
	PRINTD GDESERT
	PRINTR " expanse."
...
?L4:	CALL2 AIMLESS,DEST
	...
	PRINTI " around you is flat and empty. Only the distant "
	PRINTD DTOWER
	PRINTR " relieves the monotony of the landscape."
...
?L4:	CALL2 AIMLESS,DEST
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	CALL2 CTHE-PRINT,GDESERT
	PRINTR " is still and expectant in the gray light of dawn."
...
?L3:	CALL2 AIMLESS,DEST
	...
	PRINTD GDESERT
	PRINTR " surround you on every side."
...
?L4:	CALL2 AIMLESS,DEST
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "A lone road wanders northwest across the empty "
	PRINTD GDESERT
	PRINT PERIOD
	RTRUE
...
?L4:	CALL2 AIMLESS,DEST
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "You're at the northwest "
	PRINTD CORNER
	PRINTI " of a "
	PRINTD SWALL
	PRINTI ". A"
	CALL OPEN-CLOSED,NWGATE,1
	PRINTI " leads in to a dilapidated "
	PRINTD RANCH
	PRINT PCR
	PRINTI "A "
	PRINTD RANCH-ROAD
	...
	PRINT INTO-DESERT
	PRINTR ". Other paths curve east and south, along the wall's perimeter."

	.FUNCT NWYARD-F,CONTEXT=0
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "This patch of dust lies within the elbow of the "
	PRINTD RANCH
	PRINTI ", and is enclosed by a "
	PRINTD SWALL
	PRINT TON
	PRINTI " and west.
...
An open "
	PRINTD SHALL
	PRINTI " leads south, into the house. There's also a"
	...
	PRINTD RANCH
	PRINTI " stands nearby, bounded by dusty patches of ground and a low "
	PRINTD SWALL
	PRINTI ". Paths lead south and east, on either side of a cement "
	PRINTD RESERVOIR
	PRINT PA
	PRINTD RANCH-ROAD
	PRINTI " bends off"
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "This room is stripped bare of all furnishings. Only a rectangular area in the "
	PRINTD CORNER
	PRINTI ", lighter than the "
	PRINTD FLOOR
	PRINTI " around it, belies the former presence of a mattress.

A"
	CALL OPEN-CLOSED,BROOM-DOOR,1
	PRINTI " in the east wall leads outside. Another exit opens west, into the "
	PRINTD RANCH
	PRINT PERIOD
	RTRUE
	...
	PRINTD SINK
	PRINTR ", broken and faucetless, is the only fixture left in this tiny chamber. The south exit doesn't even have a door."
	...
	CALL OPEN-CLOSED,NROOM-DOOR,1
	PRINT TOW
	PRINTR ", this squarish room offers no amenities. Other exits lead north and east."

	.FUNCT NWROOM-F,CONTEXT=0
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTR "The original purpose of this stark room is uncertain; it might have been used for dining. Exits lead north, south and east."

	.FUNCT NEROOM-F,CONTEXT=0
	EQUAL? CONTEXT,M-LOOK \?L1
	PRINTI "Whoever used this room was paranoid about dirt. The floor is swept spotless, and the edges of both "
	PRINTD AWINDOWS
	PRINTI " are carefully sealed with tape. A"
	CALL OPEN-CLOSED,NEROOM-DOOR,1
	PRINTI " leads east, and there's a"
	FSET? CLOSET-DOOR,OPENED \?L3
	PRINTI "n open "
	PRINTD CLOSET
	JUMP ?L5
?L3:	PRINTI " closed"
?L5:	PRINTR " door in the north wall. Other exits lead south and west."
?L1:	EQUAL? CONTEXT,M-ENTERED \?L6
	FSET? XSNAKE,NODESC \?L6
	FCLEAR XSNAKE,NODESC
	CALL QUEUE,I-SNAKE,-1
	CRLF
	PRINTI "You turn to face an urgent noise behind you. Your heart skips a beat. Two tiny eyes, bright with hunger, black with menace, are glaring at you from only a few feet away"
	PRINT PCR
	CALL1 HEAR-SNAKE
	RTRUE
?L6:	EQUAL? CONTEXT,M-EXIT \FALSE
	FSET? SNAKE,LIVING \FALSE
	FSET SNAKE,SEEN
	PRINTI "You beat a hasty retreat from the "
	PRINTD SNAKE
	PRINT PCR
	RTRUE
	...
	PRINTR "You hear the noise again. It's like a pebble in an empty can."

	.FUNCT IN-CLOSET-F,CONTEXT=0
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "There's barely enough room to turn around in this puny "
	PRINTD CLOSET
	PRINTI ". Its single "
	FSET? CLOSET-DOOR,OPENED \?L3
	PRINTI "open"
	JUMP ?L5
?L3:	PRINTI "closed"
?L5:	PRINTR " door is in the south wall."
	...
	PRINTI " in it"
?L3:	PRINTI " are the only evidence of this room's identity. A"
	CALL OPEN-CLOSED,SWROOM-DOOR,1
	PRINTI " in the west wall leads out to a "
	PRINTD SHALL
	PRINTR ". Other exits lead north and east."

	.FUNCT SEROOM-F,CONTEXT=0
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "Something about this room gives you the impression that it was hastily vacated. The "
	PRINTD SEROOM-DOOR
	PRINTI " in the east wall is "
	FSET? SEROOM-DOOR,OPENED \?L3
	PRINTI "wide open"
	JUMP ?L5
?L3:	PRINTI "closed"
?L5:	PRINTR ". Other exits lead north and west."
	...
	PRINTD KITCHEN
	PRINTI ". Turning west, you see a "
	PRINTD ISTAIR
	PRINTR " descending into darkness."
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	CALL1 FEEL-IHOUSE
	PRINTI " It feels as if nobody's been down here for a long time.
...
Gray light seeps in from a "
	...
	.FUNCT FEEL-IHOUSE
	PRINTI "The walls of this underground chamber are cool and clammy to your touch."
	RTRUE
	...
	PRINTI "The low "
	PRINTD SWALL
	PRINTI " before you is almost as run-down as the "
	PRINTD RANCH
	PRINTI " inside it. Paths follow the wall's perimeter"
	PRINT TON
	PRINTI " and east, and a"
	CALL OPEN-CLOSED,SWGATE,1
	PRINTR " leads northeast into a dusty yard."
	...
	PRINTD CORNER
	PRINT PA
	PRINTI "raised deck stands immediately"
	PRINT TON
	PRINTI ", and a"
	CALL OPEN-CLOSED,SEGATE,1
	PRINTR " in the wall leads southeast."

	.FUNCT CLIMB-PORCH
	PRINTI "You stride onto the deck"
	PRINT PCR
	RETURN ON-PORCH
	...
	PRINTI "The low "
	PRINTD SWALL
	PRINTI " enclosing this dilapidated "
	PRINTD RANCH
	PRINTI " has a"
	CALL OPEN-CLOSED,SEGATE,1
	PRINTI " leading inside. Paths follow the wall's perimeter"
	PRINT TON
	PRINTI " and west, and another curves east along a cement "
	PRINTD RESERVOIR
	PRINT PERIOD
	RTRUE
	...
	PRINT PA
	PRINTD SHALL
	PRINTI " opens north into the house, and a"
	CALL OPEN-CLOSED,SWGATE,1
	PRINTR " in the wall leads southwest."
...
?L3:	FSET? RIGHT-DOOR,OPENED \?L6
	SET 'R,1
?L6:	PRINTI "You're on a raised deck attached"
	PRINT TOE
	PRINTI " side of the "
	PRINTD RANCH
	PRINTI ". Two "
...
?L13:	PRINTI "one at the deck's left "
	PRINTD CORNER
	PRINTI " and "
	ZERO? B \?L16
	CALL2 SAY-A-DOOR,RIGHT-DOOR
?L16:	PRINTR "one at the right, lead inside. A gentle ramp slopes down to the front yard."
...
?L1:	PRINTI " closed "
	...
	PRINTI "[Which way do you want to go in, northwest or southwest?]"
	CRLF
	RFALSE
...
?L6:	SET 'P-THEM-OBJECT,RIGHT-DOOR
	PRINTI "Both of the doors are closed."
	CRLF
	RFALSE
?L7:	PRINTI "You step inside the "
	...
	PRINTI "You climb off the deck"
	PRINT PCR
	RTRUE

	.FUNCT ERANCH-F,CONTEXT=0
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "This patch of ground lies between the "
	PRINTD RANCH
	PRINT TOW
	PRINTI ", and a huge cement "
	PRINTD RESERVOIR
	PRINT TOE
	PRINTI ". Well-worn paths curve north and south, around the "
	PRINTD SWALL
	PRINTI " enclosing the house. Other trails skirt the "
	PRINTD RESERVOIR
	PRINTI " on either side.

A ramp slopes up through a gap in the "
	PRINTD SWALL
	PRINTR ", ending on a raised deck."
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "You're resting at the north side of a big cement "
	PRINTD RESERVOIR
	PRINTI ". Dusty paths curve west and southwest around a "
	PRINTD RANCH
	PRINTI ", and a trail leads southeast to the base of a "
	PRINTD MILL
	PRINT PERIOD
	RTRUE
	...
	PRINTD MILL
	PRINTI " rises overhead, its dark timbers tapering up to a "
...
?L5:	PRINTD LANDING
	...
	JUMP ?L8
?L6:	PRINTI " overlooks"
?L8:	PRINTI " the east side of an adjacent "
	PRINTD RESERVOIR
	PRINTI ".

The bottom rungs of a "
	PRINTD MLADDER
	PRINTR " are just within reach."

	.FUNCT CLIMB-MILL
	FSET? BINOS,TOUCHED \?L1
	SET 'P-IT-OBJECT,LANDING
	CALL2 CTHE-PRINT,LANDING
	PRINTI " overhead is broken. "
	PRINT CANT
	PRINTI "climb up to it anymore."
	CRLF
	RFALSE
?L1:	FSET? IN-MILL,TOUCHED /?L3
	CALL QUEUE,I-MILL,-1
?L3:	CALL2 CTHE-PRINT,MLADDER
	PRINTI " squeaks and complains as you ascend"
	PRINT PCR
	RETURN IN-MILL
	...
	PRINTD LANDING
	PRINTI " near the top of the "
	PRINTD MILL
	PRINT PTHE
	PRINTI "rotting planks underfoot creak ominously as you stand on them.
...
A rickety "
	...
	CALL2 CTHE-PRINT,OBJ
	PRINTR " groans under your weight."

	.FUNCT SCIST-F,CONTEXT=0
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "You're near the south side of a big cement "
	PRINTD RESERVOIR
	PRINTI ". Dusty paths lead west and northwest around a "
	PRINTD RANCH
	PRINTI ". Another curves northeast, to the base of a "
	PRINTD MILL
	PRINTI ".
...
A "
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "You're on the edge of a big concrete "
	PRINTD RESERVOIR
	PRINTR ", filled with dark water. A short flight of steps leads down to the ground."
...
?L16:	CALL2 ITALICIZE,STR?157
	...
	EQUAL? CONTEXT,M-LOOK \FALSE
	PRINTI "You're treading water in a big cement "
	PRINTD RESERVOIR
	PRINTR ", too deep for your feet to touch bottom."
...
?L4:	RETURN UNDER-WATER
	...
	EQUAL? CONTEXT,M-LOOK \?L1
	PRINTI "Suspended particles of muck swirl in the beam of the "
	PRINTD LAMP
	PRINTR ". It's impossible to see more than a few feet."
?L1:	EQUAL? CONTEXT,M-BEG \FALSE
...
?L1:	PRINTI "You rise to the "
	...
	CRLF
	CALL1 SOUNDLESS-LANDING
	PRINTI ". Something in the way he crooks his skeletal finger compels you to board. You surrender "
...
?L3:	PRINTI "a "
	PRINTD BCOIN
	PRINTI " you didn't know you had"
?L5:	PRINTI ", take a seat and wait patiently for your first glimpse of the "
	PRINTD OPSHORE
	PRINT PERIOD
	RTRUE
	...
	CALL1 V-SCORE
	CRLF
	PRINTI "Do you want to restart the story, restore a saved position, or quit?"
	CRLF
	CRLF
...
?L3:	PRINTI "You're sick of looking at "
	CALL1 THE-PRINT
	PRINT PERIOD
	RTRUE
...
?L18:	PRINTR "dark, with scattered clouds."
?L17:	PRINTR "bright with sunshine."
...
?L8:	FSET? HERE,CHILLY \?L11
	PRINTR " is hidden by the overcast."
...
?L7:	PRINTI "Your "
	...
	PRINTR "'s digits are flashing randomly."
?L8:	CALL1 TELL-TIME
	ZERO? FREEZE? /TRUE
	CRLF
	PRINTR "(That's odd. The ""seconds"" display has stopped working.)"
...
?L15:	EQUAL? PRSA,V?CLOSE \FALSE
	CALL2 ITS-ALREADY,STR?57
	RTRUE

	.FUNCT FORGOT-HOW
	PRINTI "You forgot how to operate your electronic "
	PRINTD PRSO
	PRINTR " long ago."
	...
	PRINTI " is worth fifty pence, not thirty."
	CRLF
	RETURN 2
?L1:	CALL2 HANDLE-COIN?,STR?158 >STACK
	ZERO? STACK \TRUE
	RFALSE
	...
	PRINTI "It's standard British currency, worth "
	PRINT STR
	PRINTI " pence"
	FSET? PRSO,FLIPPED \?L3
	PRINTI ". This one seems to have been minted backwards"
?L3:	PRINT PERIOD
	RTRUE
...
?L9:	PRINTR "Tails."
	...
	SET 'LAYAWAY,3
	RFALSE
?L3:	CALL2 HANDLE-COIN?,STR?159 >STACK
	ZERO? STACK \TRUE
	RFALSE
	...
	FSET? PRSO,FLIPPED \?L3
	PRINTI "(backwards) "
?L3:	PRINTR "with the usual codes. It expires tomorrow."

	.FUNCT PIGEONS-F
	EQUAL? PRSA,V?EXAMINE,V?WATCH \?L1
	CALL1 CTHE-PRINT
	PRINTR " stare back at you hungrily."
...
?L9:	CALL2 CTHE-PRINT,PIGEONS
	...
	CALL1 TAKE-CRUMBS
	RTRUE
?L4:	CALL NOT-LIKELY,PRSI,STR?160
	RTRUE
...
?L7:	EQUAL? PRSA,V?SHOW \FALSE
	...
	JUMP ?L13
?L11:	PRINTI " swim"
?L13:	PRINTI " about excitedly at the sight of "
	JUMP ?L14
?L9:	PRINTI " don't seem to care about "
?L14:	CALL1 THE-PRINT
	PRINT PERIOD
	RTRUE
...
?L9:	EQUAL? PRSA,V?CLOSE \FALSE
	...
	.FUNCT DESCRIBE-GATE
	PRINTI "The gate is swarming with "
	CALL1 SAY-TOURISTS
	PRINT PERIOD
	RTRUE
	...
	JUMP ?L3
?L1:	PRINTI "ignore"
?L3:	PRINTR " your hopeless attempt."
...
?L30:	CALL1 HANDLE-WATER? >STACK
	...
	PRINTI "You can see it sparkling"
	CALL2 TWEEN-TREES,0
	PRINT TOE
	PRINT PERIOD
	RTRUE
...
?L9:	CALL1 CANT-FROM-HERE
	...
	PRINTI "Ducks and swans paddle between the "
	ZERO? RAID? /?L3
	PRINTD GDESERT
	PRINTI "ed "
?L3:	PRINTD BOAT
...
?L1:	EQUAL? PRSA,V?LOOK-ON,V?LOOK-INSIDE,V?SEARCH \?L6
	PRINTI "Aside from the birds and boats, you see "
	CALL2 PRINT-CONTENTS,PRSO
	PRINTI " on the "
	PRINTD PRSO
	PRINT PERIOD
...
?L6:	EQUAL? PRSA,V?DRINK,V?DRINK-FROM,V?TASTE \?L7
	...
	ZERO? RAID? /?L8
	PRINTI "frightened "
?L8:	PRINTI "child relieving itself in the pond"
	PRINT CHANGES
	RTRUE
...
?L11:	CALL1 HANDLE-WATER? >STACK
	...
	FSET? PRSO,OPENED \?L6
?L8:	CALL1 CTHE-PRINT
	PRINTI " might float out of reach"
	PRINT IF-YOU-DID
	RTRUE
?L6:	CALL1 VANISH
	CALL1 CTHE-PRINT
...
?L20:	INTBL? PRSA,TOUCHVERBS,NTOUCHES >STACK \FALSE
	...
	PRINTR "twinkling."
?L4:	PRINTI "skillfully folded from a "
	PRINTD OCRANE
	PRINTR ". Something is written between the folds."
?L3:	EQUAL? PRSA,V?READ,V?LOOK-ON,V?LOOK-INSIDE /?L8
	EQUAL? PRSA,V?SEARCH \?L7
?L8:	CALL YOUD-HAVE-TO,STR?161,PRSO
	RTRUE
...
?L19:	CALL1 CRANE-LIT? >STACK
	...
	PRINTI "Done. All that's left is a "
	PRINTD BAD-CRANE
	PRINT PERIOD
	RTRUE
...
?L23:	EQUAL? PRSA,V?TAKE \FALSE
	...
	CALL1 ITAKE >STACK
	ZERO? STACK /TRUE
	PRINTI "You lean over the edge of the "
	PRINTD RPOND
...
?L4:	PRINTI "The words """
	...
	PRINTI "kcolC'O ruoF ,retaW gnoL"
	JUMP ?L7
?L5:	PRINTI "Long Water, Four O'Clock"
?L7:	PRINTI """ are scrawled on the "
	PRINTD PRSO
	PRINT PERIOD
	RTRUE
...
?L18:	EQUAL? PRSA,V?FOLD,V?REPAIR,V?CLOSE \FALSE
	...
	.FUNCT FUMBLE
	PRINTI "Your fumbling attempt to "
	PRINTB P-PRSA-WORD
	PRINTR " the paper back into a bird fails."

	.FUNCT POND-BIRDS-F
	EQUAL? PRSA,V?EXAMINE,V?WATCH \?L1
	CALL1 CTHE-PRINT
	PRINTR " stare back at you coolly."
?L1:	CALL1 FEED-THE-BIRDS? >STACK
	ZERO? STACK \TRUE
	EQUAL? PRSA,V?LISTEN \?L4
	CALL1 CTHE-PRINT
...
?L5:	INTBL? PRSA,TOUCHVERBS,NTOUCHES >STACK \FALSE
	CALL2 CTHE-PRINT,POND-BIRDS
	PRINTR " paddle out of reach."

	.FUNCT BOAT-F
	EQUAL? PRSA,V?EXAMINE,V?WATCH \?L1
	CALL1 CTHE-PRINT
	PRINTI " are crafted of paper and sticks. They bob freely among the "
	PRINTD POND-BIRDS
	PRINTR ", who can barely conceal their outrage."
...
?L3:	INTBL? PRSA,TOUCHVERBS,NTOUCHES >STACK \FALSE
	...
	PRINTR " are far out of reach."

	.FUNCT DESCRIBE-DIAL,CONTEXT
	EQUAL? CONTEXT,M-OBJDESC \FALSE
	PRINTI "A shaft of golden sunlight falls across a handsome antique "
	PRINTD DIAL
	PRINTI ", erected at the exact center of the "
	PRINTD CLEARING
...
?L8:	PRINTI "."
	...
	EQUAL? CONTEXT,M-OBJDESC \FALSE
	PRINTI "At the center of the "
	PRINTD PLATFORM
	PRINTI " stands a handsome antique "
	PRINTD BDIAL
	CALL2 LOOK-AT-DIAL,BDIAL
	PRINTI " The circumference is enclosed in a wide "
	PRINTD RING
	PRINTI "."
	RTRUE
...
?L4:	CALL1 CTHE-PRINT
	PRINTI " is firmly imbedded in the "
	PRINTD PLATFORM
	PRINTI ", and cannot be moved. But the "
	PRINTD RING
	PRINTI " around its perimeter"
	CALL1 WOBBLES
	RTRUE
...
?L17:	ZERO? NOW-PRSI? \FALSE
	...
	PRINTI "The perimeter of the "
	PRINTD PRSO
	PRINTI " is inscribed with seven curious "
	PRINTD SYMBOLS
	PRINTI " and a "
	PRINTD ROSE
...
?L26:	PRINTI """ emblazoned across the bottom. A "
	ZERO? G \?L27
	PRINTD DIAL-HOLE
	PRINTI " is set into the center of the dial"
	JUMP ?L29
...
?L42:	CALL1 CTHE-PRINT
	PRINTI " is firmly set into the "
	EQUAL? PRSO,DIAL \?L43
	PRINTD GROUND
	JUMP ?L45
?L43:	PRINTD PLATFORM
?L45:	PRINTR ". It cannot be moved."
...
?L3:	PRINTI " around the "
	...
	GET OSIGN-DOORS,OSIGN >DOOR
	EQUAL? HERE,WABE \?L1
	PRINTI " is creeping slowly towards"
	JUMP ?L16
?L1:	ZERO? SUN-MOVING? /?L3
	PRINTI " appears to be drifting slowly "
	EQUAL? OSIGN,12 \?L4
	GRTR? ODEG,6 \?L4
	PRINTI "away from"
	JUMP ?L16
...
?L16:	ZERO? A /?L17
	...
	RTRUE
?L17:	CALL1 CTHE-PRINT
	PRINTI " fits perfectly around the dial's perimeter"
	ZERO? G /?L20
	PRINTI ". It's inscribed with an arrow, which"
	CALL1 READ-ARROW
	RTRUE
?L20:	PRINT PERIOD
	RTRUE
...
?L24:	EQUAL? PRSI,0,HANDS \?L23
	...
	CALL1 WOBBLES
	RTRUE
?L23:	EQUAL? PRSA,V?TURN-TO,V?TUNE-TO,V?POINT-AT /?L26
	EQUAL? PRSA,V?PUSH-TO \?L25
?L26:	ZERO? G \?L27
	CALL1 CTHE-PRINT
	FSET? PRSO,SEEN \?L29
	...
	JUMP ?L31
?L29:	PRINTI " has no "
?L31:	PRINTR "visible markings to use as a reference."
?L27:	EQUAL? PRSI,BDIAL \?L32
	GET P-NAMW,1 >STACK
	EQUAL? STACK,W?SHADOW \?L33
	PRINTI "The arrow already lies within the "
	PRINTD DSHADOW
	PRINTI " on the "
	PRINTD GNOMON
	PRINT PERIOD
	RTRUE
?L33:	CALL1 SPECIFY-SYMBOL
	RETURN 2
?L32:	EQUAL? PRSI,SYMBOLS \?L38
	GET P-ADJW,1 >X
	EQUAL? X,W?FIRST,W?OMEGA,W?ONE \?L39
	SET 'X,0
	JUMP ?L48
?L39:	EQUAL? X,W?SECOND,W?MERCURY,W?TWO \?L41
	SET 'X,2
	JUMP ?L48
?L41:	EQUAL? X,W?THIRD,W?PLUTO,W?THREE \?L42
	SET 'X,4
	JUMP ?L48
?L42:	EQUAL? X,W?FOURTH,W?NEPTUNE,W?FOUR \?L43
	SET 'X,6
	JUMP ?L48
?L43:	EQUAL? X,W?FIFTH,W?LIBRA,W?FIVE \?L44
	SET 'X,8
	JUMP ?L48
?L44:	EQUAL? X,W?SIXTH,W?MARS,W?SIX \?L45
	SET 'X,10
	JUMP ?L48
?L45:	EQUAL? X,W?SEVENTH,W?ALPHA /?L47
	EQUAL? X,W?SEVEN,W?LAST \?L46
?L47:	SET 'X,12
	JUMP ?L48
?L46:	SET 'X,7
?L48:	EQUAL? X,7 /?L51
	GET P-NAMW,1 >STACK
	EQUAL? STACK,W?SYMBOLS,W?GLYPHS \?L49
?L51:	CALL1 SPECIFY-SYMBOL
	RETURN 2
?L49:	ADD X,1 >STACK
	EQUAL? OSIGN,STACK /?L55
	EQUAL? OSIGN,X \?L54
	GRTR? ODEG,4 \?L54
?L55:	PRINT ARROW-ON
	PRINTI "to the "
	...
	PRINTB STACK
	PRINTR " symbol."
?L54:	FSET? PRSO,TOUCHED \?L56
	CALL1 SECOND-MOVE
	JUMP ?L57
?L56:	CALL2 FIRST-MOVE,1
?L57:	CALL2 NEW-OSIGN,X
	RTRUE
?L38:	EQUAL? PRSI,INTDIR \?L58
	EQUAL? P-DIRECTION,P?NORTH \?L59
	SET 'X,6
	JUMP ?L85
?L59:	EQUAL? P-DIRECTION,P?NE \?L61
	ZERO? FLIP? \?L62
	SET 'X,8
	JUMP ?L85
?L62:	SET 'X,4
	JUMP ?L85
?L61:	EQUAL? P-DIRECTION,P?EAST \?L65
	ZERO? FLIP? \?L66
	SET 'X,10
	JUMP ?L85
?L66:	SET 'X,2
	JUMP ?L85
?L65:	EQUAL? P-DIRECTION,P?SE \?L69
	ZERO? FLIP? \?L70
	SET 'X,12
	JUMP ?L85
?L70:	SET 'X,0
	JUMP ?L85
?L69:	EQUAL? P-DIRECTION,P?SW \?L73
	ZERO? FLIP? \?L74
	SET 'X,0
	JUMP ?L85
?L74:	SET 'X,12
	JUMP ?L85
?L73:	EQUAL? P-DIRECTION,P?WEST \?L77
	ZERO? FLIP? \?L78
	SET 'X,2
	JUMP ?L85
?L78:	SET 'X,10
	JUMP ?L85
?L77:	EQUAL? P-DIRECTION,P?NW \?L81
	ZERO? FLIP? \?L82
	SET 'X,4
	JUMP ?L85
?L82:	SET 'X,8
...
?L85:	EQUAL? X,7 \?L86
	CALL1 CTHE-PRINT
	PRINTR " refuses to move that way."
?L86:	ADD X,1 >STACK
	EQUAL? OSIGN,STACK /?L89
	EQUAL? OSIGN,X \?L88
	GRTR? ODEG,4 \?L88
?L89:	CALL1 ALREADY-POINTING
	RTRUE
?L88:	FSET? PRSO,TOUCHED \?L90
	CALL1 SECOND-MOVE
	JUMP ?L91
?L90:	CALL2 FIRST-MOVE,1
?L91:	CALL2 NEW-OSIGN,X
	RTRUE
?L58:	EQUAL? PRSI,INTNUM \?L92
	LESS? P-NUMBER,1 \?L93
	CALL1 SPECIFY-SYMBOL
	RETURN 2
?L93:	GRTR? P-NUMBER,7 \?L97
	PRINTI "There are only seven "
	PRINTD SYMBOLS
	PRINTI " on the "
	PRINTD DIAL
	PRINT PERIOD
	RTRUE
?L97:	SUB P-NUMBER,1 >STACK
	MUL STACK,2 >X
	ADD X,1 >STACK
	EQUAL? OSIGN,STACK /?L101
	EQUAL? OSIGN,X \?L99
	GRTR? ODEG,4 \?L99
?L101:	CALL1 ALREADY-POINTING
	RTRUE
?L99:	FSET? PRSO,TOUCHED \?L102
	CALL1 SECOND-MOVE
	JUMP ?L103
?L102:	CALL2 FIRST-MOVE,1
?L103:	CALL2 NEW-OSIGN,X
	RTRUE
?L92:	EQUAL? PRSI,RIGHT \?L104
	ZERO? FLIP? \?L105
	GRTR? OSIGN,10 \?L107
	SET 'X,0
	JUMP ?L116
?L107:	EQUAL? OSIGN,0,1 \?L109
	SET 'X,2
	JUMP ?L116
?L109:	MOD OSIGN,2 >STACK
	ZERO? STACK /?L110
	ADD OSIGN,1 >X
	JUMP ?L116
?L110:	ADD OSIGN,2 >X
	JUMP ?L116
?L105:	EQUAL? OSIGN,0,1 \?L113
	SET 'X,12
	JUMP ?L116
?L113:	MOD OSIGN,2 >STACK
	ZERO? STACK /?L115
	SUB OSIGN,3 >X
	JUMP ?L116
?L115:	SUB OSIGN,2 >X
?L116:	ADD X,1 >STACK
	EQUAL? OSIGN,STACK /?L119
	EQUAL? OSIGN,X \?L117
	GRTR? ODEG,4 \?L117
?L119:	CALL1 ALREADY-POINTING
	RTRUE
?L117:	FSET? PRSO,TOUCHED \?L120
	CALL1 SECOND-MOVE
	JUMP ?L121
?L120:	CALL2 FIRST-MOVE,1
?L121:	CALL2 NEW-OSIGN,X
	RTRUE
?L104:	EQUAL? PRSI,LEFT \?L122
	ZERO? FLIP? \?L123
	EQUAL? OSIGN,0,1 \?L125
	SET 'X,12
	JUMP ?L134
?L125:	MOD OSIGN,2 >STACK
	ZERO? STACK /?L127
	SUB OSIGN,3 >X
	JUMP ?L134
?L127:	SUB OSIGN,2 >X
	JUMP ?L134
?L123:	GRTR? OSIGN,10 \?L130
	SET 'X,0
	JUMP ?L134
?L130:	EQUAL? OSIGN,0,1 \?L132
	SET 'X,2
	JUMP ?L134
?L132:	MOD OSIGN,2 >STACK
	ZERO? STACK /?L133
	ADD OSIGN,1 >X
	JUMP ?L134
?L133:	ADD OSIGN,2 >X
?L134:	ADD X,1 >STACK
	EQUAL? OSIGN,STACK /?L137
	EQUAL? OSIGN,X \?L135
	GRTR? ODEG,4 \?L135
?L137:	CALL1 ALREADY-POINTING
	RTRUE
?L135:	FSET? PRSO,TOUCHED \?L138
	CALL1 SECOND-MOVE
	JUMP ?L139
?L138:	CALL2 FIRST-MOVE,1
?L139:	CALL2 NEW-OSIGN,X
	RTRUE
?L122:	CALL1 CTHE-PRINT
	PRINTR " can't be moved that way."
?L25:	EQUAL? PRSA,V?TURN,V?MOVE,V?SPIN /?L142
	EQUAL? PRSA,V?PUSH \?L141
?L142:	EQUAL? PRSI,0,HANDS,ROOMS /?L143
	PRINT DONT
	PRINTI "need "
	CALL1 THEI-PRINT
	PRINTI " to "
...
?L143:	RANDOM 7 >STACK
	...
	MUL STACK,2 >X
	EQUAL? X,OSIGN /?L143
	FSET? PRSO,TOUCHED /?L151
	CALL2 FIRST-MOVE,G
	JUMP ?L156
?L151:	PRINTI "The sun races across the sky as you casually spin the "
	PRINTD RING
	ZERO? G /?L154
	PRINT PTHE
	PRINTI "arrow "
	...
	RTRUE
?L154:	PRINT PERIOD
?L156:	CALL NEW-OSIGN,X,G
	RTRUE
?L141:	EQUAL? PRSA,V?TAKE,V?RAISE,V?UNPLUG /?L158
	EQUAL? PRSA,V?LOWER,V?PULL,V?RELEASE /?L158
	EQUAL? PRSA,V?UNSCREW,V?LOOSEN,V?UNSCREW-FROM \?L157
?L158:	CALL FIRMLY-ATTACHED,PRSO,BDIAL
	RTRUE
?L157:	EQUAL? PRSA,V?LAMP-OFF \FALSE
	ZERO? SUN-MOVING? \?L160
...
?L160:	CALL1 HOW?
	...
	.FUNCT WOBBLES
	PRINTR " wobbles a bit when you touch it."
	...
	PRINTI "[You must specify just "
	CALL2 ITALICIZE,STR?164
	PRINTI " of the seven "
	PRINTD SYMBOLS
	PRINTI " on the "
	PRINTD DIAL
	PRINTR "; for example, TURN THE RING TO THE FOURTH SYMBOL or POINT THE ARROW TO OMEGA.]"
	...
	FSET RING,TOUCHED
	PRINTI "You grasp the edges of the "
	PRINTD RING
	PRINTI " and begin to turn it.

An ominous vibration makes the "
	PRINTD PLATFORM
	PRINTI " tremble. Then a motion catches your eye"
	PRINT PCR
	CALL2 ITALICIZE,STR?165
	PRINTI " It's arcing across the sky like a time-lapse movie, smooth and terribly silent.

You let go of the ring with a cry. The sun instantly stops, and the strange vibration with it."
	CRLF
	ZERO? P /TRUE
	CRLF
	PRINTI "After your pulse slows, you grasp the ring again and turn it, ever so carefully, until it "
	RTRUE

	.FUNCT SECOND-MOVE
	PRINTI "The sun sweeps across the sky as you rotate the "
	PRINTD PRSO
	PRINTI ". It "
	RTRUE
...
?L19:	INTBL? PRSA,MOVEVERBS,NMVERBS >STACK \FALSE
	...
	.FUNCT EXAMINE-HOLE
	PRINTR "t-handed thread, and is set in the center of the dial."

	.FUNCT ROSE-F
	EQUAL? PRSA,V?EXAMINE,V?LOOK-ON,V?READ \?L1
	CALL1 CTHE-PRINT
	PRINTI " on the dial appears quite ordinary"
	EQUAL? HERE,ON-GNOMON \?L3
	ZERO? FLIP? /?L3
	PRINTI ", except that the headings are all backwards"
?L3:	PRINT PERIOD
	RTRUE
...
?L3:	PRINTI "The seven "
	PRINTD PRSO
	PRINTI " are arranged in a circle. The series begins with a Greek omega and runs "
	ZERO? FLIP? /?L4
	PRINTI "counter"
?L4:	PRINTI "clockwise around the dial, ending with a Greek alpha"
	ZERO? FLIP? /?L7
	PRINTI ". All of the "
	PRINTD PRSO
	PRINTI " are inscribed backwards"
?L7:	PRINTI ".
...
?L1:	EQUAL? PRSA,V?COUNT \?L15
	PRINTR "There are exactly seven."
...
?L3:	ZERO? NOW-PRSI? \FALSE
	...
	JUMP ?L11
?L9:	PRINTI "lef"
?L11:	PRINTI "t-handed thread, and is "
	CALL1 ATTACHED-TO
	RTRUE
...
?L13:	ZERO? NOW-PRSI? \FALSE
	...
	PRINTI "It's a triangular piece of metal, about a quarter-inch thick and four inches long"
	FSET? GNOMON,NODESC \?L20
	PRINTI ", screwed into the center of the "
	PRINTD DIAL
	JUMP ?L22
?L20:	PRINT PA
	PRINTI "long bolt is welded to the bottom"
?L22:	PRINT PERIOD
	RTRUE
...
?L30:	FSET PRSO,BORING
	...
	PRINTD PRSO
	PRINTI " getting more and more wobbly as you "
	PRINTB P-PRSA-WORD
	PRINTI " it. A final twist, and it falls with a clatter onto the face of the "
	PRINTD DIAL
	PRINT PERIOD
	...
	CRLF
	CALL2 CTHE-PRINT,RING
	PRINTI " twinkles again as the "
	PRINTD LEVER
	ZERO? SUN-MOVING? \?L34
	SET 'SUN-MOVING?,1
	PRINTI " straightens itself and"
?L34:	PRINTI " silently retracts into the "
	PRINTD FLOOR
	PRINT PERIOD
	RTRUE
...
?L39:	FSET? PRSO,NODESC \?L38
	FSET PRSO,BORING
	CALL1 CTHE-PRINT
	PRINTI " on the dial wobbles loosely when you "
...
?L45:	EQUAL? PRSI,DIAL,BDIAL \FALSE
	...
	GRTR? STACK,3 \?L46
	CALL YOUD-HAVE-TO,STR?167,PRSI
	RTRUE
?L46:	EQUAL? PRSI,BDIAL \?L48
	...
	FSET? PRSO,SEEN /?L49
	FSET PRSO,SEEN
	PRINTI "You twist and push the "
	PRINTD PRSO
	PRINTI " into the hole on the "
	PRINTD PRSI
	PRINTI ", but it doesn't seem to fit very well. A quick glance shows the reason why. "
?L49:	PRINTR "The thread on the bolt doesn't match the thread in the dial's hole."
?L48:	MOVE GNOMON,PRSI
	...
	PRINTI "A long metal "
	PRINTD LEVER
	PRINTI " silently rises out of the "
	PRINTD FLOOR
	PRINTI ". As it clicks to a stop, the ring around the "
	PRINTD BDIAL
	PRINTI " emits a brilliant twinkle of light."
	CRLF
	FSET? LEVER,TOUCHED /TRUE
	FSET LEVER,TOUCHED
	CALL2 UPDATE-SCORE,5
	CRLF
	CALL VOICE-MUTTERS,STR?168,0
	RTRUE
...
?L3:	CALL2 THE-PRINT,PLATFORM
	...
	PRINTI " is about five feet long, and"
	CALL1 SAY-LEVER
	CRLF
	RTRUE
?L3:	EQUAL? PRSA,V?RAISE,V?PULL,V?LOOSEN \?L4
	...
	CALL1 RAISE-LEVER
	RTRUE
?L5:	CALL2 LEVER-MOVED,STR?153
	RTRUE
?L4:	EQUAL? PRSA,V?LOWER,V?PUSH \?L8
	ZERO? SUN-MOVING? \?L9
	CALL2 LEVER-MOVED,STR?36
	RTRUE
...
?L26:	CALL1 HOW?
	...
	SET 'SUN-MOVING?,0
	PRINTI "As you lower"
	CALL2 SAY-GRIND,STR?169
	RTRUE

	.FUNCT RAISE-LEVER
	SET 'SUN-MOVING?,1
	PRINTI "As you raise"
	CALL2 SAY-GRIND,STR?170
	RTRUE

	.FUNCT SAY-GRIND,STR
	PRINTI " the "
	PRINTD LEVER
	PRINTI " you hear a loud, mechanical groan below your feet. The "
	PRINTD FLOOR
	PRINTI " lurches and "
	PRINT STR
	PRINTI "; you feel a momentary dizziness, and a brief gust of wind"
...
?L15:	EQUAL? PRSA,V?SMELL \FALSE
	...
	PRINTR " half-hidden among the blossoms."

	.FUNCT SMELL-FLOWERS
	PRINTR "The air is filled with a delicate fragrance."
	...
	PRINTR " are lovely to behold."

	.FUNCT NO-PICKING
	PRINTI "Flower-picking in the "
	PRINTD GARDENS
	PRINTR " is strictly forbidden."
...
?L3:	PRINTI "The surrounding "
	PRINTD PRSO
	PRINTR " is dense and full of thorns."
...
?L7:	FSET MEMORIAL,TOUCHED
	PRINTI "Your "
	PRINTD LONDON
	PRINTI " guide book warned you that the "
	PRINTD PRSO
	PRINTR " was ugly, but nothing could have prepared you for this embarrassing spectacle!"
?L5:	CALL1 GETTING-INTO? >STACK
	ZERO? STACK /?L10
	CALL2 DO-WALK,P?SOUTH
	RTRUE
...
?L1:	XCALL HANDLE-PLACE?,BROAD-WALK,LION-GATE,ROUND-POND,PAL-GATE >STACK
	...
	.FUNCT VICTORIA-F
	EQUAL? PRSA,V?EXAMINE \?L1
	PRINTR "She wasn't much to look at."
?L1:	CALL1 ENTERING? >STACK
	ZERO? STACK /?L3
	CALL2 DO-WALK,P?WEST
	RTRUE
...
?L17:	EQUAL? PRSI,POCKET \?L19
	PRINTI "You try to empty the "
	PRINTD PRSO
	PRINTI " into "
	PRINTD POCKET
	PRINTI ", but crumbs pile up around the edges"
	CALL1 DROP-CRUMBS
	RTRUE
...
?L24:	EQUAL? PRSA,V?SHAKE,V?SQUEEZE \?L28
	PRINTI "Bread crumbs jitter in "
	CALL1 THE-PRINT
	PRINT PERIOD
	RTRUE
?L28:	EQUAL? PRSA,V?SMELL \?L29
	PRINTR "The crumbs in the bag smell a bit stale."
...
?L30:	CALL1 SAID-CRUMBS? >STACK
	...
	PRINTI "The bread crumbs look old and stale. "
	CALL1 LOOK-IN-BAG
	RTRUE
...
?L38:	EQUAL? PRSA,V?EAT,V?TASTE,V?BITE \FALSE
	PRINTI "You grab "
	CALL1 SAY-HANDFUL
	PRINTI " and cram them into your mouth"
	FSET? HERE,WINDY \?L40
...
?L42:	PRINT PERIOD
	...
	CALL1 GET-RUBY
	CRLF
	PRINTI "As you munch the bread, your teeth clamp down on something hard. Ouch! You spit out the particle with a muffled curse.
...
?L53:	CALL2 DONT-HAVE?,PRSO >STACK
	ZERO? STACK \TRUE
...
?L57:	CALL1 DO-BAG? >STACK
	...
	FSET? PRSI,WATERY \?L1
	CALL1 CTHE-PRINT
	PRINTR " would get all soggy if you tried that."
?L1:	EQUAL? PRSA,V?CLOSE \FALSE
	CALL1 CTHE-PRINT
	PRINTR " refuses to stay closed."
...
?L1:	PRINTI " on hungrily"
	...
	CALL2 CTHE-PRINT,PIGEONS
	PRINTI " flock eagerly around the bag. Soon the bread crumbs are history."
	CRLF
	FSET? RUBY,SEEN /TRUE
	CALL1 GET-RUBY
	CRLF
	PRINTI "As the birds wander away "
	CALL1 NOTICE-RUBY
	RTRUE
	...
	CALL1 GET-RUBY
	CRLF
	PRINTR "As you rummage through the crumbs, your fingers brush against something solid. A brilliant ruby slips out of the bag and falls to the ground."

	.FUNCT EMPTY-PRSO-FIRST
	PRINTI "Maybe you should empty the "
	PRINTD PRSO
	PRINTR " first."

	.FUNCT CRUMBS-INTO-PRAM
	FSET? PRSI,OPENED /?L1
	CALL YOUD-HAVE-TO,STR?56,PRSI
	RTRUE
?L1:	ZERO? IN-PRAM? /?L3
	CALL YOUD-HAVE-TO,STR?82,PRSI
	RTRUE
?L3:	CALL1 SAY-CRUMBS-FALL
	PRINTI " and tumble into the open "
	PRINTD PRSI
	PRINTI ".

In moments, the pram is covered with greedy "
	PRINTD PIGEONS
	PRINTI "! Soon there's not a crumb to be seen"
	PRINT PCR
	FSET? RUBY,SEEN /TRUE
	CALL2 GET-RUBY,1
	PRINTI "As you brush the last few "
	PRINTD PIGEONS
	PRINTI " off the pram "
	CALL1 NOTICE-RUBY
	RTRUE
	...
	CALL1 EMPTY-BAG
	PRINTI "Bread crumbs fall out of the bag"
	RTRUE
	...
	PRINTI "There"
	EQUAL? CCNT,1 \?L1
	PRINTI "'s only one more handful"
	JUMP ?L3
?L1:	PRINTI " are "
	EQUAL? CCNT,2,3 \?L4
	PRINTI "a couple of"
...
?L15:	CALL1 THEI-PRINT
	...
	JUMP ?L17
?L1:	PRINTI "They "
?L17:	PRINTI "fall between your fingers"
	CALL1 DROP-CRUMBS
	RTRUE
...
?L1:	EQUAL? HERE,IN-WATER,IN-CIST,UNDER-WATER /?L4
	ZERO? IN-DISH? \?L4
	ZERO? IN-DORY? /?L3
?L4:	PRINTR "disappear in the water."
?L3:	ZERO? SUITED? /?L5
	ZERO? CCNT \?L6
	LOC EBAG >STACK
	MOVE BAG,STACK
	...
	SET 'P-IT-OBJECT,BAG
?L6:	INC 'CCNT
	PRINTI "jiggle around inside the "
	PRINTD FILM
	PRINTR " until you scoop them all up with the bag."
...
?L23:	PRINTI ", where "
	...
	EQUAL? HERE,W100 \?L27
	FSET? DOG,WINDY \?L27
	PRINTI " before returning to the dog's head"
?L27:	PRINT PERIOD
	RTRUE
?L25:	FSET? HERE,INDOORS \?L30
	PRINTR "they scatter all over the place."
?L30:	PRINTR "the breeze blows them all away."

	.FUNCT NOTICE-RUBY
	PRINTI "a glint of red catches your eye. Frowning, you "
	IN? RUBY,PRAM \?L1
	PRINTI "peer inside"
	JUMP ?L4
?L1:	ZERO? IN-PRAM? \?L3
	PRINTI "stoop down"
	JUMP ?L4
?L3:	PRINTI "peer over the edge of the "
	PRINTD PRAM
?L4:	PRINTI " for a closer look... and gasp with astonishment!
...
?L8:	PRINTI " is bigger than a walnut, with finely cut facets that sparkle with crimson fire. It must have been in the "
	PRINTD BAG
	PRINT PERIOD
	RTRUE

	.FUNCT FEEL-STALE
	PRINTR "The crumbs feel dry and stale."
	...
	CALL YOUD-HAVE-TO,STR?172,EBAG
	RTRUE

	.FUNCT EBAG-F
	CALL1 SAID-CRUMBS? >STACK
	ZERO? STACK /?L1
	PRINTI "The crumbs are all gone."
	CRLF
	RETURN 2
?L1:	ZERO? NOW-PRSI? /?L5
...
?L7:	EQUAL? PRSA,V?EXAMINE,V?LOOK-INSIDE,V?SEARCH \?L8
	PRINTR "The bags are full of bread crumbs."
?L8:	INTBL? PRSA,TOUCHVERBS,NTOUCHES >STACK \FALSE
	CALL1 NO-TOUCHIN
	RTRUE
	...
	PRINTD HANDS
	PRINTR " away. ""No touchin' the merchandise!"""
...
?L1:	RETURN BAG
	...
	PRINTR "There's nobody here to sell you any."
...
?L3:	ZERO? PRSI /?L4
	FSET BWOMAN,SEEN
	CALL2 CTHE-PRINT,BWOMAN
	PRINTR " scowls. ""I ain't no pawn shop!"""
...
?L5:	EQUAL? PRSI,0,HANDS \FALSE
	FSET? PRSO,TOUCHED /FALSE
	FSET PRSO,TOUCHED
	PRINTI "As you reach down to touch the ruby, "
	CALL1 MEEP-GETS-RUBY
	RTRUE

	.FUNCT TRUBY-F
	EQUAL? PRSA,V?EXAMINE,V?LOOK-INSIDE \FALSE
	CALL2 SPARKLE-WITH,STR?173 >STACK
	RSTACK

	.FUNCT SPARKLE-WITH,STR
	PRINTI "Its finely cut edges sparkle with "
	PRINT STR
	PRINTR " fire."

	.FUNCT EMERALD-F
	EQUAL? PRSA,V?EXAMINE,V?LOOK-INSIDE \FALSE
	CALL2 SPARKLE-WITH,STR?174 >STACK
	RSTACK

	.FUNCT GPRAM-F
	EQUAL? PRSA,V?EXAMINE,V?LOOK-INSIDE,V?SEARCH /?L3
	EQUAL? PRSA,V?WATCH \?L1
?L3:	PRINTR "They're probably full of British babies."
?L1:	CALL1 HANDLE-BABES? >STACK
	...
	EQUAL? CONTEXT,M-OBJDESC \FALSE
	PRINTI "A careless nanny has left her "
	PRINTD PRAM
	PRINTI " unattended"
	FIRST? PRAM >STACK \?L4
	FSET? PRAM,OPENED \?L4
...
?L15:	EQUAL? PRSA,V?STAND-ON,V?STAND \?L16
	ZERO? IN-PRAM? \?L17
	PRINTI "You clamber into the "
	PRINTD PRSO
	PRINTI " and slowly rise to your feet, knees wobbling"
	JUMP ?L19
?L17:	SET 'OLD-HERE,0
	SET 'IN-PRAM?,0
	FCLEAR PRSO,NODESC
	PRINTI "With wobbling knees, you slowly rise to your feet"
?L19:	PRINT PCR
	CALL2 ITALICIZE,STR?175
	PRINTI " The pram skitters away and deposits you on the ground"
	ZERO? RAID? \?L20
	EQUAL? HERE,WABE /?L20
	PRINTI ", much to the amusement of passersby"
?L20:	PRINTR ".
...
?L16:	CALL2 VISIBLE?,RUBY >STACK
	ZERO? STACK /?L23
	PRINTI "You start to climb into the "
	PRINTD PRSO
...
?L23:	SET 'IN-PRAM?,1
	FSET PRSO,NODESC
	SET 'OLD-HERE,0
	PRINTI "With great difficulty, "
	ZERO? RAID? \?L25
	EQUAL? HERE,WABE /?L25
	PRINTI "and much to the amusement of passersby, "
?L25:	PRINTI "you jam yourself into the unfortunate "
	PRINTD PRSO
	PRINT PERIOD
	RTRUE
?L11:	CALL1 EXITING? >STACK
...
?L30:	SET 'IN-PRAM?,0
	FCLEAR PRSO,NODESC
	SET 'OLD-HERE,0
	PRINTI "Gratefully, you clamber out of the cramped "
	PRINTD PRSO
	PRINT PERIOD
	RTRUE
...
?L42:	PRINTI "[To move the "
	PRINTD PRSO
	PRINTI ", simply push it in the desired "
	PRINTD INTDIR
	PRINTR "; for example, PUSH THE PERAMBULATOR TO THE SOUTH or PULL PRAM EAST.]"
?L41:	EQUAL? PRSA,V?LOOSEN \?L43
	...
	GRTR? STACK,2 \?L44
	CALL1 CTHE-PRINT
	PRINTR " rolls a few feet, then stops."
?L44:	CALL NOT-LIKELY,PRSI,STR?176
	RTRUE
...
?L51:	PRINTI "ing "
	PRINTD NANNIES
	PRINTR " look on in horror."

	.FUNCT CANT-WHILE-IN-PRAM
	PRINTR "That'd be easier to do if you got out of the pram first."
...
?L1:	EQUAL? PRSA,V?EXAMINE \?L6
	CALL2 CTHE-PRINT,PRAM
	PRINTR " is lying on its side, bent and useless."
?L6:	EQUAL? PRSA,V?TAKE,V?RAISE \?L7
	CALL1 CTHE-PRINT
	PRINTR " topples over on its side again. It's quite useless."
?L7:	EQUAL? PRSA,V?PUSH-TO,V?MOVE,V?PULL /?L9
	EQUAL? PRSA,V?PUSH \?L8
?L9:	CALL1 CTHE-PRINT
	PRINTR "'s days of carefree rolling are over."
?L8:	EQUAL? PRSA,V?OPEN,V?OPEN-WITH,V?CLOSE \?L10
	PRINTI "The top of the "
	PRINTD PRAM
	PRINTR " is hopelessly broken."
?L10:	EQUAL? PRSA,V?ENTER,V?CLIMB-ON,V?SIT /?L12
	EQUAL? PRSA,V?LIE-DOWN,V?CLIMB-UP,V?STAND-ON /?L12
	EQUAL? PRSA,V?STAND \FALSE
?L12:	CALL1 CTHE-PRINT
	PRINTR " would never support you now."
	...
	PRINTI " are sternly printed on the "
	PRINTD NOTICE
	PRINT PERIOD
	RTRUE
?L1:	INTBL? PRSA,TOUCHVERBS,NTOUCHES >STACK /?L4
...
?L24:	EQUAL? PRSA,V?LISTEN \FALSE
	...
	PRINTD VOICES
	PRINTI " giggling ""Shh! Shh! Quiet!"" for a moment"
	CALL1 ALL-IS-STILL >STACK
	RSTACK
	...
	FSET GRASS,TOUCHED
	PRINT STR
	PRINTI " you sense a strange motion around you. Looking down, you watch with horror as the "
	PRINTD GRASS
	PRINTI " begins to ripple and writhe with vegetable indignance!"
	CRLF
	CRLF
?L1:	PRINTI "Angry green stalks whip around your legs, pull you to the ground and drag you, kicking and screaming, back to the paved "
	PRINTD CSURFACE
	PRINTI " of the "
	PRINTD LNWALK
	PRINT PCR
	PRINTI "A chorus of offended little "
	PRINTD VOICES
	PRINTI " subsides as you regain your footing"
	ZERO? UMB? \?L6
...
?L4:	PRINT PERIOD
	...
	.FUNCT ENERGY-F
	EQUAL? PRSA,V?EXAMINE,V?LOOK-ON,V?READ \?L1
	PRINTI "According to a plaque, the "
	PRINTD PRSO
	PRINTI " is called "
	CALL2 ITALICIZE,STR?180
	CRLF
	RTRUE
?L1:	CALL1 GETTING-INTO? >STACK
	ZERO? STACK /FALSE
	CALL2 CTHE-PRINT,ENERGY
	PRINTR "'s design would make that difficult."
...
?L6:	EQUAL? PRSA,V?KICK,V?PLAY,V?BOUNCE \FALSE
	...
	PRINTI " around"
?L13:	PRINTI " for a few moments, but "
	EQUAL? HERE,WABE \?L16
	PRINTI "there's nobody here "
	JUMP ?L18
?L16:	PRINTI "nobody stops "
?L18:	PRINTR "to admire your athletic prowess."
...
?L5:	EQUAL? PRSA,V?TAKE,V?MOVE,V?PULL \?L7
	...
	CALL1 ATTACHED-TO
	RTRUE
?L7:	CALL YOU-DONT-NEED,STR?181,1
	RTRUE
?L3:	ZERO? NOW-PRSI? /?L9
	EQUAL? PRSA,V?THROW,V?THROW-OVER \?L10
	EQUAL? PRSO,BALL \?L12
...
?L12:	CALL1 CTHE-PRINT
	...
	CRLF
	CALL1 CTHEI-PRINT
	PRINTR " teeters uncertainly for a moment."
...
?L24:	EQUAL? PRSA,V?EXAMINE,V?LOOK-INSIDE \?L28
	...
	CALL2 OPEN-CLOSED,PRSO
	IN? PRSO,TREE \?L29
	PRINTI " dangles in the tree overhead, high out of reach. It"
	JUMP ?L31
?L29:	PRINTI "'"
?L31:	PRINTI "s handle is carved in the shape of a parrot's head"
...
?L36:	FSET? PRSO,OPENED \?L38
	...
	CALL1 READ-SLOGAN
	RTRUE
?L38:	CALL YOUD-HAVE-TO,STR?56,PRSO
	RTRUE
...
?L40:	EQUAL? PRSA,V?TAKE \?L46
	...
	PRINTD PRSO
	PRINTI " and smooth the wrinkles, you notice a touristy slogan printed around the outside: """
	PRINT ALLPRAMS
	PRINTI """"
	CRLF
	CALL2 UPDATE-SCORE,5
...
?L58:	EQUAL? HERE,IN-SKY \?L59
	...
	FSET PRSO,OPENED
	CALL1 CTHE-PRINT
	PRINTR " snaps open and nearly flies to pieces in the fury of your descent. But a sympathetic breeze fills the cloth panels with air, and your death-plunge slows to a leisurely drift."
?L59:	ZERO? SUITED? /?L60
?L134:	CALL2 CTHE-PRINT,FILM
	EQUAL? HERE,IN-ORBIT,ON-SAT \?L61
	PRINTR " won't stretch enough now."
?L61:	FSET PRSO,OPENED
	PRINTI " stretches as you open the "
	PRINTD PRSO
	PRINT PERIOD
	RTRUE
?L60:	FSET? HERE,WINDY \FALSE
	...
	PRINTI " fills the "
	PRINTD PRSO
	PRINTI " the moment you open it. You"
	ZERO? IN-PRAM? \?L66
	PRINTI "'"
	JUMP ?L68
...
?L80:	SET 'HERE,LION-GATE
	...
	JUMP ?L83
?L79:	PRINTI " until"
?L83:	PRINTI " you collide with a crowd of "
	CALL1 SAY-TOURISTS
	JUMP ?L113
?L72:	EQUAL? HERE,WABE \?L84
	PRINTI " until you plow into the "
	PRINTD THICKET
	JUMP ?L113
...
?L86:	EQUAL? HERE,FLOWER-WALK \?L88
	...
	JUMP ?L89
?L88:	PRINTI " until"
?L89:	PRINTI " you careen into the "
	EQUAL? HERE,FLOWER-WALK \?L90
	PRINTD BEDS
	JUMP ?L113
?L90:	CALL1 SAY-TOURISTS
	JUMP ?L113
...
?L94:	PRINTI " onto the "
	...
	RETURN 2
?L103:	CALL GRASS-STOPS-YOU,STR?182,1
...
?L116:	SET 'HERE,BROAD-WALK
	...
	JUMP ?L119
?L114:	PRINTI " until"
?L119:	PRINTI " you careen into the "
	PRINTD VICTORIA
...
?L55:	EQUAL? PRSA,V?CLOSE,V?FOLD \FALSE
	...
	PRINTI "snedraG notgnisneK eht ot dael smarp llA"
	JUMP ?L3
?L1:	PRINTI "All prams lead to the "
	PRINTD GARDENS
?L3:	PRINTR """ is printed around the outside."
	...
	CALL1 CTHE-PRINT
	PRINTI " lodges itself in the tree beside the "
	PRINTD PRSI
	PRINTI ".

The "
	PRINTD PRSI
	PRINTR " teeters uncertainly for a moment, then tumbles out of the tree and lands at your feet."

	.FUNCT NICE-TRY
	PRINTI "Nice try. Unfortunately, "
	EQUAL? PRSI,HANDS,0 \?L1
	PRINTI "your arm"
	JUMP ?L3
?L1:	CALL1 THEI-PRINT
?L3:	PRINTI " isn't long enough to reach "
	CALL1 THE-PRINT
	PRINT PERIOD
	RTRUE
	...
	PUTP BAD-CRANE,P?FDESC,STR?183
...
?L4:	CALL2 DEQUEUE,I-CRANE-APPEARS
	...
	FCLEAR WWIND,SEEN
	PRINTI "You zoom down a long slope, barely missing several trees and boulders. Peering over the top of the "
	PRINTD PRAM
	PRINTI ", you see the "
	PRINTD LWATER
	PRINTI " coming closer and closer. Unable to stop, and too stupid to let go of the "
	PRINTD PARASOL
	PRINTI ", you bravely close your eyes and pinch your nose shut"
	PRINT PCR
	CALL2 ITALICIZE,STR?175
	CALL1 CARRIAGE-RETURNS
	CALL1 V-LOOK
	...
	.FUNCT PAIN-REGAIN
	CRLF
	PRINTI "Painfully, you regain your footing"
...
?L5:	PRINTI " "
	PRINTD X
	PRINTI " is wedged in the branches overhead."
	RTRUE
	...
	INTBL? PRSA,PUTVERBS,NUMPUTS >STACK \FALSE
	CALL1 CTHE-PRINT
	PRINTI " tumbles out of the tree and "
	CALL1 LANDS-AT-YOUR-FEET
	RTRUE
?L1:	EQUAL? PRSA,V?EXAMINE,V?LOOK-INSIDE,V?SEARCH /?L7
	EQUAL? PRSA,V?LOOK-UP \?L6
?L7:	PRINTI "It's quite a nice tree, actually"
	FIRST? TREE >WORD \?L9
	PRINTI ", except for "
	CALL2 THE-PRINT,WORD
	PRINTI " wedged in its branches"
?L9:	PRINT PERIOD
	RTRUE
...
?L25:	EQUAL? PRSA,V?OPEN,V?OPEN-WITH,V?CLOSE \FALSE
	...
	PRINTR " portrays a carefree little boy playing a set of pipes."
...
?L1:	EQUAL? PRSA,V?LISTEN \?L6
	CALL1 CTHE-PRINT
	PRINTR " rise and fall with fateful urgency."
...
?L9:	PRINTI "floating "
?L11:	PRINTD MISSILE
	PRINTR " is impressively large, sixty or seventy feet from nose to tail, aiming straight downward. A crimson hammer and sickle are lovingly painted on the hull."
?L5:	EQUAL? PRSA,V?CLIMB-ON,V?CLIMB-OVER,V?RIDE /?L13
	EQUAL? PRSA,V?SIT,V?STAND-ON,V?LIE-DOWN \?L12
?L13:	CALL2 THIS-IS-NOT,STR?184
	RTRUE
...
?L1:	CALL NOUN-USED?,W?DOORS,W?DOORWAYS >STACK
	ZERO? STACK /?L5
	PRINTI "There's only one door here."
	CRLF
	RETURN 2
?L5:	ZERO? NOW-PRSI? \FALSE
...
?L17:	EQUAL? HERE,IN-WATER /FALSE
	...
	.FUNCT UNEASY-DOOR
	PRINTI "Looking directly at the "
	PRINTD PRSO
	PRINTR " makes you uneasy. It's as if your eyes can't decide whether it's really there or not."
	...
	JUMP ?L6
?L4:	PRINTI "Y"
?L6:	PRINTI "ou wade to the threshold "
	GRTR? HCNT,1 \?L7
	PRINTI "a familiar "
	PRINTD MEEP
	PRINTI " flutters past"
	CALL1 ENTICINGLY
	PRINTI " as it slips through "
	JUMP ?L9
?L7:	PRINTI "of "
?L9:	CALL2 THE-PRINT,LWDOOR
	PRINT PCR
	PRINTI "All color abruptly drains from the landscape. Trees, sky and sun flatten into a spherical shell, with you at the very center. A hissing in your ears becomes a rumble, then a roar as the walls of the shell collapse inward, faster and faster"
	PRINT PCR
	GETB 0,30 >STACK
	EQUAL? STACK,5 \?L10
	INC 'ST
...
?L24:	CALL1 ARTICULATES
	PRINTI """No!"" your mind shudders. ""That's not a "
	PRINTD INTDIR
	PRINTI "!"""
	CRLF
	CRLF
...
?L25:	CALL1 ST-QUOTE
	HLIGHT H-ITALIC
?L27:	PRINTI "It's a perfectly legitimate "
	PRINTD INTDIR
	PRINTI ","
	HLIGHT H-NORMAL
	ZERO? ST \?L28
	...
	JUMP ?L30
?L28:	CALL1 ST-QUOTE
?L30:	PRINTI " retorts the voice with cold amusement. "
	ZERO? ST \?L31
	PRINTI """"
	JUMP ?L33
?L31:	CALL1 ST-QUOTE
...
?L3:	CRLF
	CRLF
	PRINTR "You turn, but see no one."

	.FUNCT ARTICULATES
	CRLF
	CRLF
	PRINTI "The space around you articulates. "
	RTRUE
...
?L3:	EQUAL? PRSA,V?LISTEN,V?TOUCH \?L4
	...
	PRINTR "It blows briskly through the trees."
?L4:	EQUAL? PRSA,V?SMELL \?L5
	PRINTR "It smells unusually fresh."
?L5:	EQUAL? PRSA,V?LAMP-ON,V?LAMP-OFF \FALSE
	...
	JUMP ?L8
?L3:	PRINTI "down"
?L8:	PRINTI " along the diagonal edge of the "
	PRINTD STRUCTURE
	PRINT PERIOD
	RTRUE
...
?L1:	ZERO? NOW-PRSI? /?L4
	INTBL? PRSA,PUTVERBS,NUMPUTS >STACK \FALSE
	PRINTI "Better not. You might trip over "
	FSET? PRSO,PLURAL \?L8
	PRINTI "them "
	JUMP ?L10
?L8:	PRINTI "it "
...
?L1:	RETURN STRUCTURE
	...
	PRINTI "High and broad as it is, the "
	PRINTD STRUCTURE
	PRINTI " is only a few feet thick. Its "
	PRINTD CSURFACE
	PRINTI " is smooth and featureless, except for the "
	PRINTD STAIR
	PRINTR " along the diagonal edge."
?L3:	EQUAL? PRSA,V?TOUCH,V?KNOCK,V?KISS \?L4
	EQUAL? PRSI,0,HANDS \?L4
	CALL2 CTHE-PRINT,STRUCTURE
	PRINTR " feels smooth and hard."
?L4:	EQUAL? PRSA,V?ENTER,V?THROUGH \?L5
	PRINTI "There are no visible "
	PRINTD CAVE-HOLE
	PRINTR "s."
...
?L8:	CALL1 CTHE-PRINT
	...
	CALL1 CTHE-PRINT
	PRINTI " doesn't seem to be moving"
	PRINT AT-MOMENT
	CRLF
	RTRUE
...
?L1:	GETP PRSO,P?TDOOR >DOOR
	EQUAL? PRSA,V?EXAMINE \?L8
	CALL1 CTHE-PRINT
	PRINTI " must be at least twelve feet from base to crown"
	FSET? DOOR,NOALL /?L10
	PRINTI ". A"
	CALL OPEN-CLOSED,DOOR,1
	PRINTI " is set into its fleshy stem"
?L10:	PRINT PERIOD
	RTRUE
...
?L3:	PRINTI "You slide off the slippery "
	PRINTD TS0
	PRINT PERIOD
	RTRUE
...
?L21:	CALL1 CANT-FROM-HERE
	RTRUE
?L25:	PRINT CANT
	PRINTI "see the door anymore. It's too far away."
	CRLF
	RETURN 2
?L6:	CALL THRU-DOOR?,AT-FALLS,IN-ORBIT >STACK
	...
	FSET? PRSI,OPENED /?L4
	CALL1 CTHE-PRINT
	PRINTI " strikes the closed door and "
	CALL1 LANDS-AT-YOUR-FEET
	RTRUE
...
?L11:	SET 'P-IT-OBJECT,NOT-HERE-OBJECT
	CALL1 CTHE-PRINT
	PRINTR " disappears through the open door."
	...
	PRINTI "The"
	CALL2 OPEN-CLOSED,PRSO
	PRINTR " is of stately residential design."
...
?L7:	EQUAL? PRSA,V?REACH-IN \?L8
	FSET? PRSO,OPENED \?L9
	PRINTR "You feel a gentle but firm pressure."
?L9:	CALL2 ITS-CLOSED,PRSO
	RTRUE
?L8:	EQUAL? PRSA,V?UNLOCK \?L12
	CALL1 CTHE-PRINT
	PRINTR " doesn't have a keyhole."
...
?L3:	CALL2 ITALICIZE,STACK
	PRINTI " are inscribed on the base."
	RTRUE
...
?L1:	EQUAL? PRSA,V?EXAMINE \?L9
	CALL1 CTHE-PRINT
	PRINTI " looks like a crystalline bottle, eight feet high, with a polished "
	PRINTD CSURFACE
	PRINTI " that twists in impossible curves. "
	CALL1 INSIDE-BEGINS
	CRLF
	CALL1 READ-KLEIN
	CRLF
...
?L21:	PRINTI "Easier said than done. "
	CALL1 INSIDE-BEGINS >STACK
	RSTACK
...
?L23:	EQUAL? PRSI,0,HANDS \?L22
	CALL1 CTHE-PRINT
	PRINTR " feels oddly insubstantial."
?L22:	INTBL? PRSA,MOVEVERBS,NMVERBS >STACK \FALSE
	CALL1 PRSO-TOO-BIG
	RTRUE

	.FUNCT INSIDE-BEGINS
	PRINTI "It's hard to tell where the outside of the "
	PRINTD ENERGY
	PRINTR " ends and the inside begins."
...
?L5:	IN? PRSO,PLAYER \FALSE
	PRINTI "It'd be dangerous to do that while holding "
	CALL1 THE-PRINT
	PRINT PERIOD
	RTRUE
?L1:	EQUAL? PRSA,V?EXAMINE,V?TOUCH \?L7
	EQUAL? PRSI,0,HANDS \?L7
	PRINTR "The silver blade is still sharp."
?L7:	EQUAL? PRSA,V?TAKE \FALSE
	FSET? PRSO,TOUCHED /FALSE
	CALL1 ITAKE >STACK
	ZERO? STACK /TRUE
	PRINTI "You yank the axe out of the arborvitae."
	CRLF
	CALL1 UPDATE-SCORE
	RTRUE
	...
	CALL1 CTHE-PRINT
	FSET? PRSO,NOALL \?L4
	PRINTR " spreads like a green canopy overhead."
?L4:	FSET? PRSO,TOUCHED \?L6
	PRINTI " lies fallen across the "
	FSET? PRSO,WINDY \?L7
	PRINTD CHASM
	JUMP ?L9
?L7:	PRINTD GROUND
...
?L22:	CALL2 DEQUEUE,I-DROP-OAK
	...
	PRINTI "You "
	PRINTB P-PRSA-WORD
	PRINTI " the teetering oak northward with all your strength. It arcs across the chasm with a leafy whoosh and crashes onto the mesa, barely missing the "
	PRINTD TS3
	PRINT PERIOD
	CALL2 UPDATE-SCORE,3
	RTRUE
...
?L25:	FSET? PRSO,NOALL /?L26
	PRINTR "You've already killed the oak."
...
?L28:	EQUAL? PRSI,AXE \?L29
	...
	PRINTR "You chop at both sides of the oak's trunk until it teeters uncertainly, deciding which way it will fall."
?L29:	CALL NOT-LIKELY,PRSI,STR?188
	RTRUE
...
?L45:	CALL1 NOT-IN
	...
	PRINTR "You aren't strong enough to do that."

	.FUNCT CAVORTING
	PRINTR "You soon tire of cavorting around the oak."

	.FUNCT HAPHAZARD
	PRINTI "Your uncoordinated attempt to "
	PRINTB P-PRSA-WORD
	PRINTR " the oak only speeds its descent."
...
?L7:	FSET PRSO,TOUCHED
	CALL1 CTHE-PRINT
	PRINTR " is several hundred feet deep. Treetops block your view of the bottom."
...
?L4:	EQUAL? PRSA,V?EXAMINE,V?LOOK-ON,V?SEARCH \?L6
	ZERO? ON \?L7
	CALL1 CTHE-PRINT
	PRINTI "'s summit is ornamented with a giant "
	PRINTD AUX-TS3
	PRINT PERIOD
	RTRUE
?L7:	CALL1 V-LOOK
...
?L4:	CALL1 TS-F >STACK
	...
	EQUAL? CONTEXT,M-OBJDESC \FALSE
	PRINTI "A splintered log lies rotting in the mist at your feet. "
	CALL1 SAY-GLOWS
	RTRUE

	.FUNCT SAY-GLOWS
	PRINTI "Its edges flicker with the eerie phosphorescence of decay."
	RTRUE
...
?L10:	CALL1 CTHE-PRINT
	...
	CALL1 CTHE-PRINT
	PRINTR " is rotten with decay."
?L1:	EQUAL? PRSA,V?TOUCH,V?SQUEEZE,V?KISS \?L3
	CALL1 CTHE-PRINT
	PRINTR " feels old and squishy."
?L3:	EQUAL? PRSA,V?SMELL \FALSE
	CALL1 CTHE-PRINT
	PRINTR " is dank with corruption."
	...
	PRINTD HEAP
	ZERO? TOUCH? /?L1
	PRINTI " when you try to move it"
...
?L4:	CALL1 HANDLE-LOG? >STACK
	...
	ZERO? STACK /?L1
	PRINTI "All that's left of the log is a "
	PRINTD HEAP
	PRINT PERIOD
	RETURN 2
?L1:	ZERO? NOW-PRSI? /?L5
...
?L1:	PRINTR "too far away."
	...
	CALL1 CTHE-PRINT
	PRINTR " are remarkably bright and numerous."
...
?L1:	ZERO? NOW-PRSI? \FALSE
	...
	CALL1 CTHE-PRINT
	PRINTR " is too far away to see clearly. But its trajectory is hurling it northward, over the Arctic pole."
...
?L5:	EQUAL? PRSA,V?EXAMINE \FALSE
	CALL1 CTHE-PRINT
	PRINTI " are tiny jets attached to the "
	PRINTD XRAY
	PRINTR "'s hull."
...
?L3:	INTBL? PRSA,TOUCHVERBS,NTOUCHES >STACK \FALSE
	...
	ZERO? NOW-PRSI? \FALSE
	EQUAL? PRSA,V?EXAMINE \?L3
	PRINTI "Except for their size (about four feet across), you see nothing "
	CALL2 PICK-NEXT,YAWNS >STACK
	PRINT STACK
	PRINTI " about the "
	PRINTD PRSO
...
?L1:	CALL1 HANDLE-SOAPY-WATER? >STACK
	...
	CALL1 CTHE-PRINT
	PRINTI " is about the size of a small swimming pool, and"
	CALL1 IS-FILLED
	RTRUE
...
?L8:	INTBL? PRSA,TOUCHVERBS,NTOUCHES >STACK \FALSE
	...
	.FUNCT IS-FILLED
	PRINTI " is filled to the brim with "
	PRINTD SOAPY-WATER
	PRINT PERIOD
	RTRUE
...
?L5:	EQUAL? PRSA,V?STAND-ON,V?CROSS \FALSE
	...
	JUMP ?L3
?L1:	CALL2 CTHE-PRINT,OBJ
?L3:	PRINTR " splashes all over the place."
...
?L15:	ZERO? IN-DISH? \?L16
	CALL1 ENTER-DISH
	RTRUE
?L16:	PRINTR "You're wet enough already."
...
?L25:	EQUAL? PRSA,V?SMELL \?L26
	PRINTR "Its lemony scent reminds you of dishwashing liquid."
?L26:	EQUAL? PRSA,V?EAT,V?BITE \FALSE
	CALL1 IMPOSSIBLE
	RTRUE

	.FUNCT WET-AND-SLIPPERY
	PRINTR "It feels wet and slippery."

	.FUNCT PRSO-INTO-SOAPY-WATER
	CALL1 VANISH
	CALL1 CTHE-PRINT
	PRINTI " sinks without a trace into the white, "
	PRINTD SOAPY-WATER
	PRINT PERIOD
	RTRUE
	...
	SET 'OLD-HERE,0
	SET 'IN-DISH?,1
	PRINTI "You clamber over the edge of the dish"
	ZERO? SUITED? /?L1
	CALL1 POP-BUBBLE-SUIT
	PRINT PTHE
	PRINTD FILM
...
?L3:	PRINTI "find "
	PRINTD ME
	PRINTR " up to your knees in white, slippery water."
	...
	SET 'OLD-HERE,0
	SET 'IN-DISH?,0
	PRINTR "You clamber out of the dish."

	.FUNCT WAND-F
	ZERO? NOW-PRSI? \FALSE
	EQUAL? PRSA,V?EXAMINE \?L3
	PRINTI "It's a flat plastic stick, with hoops molded onto each end for blowing "
	PRINTD SBUBBLE
	PRINTR "s."
?L3:	INTBL? PRSA,TOUCHVERBS,NTOUCHES >STACK \FALSE
	IN? PRSO,BOY \?L5
...
The startled boy leaps backward at your approach, splashing water all over the place. ""Stupid git!"" he cries (in an intriguing Cockney accent). Then he retrieves the empty dish, pockets the wand and disappears between the prams, glaring at you over his shoulder."
	...
	CRLF
	PRINTR "His last bubble floats away over the treetops."
	...
	PRINT DONT
	PRINTI "have any bubble-blowing "
	PRINTD MIKE
	PRINT PERIOD
	RTRUE
...
?L10:	INTBL? PRSA,TOUCHVERBS,NTOUCHES >STACK \FALSE
	CALL1 CTHE-PRINT
	PRINTR " is floating high out of reach."
...
?L16:	EQUAL? PRSA,V?TOUCH,V?KNOCK,V?KISS \?L25
	...
	ZERO? VAC? \?L26
	PRINTR "flexible."
?L26:	PRINTR "firm in the vacuum of space."
...
?L39:	CALL1 EXITING? >STACK
	...
	PRINTD FILM
	PRINTR " and ricochets around until you catch it."
...
?L3:	PRINTI " of "
	...
	JUMP ?L6
?L4:	PRINTI "ain"
?L6:	PRINTI "s against the shimmering wall of soap.."
	PRINT PCR
	CALL2 ITALICIZE,STR?152
	PRINTI " The film disappears in an explosion of color"
...
?L7:	EQUAL? HERE,IN-ORBIT,ON-SAT \?L9
	...
	PRINTI ". "
	CALL2 CTHE-PRINT,OBJ
	PRINTI " sails off on a new orbit of its own"
...
?L17:	PRINT PERIOD
	...
	CALL1 I-ORBIT
?L20:	CRLF
	PRINTI "The plutonium heart of the "
	PRINTD XRAY
	PRINTI " erupts in a searing glare"
	FSET? TS1-DOOR,OPENED \?L25
	FSET? TS1-DOOR,NOALL \?L23
?L25:	CALL1 STAR-WARS
	RTRUE
?L23:	PRINTI " as you cross the threshold..."
...
?L9:	PRINT PERIOD
	...
	PRINTI ". Fortunately, your open "
	PRINTD PARASOL
	PRINTR " fills with wind and saves you from a nasty fall."
?L1:	PRINT PERIOD
	RFALSE
...
?L3:	PRINTI "dark "
?L5:	PRINTD LUMP
	PRINTI " lies half-buried at your feet"
	FIRST? LUMP >STACK \?L6
...
?L19:	CALL1 VANISH
	CALL1 CTHE-PRINT
	PRINTI " bursts into flame when it touches the "
	PRINTD PRSI
	PRINTR ". Soon there's nothing left of it."
...
?L6:	EQUAL? PRSA,V?EXAMINE,V?LOOK-ON \?L30
	CALL1 CTHE-PRINT
	PRINTI " is roughly the size and shape of a large grapefruit. Its "
	PRINTD CSURFACE
	FSET? PRSO,CHILLY \?L31
	PRINTI " glows with heat"
	JUMP ?L33
?L31:	PRINTI " is black and scorched"
...
?L46:	EQUAL? PRSI,PARASOL \?L47
	CALL1 CTHEI-PRINT
	PRINTR " proves awkward for this purpose."
...
?L60:	FSET? PRSO,CHILLY \FALSE
	PRINTR "Your sneaker sizzles with intense heat."

	.FUNCT MAGNETIC
	PRINTR "You feel a strong magnetic attraction."

	.FUNCT TOUCH-LUMP
	PRINTR "You recklessly burn your fingers on the hot metal. Ouch!"

	.FUNCT SPADE-LUMP
	PRINTI "You try really hard to "
	EQUAL? PRSA,V?TAKE-WITH \?L1
	PRINTI "lift"
	JUMP ?L3
?L1:	PRINTI "budge"
?L3:	PRINTI " the lump of metal with the "
	PRINTD SPADE
	PRINTI ". But it's hopeless. Every time you "
	EQUAL? PRSA,V?TAKE-WITH \?L4
	PRINTI "get the awkward thing balanced, it slides off with an infuriating "
	CALL2 ITALICIZE,STR?190
	CRLF
	RTRUE
?L4:	PRINTI "move the awkward thing a few inches, the "
	PRINTD SPADE
	PRINTR " slips out from underneath."
	...
	CALL2 CTHE-PRINT,ICE
	PRINTI " disappears in a hissing cloud as it touches the hot "
	PRINTD LUMP
	PRINTI ". When the steam clears, the "
	PRINTD CSURFACE
	PRINTI " of the lump is black and wet."
	CRLF
	CALL2 UPDATE-SCORE,3
	RTRUE
...
?L1:	ZERO? NOW-PRSI? /?L4
	...
	SET 'P-IT-OBJECT,NOT-HERE-OBJECT
	CALL1 CTHE-PRINT
	PRINTI " disappears into the smoky "
	PRINTD PRSI
	PRINT PERIOD
	RTRUE
...
?L5:	PRINTI "Bits of "
	PRINTD PRSO
	PRINTR " fall through your fingers."
?L4:	ZERO? NOW-PRSI? /?L6
...
?L1:	EQUAL? PRSA,V?EXAMINE,V?LOOK-INSIDE \?L4
	PRINTI "The water falls in a white curtain "
	ZERO? IN \?L6
	PRINTR "from the overhanging cliffs."
?L6:	PRINTI "across the "
	PRINTD CAVE-HOLE
	PRINTR " in the wall."
...
?L12:	FSET CAVE-HOLE,SEEN
	PRINTI "Careful inspection reveals "
?L14:	CALL2 PRINTA,CAVE-HOLE
	PRINTI " in the cliff behind the "
	PRINTD PRSO
	PRINT PERIOD
	RTRUE
...
?L17:	FSET? CAVE-HOLE,SEEN \?L19
	CALL2 DO-WALK,P?WEST
	RTRUE
?L19:	PRINTI "There's no obvious way around the "
	PRINTD PRSO
	PRINT PERIOD
	RTRUE
?L16:	EQUAL? PRSA,V?LISTEN \?L21
	CALL1 CTHE-PRINT
	PRINTR " fills the air with its hissing roar."
...
?L1:	EQUAL? PRSA,V?CROSS,V?CLIMB-OVER,V?LEAP \?L10
	PRINTI "You easily jump over the narrow "
	PRINTD PRSO
	PRINT PERIOD
	RTRUE
...
?L6:	EQUAL? PRSA,V?DRINK-FROM,V?DRINK,V?TASTE \?L7
	PRINTR "The cold water is quite refreshing."
?L7:	CALL1 DO-WATER? >STACK
	ZERO? STACK /FALSE
	RTRUE

	.FUNCT SAY-IN-MOUNTAIN-WATER
	PRINTR "in the white, foaming water."
...
?L4:	PRINTI "One touch of the frigid water"
	PRINT CHANGES
	RTRUE
?L1:	EQUAL? PRSA,V?TOUCH,V?REACH-IN \?L5
	EQUAL? PRSI,0,HANDS \?L5
	PRINTI "The water is very cold."
	CRLF
...
?L11:	CALL1 EXITING? >STACK
	...
	EQUAL? PRSA,V?EXAMINE \?L1
	CALL1 CTHE-PRINT
	PRINTR " are carved into the face of the cliff."
...
?L34:	CALL1 ALREADY-AT-TOP
	...
	.FUNCT HEADS-F
	EQUAL? PRSA,V?EXAMINE,V?WATCH \?L1
	PRINTR "The sightless eyes seem to follow you around."
?L1:	CALL1 STATUARY-F >STACK
	...
	EQUAL? PRSA,V?EXAMINE,V?WATCH \?L3
	CALL1 CTHE-PRINT
	PRINTR " lie motionless in the grass."
?L3:	EQUAL? PRSA,V?TAKE,V?RAISE,V?PUSH /?L5
	EQUAL? PRSA,V?PULL,V?MOVE \?L4
?L5:	PRINTI "The cold, clammy feel of the "
	PRINTD PRSO
	PRINT CHANGES
	RTRUE
...
?L3:	RETURN TOMBS
	...
	CALL1 CTHE-PRINT
	PRINTI " are covered with forgotten names and hopeless epitaphs"
	ZERO? FLIP? /?L4
	PRINTI ", all engraved backwards"
?L4:	PRINT PERIOD
	FSET? PRSO,SEEN /TRUE
	FSET PRSO,SEEN
	CRLF
	CALL VOICE-MUTTERS,STR?191,0
	RTRUE
?L3:	INTBL? PRSA,MOVEVERBS,NMVERBS >STACK \?L10
	CALL1 CTHE-PRINT
	PRINTR " are deeply imbedded in the ground."
...
?L3:	EQUAL? PRSA,V?EXAMINE \?L8
	PRINTI "The granite "
	PRINTD PRSO
	PRINTI " must be hundreds of years old. It"
	FSET? PRSO,OPENED \?L9
	PRINTI "s lid is broken off, leaving a jagged "
	PRINTD CAVE-HOLE
	JUMP ?L12
?L9:	PRINTI "'s sealed shut with a heavy lid"
...
?L23:	EQUAL? PRSA,V?REACH-IN \?L24
	...
	PRINTR "You feel something nasty."
...
?L32:	EQUAL? PRSA,V?CLOSE \?L34
	...
	PRINT CANT
	PRINTI "do that now. You broke the "
	PRINTD LID
	PRINT PERIOD
	RTRUE
?L35:	CALL2 ITS-ALREADY,STR?57
	RTRUE
?L34:	EQUAL? PRSA,V?ENTER,V?LIE-DOWN \?L38
	FSET? PRSO,OPENED \?L39
	PRINTR "There's room for only one stiff."
...
?L38:	CALL1 DISRESPECT? >STACK
	...
	RTRUE
?L5:	CALL YOUD-HAVE-TO,STR?192,PRSI
	RTRUE
...
?L14:	CALL2 VANISH,PRSI
	CALL1 LEAN-ON-LID
	CALL1 CTHEI-PRINT
	PRINTI "'s handle snaps neatly in half.

You curse and fume at the stupid, flimsy "
	PRINTD PRSI
	PRINTR ", and obtain great satisfaction by throwing the broken pieces over the edge of the cliff."
?L13:	EQUAL? PRSI,SPADE \?L17
	...
	CALL1 LEAN-ON-LID
	PRINTI "You feel a puff of foul-smelling air as a section of the crypt's lid breaks away"
	FIRST? LID >STACK \?L18
	CALL MOVE-ALL,LID,BONEYARD
	PRINTI ". Everything that was on the "
	PRINTD CRYPT
	PRINTI " scatters to the ground"
?L18:	PRINT PERIOD
	MOVE GOON,CRYPT
	CALL2 UPDATE-SCORE,3
	RTRUE
?L17:	CALL NOT-LIKELY,PRSI,STR?193
	RTRUE
...
?L24:	EQUAL? PRSA,V?HIT \?L25
	EQUAL? PRSI,AXE \?L25
	PRINTR "You'd probably ruin the blade."
?L25:	CALL1 DISRESPECT? >STACK
	ZERO? STACK /FALSE
	RTRUE

	.FUNCT LIFT-LID
	PRINTR "Beads of sweat stand out on your forehead as you strain against the lid. But it'll take more leverage than you've got to budge it."

	.FUNCT LEAN-ON-LID
	PRINTI "You slide the end of "
	CALL1 THEI-PRINT
	PRINTI " under the lid's edge and lean on it with all your strength.

"
	CALL2 ITALICIZE,STR?194
	PRINTI " "
	RTRUE

	.FUNCT DESCRIBE-LID
	CALL1 CTHE-PRINT
	PRINTI " is a formidable slab of granite"
	FIRST? PRSO >STACK \?L1
	PRINTI ". "
	PRINT YOU-SEE
	CALL2 PRINT-CONTENTS,PRSO
...
?L4:	PRINTR "That would be a disrespectful thing to do."
...
?L10:	SET 'P-IT-OBJECT,NOT-HERE-OBJECT
	MOVE PRSO,IN-BARROW
	CALL1 CTHE-PRINT
	PRINTI " disappears into the darkness of the "
	PRINTD PRSI
	PRINT PERIOD
	RTRUE
...
?L7:	PRINTR "The door bristles with iron spikes."
...
?L9:	EQUAL? PRSI,0,HANDS \?L8
	PRINTR "Ouch! The spikes on the door are razor-sharp."
...
?L13:	CALL1 CTHE-PRINT
	PRINTR " resists your feeble assault."
?L12:	CALL1 ENTERING? >STACK
	ZERO? STACK \?L15
...
?L5:	PRINTI " is gray and tattered"
	FSET? PRSO,NODESC \?L8
	PRINTI ". It's wrapped loosely around the "
	PRINTD GOON
?L8:	PRINT PERIOD
	RTRUE
?L3:	EQUAL? PRSA,V?TAKE \?L11
	...
	PRINTI " from the "
	PRINTD GOON
	PRINTI ", revealing its decomposed body."
	CRLF
	CALL1 UPDATE-SCORE
	RTRUE
?L11:	CALL1 HANDLE-CLOTH? >STACK
	...
	EQUAL? PRSI,AXE \?L1
?L3:	CALL1 CTHE-PRINT
	PRINTR " is tattered enough already."
...
?L5:	EQUAL? PRSA,V?OPEN,V?OPEN-WITH,V?UNFOLD \FALSE
	...
	PRINTR "You sense the gray odor of death."

	.FUNCT BANDAGE-F
	ZERO? NOW-PRSI? \FALSE
	EQUAL? PRSA,V?EXAMINE,V?LOOK-INSIDE,V?SEARCH /?L4
	EQUAL? PRSA,V?LOOK-UNDER \?L3
?L4:	PRINTI "It's a broad strip of gray cloth"
	FSET? PRSO,NODESC \?L5
	PRINTI ", wrapped over the top of the "
	PRINTD GOON
	PRINTI "'s head and under its chin"
	JUMP ?L7
?L5:	FSET? PRSO,WORN \?L7
	PRINTI ", wrapped around your head"
?L7:	PRINT PERIOD
	RTRUE
...
?L1:	CALL2 MULTIBOOT?,RBOOT >X
	ZERO? X /?L6
	RETURN X
?L6:	CALL2 HANDLE-BOOT?,STR?195 >STACK
	RSTACK
...
?L1:	CALL2 MULTIBOOT?,GBOOT >X
	ZERO? X /?L6
	RETURN X
?L6:	CALL2 HANDLE-BOOT?,STR?174 >STACK
	RSTACK
	...
	ZERO? STACK /?L1
	PRINTR "The recess you saw before is gone now."
...
?L5:	CALL NOUN-USED?,W?WING,W?WINGS >STACK
	...
	PRINTI "[You can only do that to one "
	PRINT STR
	PRINTR " at a time.]"
...
?L9:	EQUAL? BOOT,GBOOT \?L7
	...
	ZERO? STACK \?L7
?L8:	PRINTI "There's only one boot here."
	CRLF
	RETURN 2
...
?L13:	REMOVE PRSO
	...
	PRINTD PRSO
	PRINTI " into the toe of the "
	PRINTD PRSI
	PRINTI ". As you watch, the "
	PRINT STR
	PRINTI " leather closes around the jewel and absorbs it like melting wax.
...
?L16:	FSET? PRSI,WORN \?L20
	CALL YOUD-HAVE-TO,STR?71,PRSI
	RTRUE
?L20:	GETP PRSO,P?SIZE >STACK
	GRTR? STACK,2 \?L22
	CALL1 CTHE-PRINT
	PRINTR " wouldn't fit in there."
?L22:	CALL1 CTHE-PRINT
	PRINTI " slides out and "
	CALL1 LANDS-AT-YOUR-FEET
	RTRUE
?L7:	EQUAL? PRSA,V?EXAMINE,V?LOOK-ON \?L26
	PRINTI "The boot is exceedingly well-made, and colored bright "
	PRINT STR
	PRINT PA
	FSET? PRSO,CHILLY \?L27
	PRINTI "pair of miniature wings sprouts from the heel"
	JUMP ?L29
?L27:	PRINTI "small recess is visible at the toe's tip"
?L29:	PRINT PERIOD
	RTRUE
...
?L1:	CALL1 HANDLE-COIN? >STACK
	...
	PRINTD CEILING
	PRINTR " and falls to the ground."
?L7:	PRINTI "You're showered with useless ice fragments"
	ZERO? SUITED? /?L10
	CALL1 POP-BUBBLE-SUIT
	PRINTI ", and the "
	PRINTD FILM
...
?L15:	EQUAL? PRSA,V?HIT,V?LOOSEN \?L16
	...
	PRINTD CEILING
	JUMP ?L21
?L19:	PRINTI "There aren't any more "
	PRINTD PRSO
	PRINTI " within reach of the "
	PRINTD PRSI
?L21:	PRINT PERIOD
	RTRUE
?L17:	CALL1 NICE-TRY
...
?L16:	INTBL? PRSA,TOUCHVERBS,NTOUCHES >STACK \FALSE
	...
	PRINTI "melting "
?L4:	PRINTD ICE
	PRINTR " looks like a crystal needle, eighteen inches long."
...
?L1:	PRINT PERIOD
	...
	JUMP ?L6
?L4:	PRINTI "small hole is visible in "
?L6:	PRINTI "the wall."
	RTRUE
...
?L9:	EQUAL? PRSO,KEY \?L11
	MOVE PRSO,KEYHOLE
	CALL1 CTHE-PRINT
	PRINTR " slides into the hole with a satisfying click."
...
?L13:	CALL2 TOO-SMALL,PRSI
	RTRUE
?L12:	IN? KEY,PRSI \?L14
	CALL YOUD-HAVE-TO,STR?172,KEY
	RTRUE
?L14:	PRINTI "You try jamming "
	CALL1 THE-PRINT
	PRINTR " into the hole, but it doesn't fit."
...
?L17:	EQUAL? PRSA,V?LOOK-INSIDE,V?LOOK-BEHIND \?L21
	...
	PRINTR " is blocking the hole."
?L22:	PRINTI "It occurs to you that there might be another "
	PRINTD WIGHT
	PRINTR " beyond that wall, waiting to jab a hot spike into your eye. You decide not to risk it."
...
?L1:	ZERO? NOW-PRSI? /?L5
	...
	PRINTD SLOPE
	PRINTI " into the darkness below."
	CRLF
	CALL1 SAY-IF-HERE-LIT
	RTRUE
?L5:	EQUAL? PRSA,V?EXAMINE,V?LOOK-INSIDE,V?SEARCH /?L10
...
?L10:	CALL1 CTHE-PRINT
	PRINTR " leads down into darkness."
...
?L20:	CALL1 V-WALK-AROUND
	...
	EQUAL? PRSA,V?EXAMINE \?L1
	CALL1 CTHE-PRINT
	PRINTI " become more numerous as your eyes sweep "
	CALL1 SAY-WEST
	PRINTR "ward."
...
?L17:	EQUAL? PRSA,V?SMELL \FALSE
	...
	.FUNCT DIG-IN-GARDEN
	PRINTI "It would be a shame to disturb the "
	PRINTD HERBS
	PRINTR ". They're so nice and symmetrical."
...
?L11:	CALL1 ITS-CLOSED
	...
	ZERO? NOW-PRSI? \FALSE
	EQUAL? PRSA,V?EXAMINE \?L3
	PRINTR "It's at least ten feet high."
...
?L6:	CALL1 EXITING? >STACK
	...
	ZERO? NOW-PRSI? \FALSE
	EQUAL? PRSA,V?EXAMINE,V?LOOK-INSIDE,V?SEARCH \?L3
	PRINTR "The herbs are lovingly planted in neat, parallel rows."
?L3:	EQUAL? PRSA,V?SMELL \?L4
	CALL1 SMELL-GARLIC
	RTRUE
...
?L5:	CALL1 PLAYING-IN? >STACK
	...
	ZERO? NOW-PRSI? \FALSE
	EQUAL? PRSA,V?EXAMINE,V?LOOK-ON \?L3
	PRINTI "It's just a dry heap of discarded stalks and dirt."
	CALL1 LOOK-ON-PILE
	CRLF
	RTRUE
...
?L5:	FSET? GARLIC,NODESC \?L6
	...
	PRINTI "You find nothing in the pile except a rotten "
	PRINTD GARLIC
	JUMP ?L8
?L6:	PRINTI "Further sifting reveals nothing new in the "
	PRINTD PRSO
?L8:	PRINT PERIOD
	RTRUE
?L4:	EQUAL? PRSA,V?TAKE \?L9
	PRINTR "Dirt falls uselessly through your fingers."
?L9:	CALL1 PLAYING-IN? >STACK
	...
	EQUAL? PRSA,V?EXAMINE \?L3
	CALL1 CTHE-PRINT
	PRINTR " is at least a year old."
?L3:	EQUAL? PRSA,V?EAT,V?BITE \?L4
	CALL1 VANISH
	PRINTI "You cram the dirty "
	PRINTD PRSO
	PRINTR " in your mouth and chew with enthusiasm. Soon it's completely gone."
...
?L6:	EQUAL? PRSA,V?SMELL \FALSE
	...
	.FUNCT SMELL-GARLIC
	PRINTR "You make out a distinctly rancid odor."

	.FUNCT PATCH-F
	ZERO? NOW-PRSI? \FALSE
	EQUAL? PRSA,V?EXAMINE,V?LOOK-INSIDE,V?SEARCH \?L3
	CALL1 CTHE-PRINT
	PRINTI " must have looked nice before the "
	PRINTD TS4
	PRINTR " ruined it."
...
?L5:	PRINTR "Better not. There isn't much thyme left."
...
?L6:	CALL1 PLAYING-IN? >STACK
	...
	PRINTR "The scent is vaguely aromatic."
...
?L1:	CALL2 HANDLE-STAIRS?,ON-PLATFORM >STACK
	...
	EQUAL? PRSA,V?EXAMINE,V?LOOK-ON,V?LOOK-INSIDE \?L1
	CALL1 CTHE-PRINT
	PRINTR " tower like gray walls against the sky."
...
?L14:	CALL2 CTHE-PRINT,RATS
	CALL1 RUN-OR-LEAPING
	PRINTI " look something like hamsters"
	CALL1 LONG-BROWN
	PRINT PTHE
	PRINTR "largest are only five or six inches long."
...
?L17:	EQUAL? PRSA,V?TAKE,V?RAISE \?L23
	PRINTI "You manage to grab one of the "
	PRINTD RATS
	PRINTI ", but it relieves itself in "
	PRINTD HANDS
	PRINTR "s and struggles away."
...
?L1:	PRINTI " running past"
	...
	PRINTI "sniffs at "
	CALL1 THE-PRINT
	PRINTR ", but shows no interest."
?L5:	CALL NOT-LIKELY,PRSO,STR?199
	RTRUE
?L1:	INTBL? PRSA,TALKVERBS,NTVERBS >STACK \?L9
	PRINT CTHELEM
	PRINTI "sulks, refusing to respond."
	CRLF
	RETURN 2
?L9:	EQUAL? PRSA,V?EXAMINE \?L12
	PRINT CTHELEM
	PRINTI "looks something like a hamster"
	CALL1 LONG-BROWN
	PRINTI " that "
	EQUAL? HERE,IN-ORBIT,ON-SAT \?L13
	ZERO? SUITED? \?L13
	PRINTR "bulge in the vacuum of space."
?L13:	PRINTR "glare at you defiantly."
?L12:	EQUAL? PRSA,V?WATCH \?L16
	EQUAL? HERE,IN-ORBIT,ON-SAT \?L17
	ZERO? SUITED? \?L17
	PRINTR "It isn't looking well."
...
?L1:	EQUAL? PRSA,V?EXAMINE,V?LOOK-INSIDE,V?SEARCH \?L6
	...
	PRINTI "A trapped "
	PRINTD LEM
	PRINTI " glares up at you defiantly"
	FIRST? PRSO >STACK \?L7
	PRINTI ". There's also "
	CALL2 PRINT-CONTENTS,PRSO
	PRINTI " in the "
...
?L11:	CALL1 EXITING? >STACK
	...
	CALL1 VANISH
	CALL1 CTHE-PRINT
	PRINTI " disappears over the edge of the "
	PRINTD TCLIFF
	PRINT PERIOD
	RTRUE
...
?L13:	EQUAL? PRSA,V?STAND-ON \FALSE
	...
	FSET TCLIFF,TOUCHED
	PRINTI "The waves dashing on the rocks below are choked with "
	PRINTD DLEM
	PRINTR "s."
	...
	CALL1 VANISH
	CALL1 CTHE-PRINT
	PRINTR " disappears over the cliff."
?L1:	EQUAL? PRSA,V?EXAMINE,V?LOOK-ON,V?LOOK-INSIDE /?L7
	EQUAL? PRSA,V?SEARCH \?L6
...
?L12:	CALL1 CANT-FROM-HERE
	...
	EQUAL? PRSA,V?EXAMINE \?L3
	CALL1 CTHE-PRINT
	PRINTI " run southwest, across the "
	PRINTD TUNDRA
	PRINT PERIOD
	RTRUE
...
?L10:	CALL1 WASTE-OF-TIME
	...
	PRINTI "The distant "
	PRINTD SCHOOL
	PRINTI "s look like military "
	PRINTD NBUNKERS
	PRINTR ". Armed guards are patrolling the area."
?L1:	CALL1 RUSSIA? >STACK
	...
	PRINTI "Luckily, the "
	PRINTD RUSSIANS
	PRINTI " don't notice. You're still too far away."
	CRLF
	RETURN 2
?L1:	CALL1 RUSSIA? >STACK
	ZERO? STACK /FALSE
...
?L1:	CALL1 SAY-SURE
	...
	ZERO? STACK /?L4
	CRLF
	CALL2 VOICE-MUTTERS,STR?200
	PRINTI "You draw closer to the "
	PRINTD GROUP
	PRINT PCR
	HLIGHT H-BOLD
	...
	CRLF
	CRLF
	PRINTI "This cluster of military "
	PRINTD NBUNKERS
	PRINTI " is choked with scientific instruments, tended by men in heavy overcoats.
...
?L5:	PRINTR "There aren't any good footholds."
?L4:	CALL1 EXITING? >STACK
	ZERO? STACK \?L7
	EQUAL? PRSA,V?CLIMB-DOWN,V?LEAP,V?DIVE \?L6
?L7:	PRINTR "You're not in a tree."
?L6:	CALL1 ENTERING? >STACK
	ZERO? STACK /?L8
	CALL1 V-WALK-AROUND
	RTRUE
...
?L9:	EQUAL? PRSA,V?SMELL \FALSE
	CALL1 CTHE-PRINT
	PRINTR " smells old and damp."

	.FUNCT TRELS-F
	EQUAL? PRSA,V?EXAMINE \?L1
	PRINTI "They lead southeast and southwest, into the "
	PRINTD HEDGE
	PRINT PERIOD
	RTRUE
?L1:	EQUAL? PRSA,V?COUNT \?L3
...
?L9:	GETP HERE,P?OVER-HEDGE >STACK
	...
	SET 'P-IT-OBJECT,NOT-HERE-OBJECT
	CALL1 CTHE-PRINT
	PRINTR " sails over the top of the hedge and disappears."
?L7:	EQUAL? PRSA,V?PUT-ON \FALSE
	CALL1 PRSI-TOP-TOO-HIGH
	RTRUE
?L5:	EQUAL? PRSA,V?EXAMINE \?L14
	CALL2 CTHE-PRINT,HEDGE
	PRINTI " is a dense tangle of "
	PRINTD ARBS
...
?L15:	EQUAL? HERE,DOCKSIDE \?L17
	PRINTI ". It ends at the river's edge"
?L17:	PRINT PERIOD
	RTRUE
...
?L40:	EQUAL? PRSA,V?SMELL \FALSE
	...
	.FUNCT SMELL-HEDGE
	PRINTI "The air is pungent with the odor of "
	PRINTD ARBS
	PRINT PERIOD
	RTRUE
...
?L1:	EQUAL? PRSA,V?EXAMINE,V?LOOK-INSIDE,V?SEARCH \?L4
	...
	RTRUE
?L6:	CALL1 CTHE-PRINT
	PRINTI " resembles a doughnut, fifty feet across and woven entirely of "
	PRINTD ARBS
	PRINTI ". This ""doughnut"" is standing on end, and you're gawking up at it from underneath. "
	CALL1 DESCRIBE-PERGOLA
	PRINTR "The whole affair is oddly skewed; some parts look as if they're turned inside out."
?L4:	CALL1 ENTERING? >STACK
	ZERO? STACK \?L10
...
?L1:	CALL1 SKY-F >STACK
	...
	PRINTR " is thick and suffocating."

	.FUNCT DESCRIBE-TRAP,CONTEXT=0
	EQUAL? CONTEXT,M-OBJDESC \FALSE
	PRINTI "A big Venus "
	PRINTD TRAP
	PRINTI " is growing nearby. Its crimson jaws are "
	FSET? TRAP,OPENED \?L3
	PRINTI "wide open, exposing a cavity that gleams with sweet-smelling "
	PRINTD ICHOR
	PRINTI "."
	RTRUE
...
?L7:	PRINTI "jaws are fully three feet across."
	FSET? PRSO,OPENED \?L8
	PRINTI " The inside"
...
?L15:	INTBL? PRSA,MOVEVERBS,NMVERBS >STACK \FALSE
	...
	CALL1 CLOSE-TRAP
	PRINTI "when it snaps its jaws shut, nearly severing "
	PRINTD HANDS
	PRINT PERIOD
	RTRUE
...
?L1:	PRINTI "The closed "
	...
	PRINTR "'s smell reminds you of corn syrup."
	...
	PRINTI "You barely manage to leap away from the "
	PRINTD TRAP
	PRINTR " before the crimson jaws snap shut."

	.FUNCT LOOK-INTO-TRAP
	PRINTI " is coated with a glistening "
	PRINTD ICHOR
	PRINTI " that resembles morning dew."
	RTRUE
...
?L3:	CALL1 HERE-F >STACK
	...
	.FUNCT HEAR-DRIPPING
	PRINTI "You can hear dripping liquids and other moist "
	PRINTD SOUND
	PRINTR "s close by."
...
?L12:	CALL2 RUPTURES-HIVE,PRSO
	RTRUE
?L1:	EQUAL? PRSA,V?EXAMINE \?L15
	PRINTI "The gray mass of the "
	PRINTD PRSO
	PRINTI " hangs down from the overhanging cliff. A dark "
	PRINTD CAVE-HOLE
	PRINTR " in the bottom is low enough to reach."
...
?L19:	EQUAL? PRSA,V?SMELL,V?INHALE \?L24
	CALL1 CTHE-PRINT
	PRINTR " fills the air with a sweet odor."
...
?L4:	MOVE OBJ,HERE
	CALL2 CTHE-PRINT,OBJ
	PRINTI " strikes the hive and lands harmlessly at your feet."
	CRLF
	CALL1 BUZZ-RISES
	RTRUE
	...
	JUMP ?L3
?L1:	PRINTI "greedi"
?L3:	PRINTI "ly into the hive, and feel something sticky at your fingertips. "
	FSET? BEE,BORING \?L4
	FCLEAR BEE,BORING
	MOVE BEE,UNDER-CLIFF
	CALL QUEUE,I-BEE,-1
	PRINTI "Then a sharp, burning pain sears "
	PRINTD HANDS
	PRINTI " like fire!

Howling with agony"
	CALL1 YANK-ARM
	PRINTR "shake a gigantic bee off your swelling hand."
?L4:	PRINTI "Without hesitation"
	...
	FCLEAR HONEY,NODESC
	MOVE HONEY,PLAYER
	PRINTI " gleaming with a golden "
	PRINTD HONEY
	PRINT PERIOD
	CALL2 UPDATE-SCORE,3
	RTRUE
?L7:	PRINTI " covered with gigantic bees!"
	CRLF
	CALL1 BEES-ATTACK
	RTRUE

	.FUNCT YANK-ARM
	PRINTI ", you yank your arm out of the hive and "
	RTRUE

	.FUNCT RUPTURES-HIVE,THING
	PRINTI "With a papery "
	CALL2 ITALICIZE,STR?203
	PRINTI " "
	CALL2 THE-PRINT,THING
	PRINTI " ruptures the "
	PRINTD CSURFACE
	...
	.FUNCT BEES-ATTACK
	CRLF
	PRINTI "Giant bees pour out of the hive in an angry cloud! They cover your face and neck with hundreds of stings, any few of which would have been enough to kill you."
	CALL1 JIGS-UP
	RTRUE
	...
	PRINTR "'s buzz grows louder, then slowly subsides."

	.FUNCT HONEY-F
	IN? HONEY,HIVE \?L1
	CALL CANT-SEE-ANY,STR?204,1
	RETURN 2
?L1:	ZERO? NOW-PRSI? /?L5
...
?L10:	EQUAL? PRSA,V?TASTE,V?EAT \?L15
	CALL1 VANISH
	PRINTR "You lick all the honey off your fingers. Yum."
...
?L16:	INTBL? PRSA,HAVEVERBS,NHAVES >STACK \FALSE
	...
	.FUNCT HONEYFY,OBJ
	PRINTI "You'd get honey all over "
	CALL2 THE-PRINT,OBJ
	PRINT IF-YOU-DID
	RTRUE

	.FUNCT HONEY-STICKS
	PRINTI "The honey sticks stubbornly to "
	PRINTD HANDS
	PRINT PERIOD
	RTRUE
...
?L6:	PRINT CANT
	...
	.FUNCT EARS-RING
	PRINTR "heir buzz is making your ears ring."

	.FUNCT BEE-F
	CALL2 NOUN-USED?,W?BEES >STACK
	ZERO? STACK /?L1
	PRINTI "You see only one bee here."
	CRLF
	RETURN 2
?L1:	ZERO? NOW-PRSI? /?L5
	EQUAL? PRSA,V?THROW,V?THROW-OVER \FALSE
...
?L5:	EQUAL? PRSA,V?EXAMINE \?L9
	CALL1 CTHE-PRINT
	PRINTR " is about a foot long, including a three-inch stinger tipped with a drop of your own blood."
...
?L13:	PRINTR "You have lost your mind."
?L12:	EQUAL? PRSA,V?LISTEN \?L14
	CALL1 CTHE-PRINT
	PRINTR " buzzes with indignance."
?L14:	INTBL? PRSA,TALKVERBS,NTVERBS >STACK \?L15
	CALL1 CTHE-PRINT
	PRINTI " buzzes angrily in reply."
	CRLF
	RETURN 2
...
?L18:	CALL1 EXITING? >STACK
	...
	EQUAL? PRSA,V?EXAMINE \?L3
	CALL1 CTHE-PRINT
	PRINTI " is about three feet in diameter and ten feet long. "
	CALL1 READ-UBOMB
	RTRUE
...
?L12:	EQUAL? PRSI,AXE,SPADE,GNOMON /?L15
	EQUAL? PRSI,LUMP \?L14
?L15:	CALL2 VOICE-MUTTERS,STR?206
	PRINTI "Your "
	PRINTD PRSI
	...
	RTRUE
?L14:	CALL NOT-LIKELY,PRSI,STR?207
	RTRUE
...
?L18:	PRINTI "Cavorting around the "
	PRINTD PRSO
	CALL1 WONT-HELP
	RTRUE
?L17:	INTBL? PRSA,MOVEVERBS,NMVERBS >STACK \FALSE
	...
	PRINTI "into a compartment lined with high explosives. The resulting blast fails to initiate the nuclear reaction it was designed to trigger. It is, nevertheless, sufficiently powerful to blow you to bits."
	CALL1 JIGS-UP
	RTRUE
	...
	.FUNCT READ-UBOMB
	PRINTR "Warnings indicate the presence of radioactivity."

	.FUNCT UCABLES-F
	ZERO? NOW-PRSI? \FALSE
	EQUAL? PRSA,V?EXAMINE \?L3
	CALL1 CTHE-PRINT
	PRINTI " lead west, into the "
	EQUAL? HERE,TUN3 \?L4
	PRINTD LANDSLIDE
	JUMP ?L6
?L4:	PRINTD CAVERN
...
?L8:	CALL2 DEEP-CREVICE,STACK
	...
	PRINTI "It's too dark to see anything in the "
	PRINTD CREVICE
	PRINT PERIOD
	RTRUE
	...
	EQUAL? PRSO,SHARD \?L5
	MOVE PRSO,PRSI
	PRINTI "It doesn't look as if the "
	PRINTD PRSO
	PRINTI " is going to fit. But you twist it harder against the narrow "
	PRINTD CAVE-HOLE
	PRINTI ", harder.."
	PRINT PCR
	CALL2 ITALICIZE,STR?208
	PRINTI " The soft wood falls to the bottom of the "
	PRINTD PRSI
	PRINTR ", filling it with pale light."
...
?L7:	PRINTI "into the "
	...
	EQUAL? PRSA,V?EXAMINE,V?WATCH \?L1
	FCLEAR PRSO,SEEN
	PRINTR "It's a scaly lizard, four inches long, with big eyes and a little pink mouth."
?L1:	FSET SKINK,SEEN
	ZERO? NOW-PRSI? /?L4
...
?L6:	EQUAL? PRSA,V?THROW,V?THROW-OVER \FALSE
	GETP PRSO,P?SIZE >STACK
	GRTR? STACK,3 /?L9
	CALL NOT-LIKELY,PRSO,STR?209
	RTRUE
?L9:	IN? PRSI,PLAYER \?L11
	CALL YOUD-HAVE-TO,STR?210,PRSI
	RTRUE
...
?L4:	EQUAL? PRSA,V?SQUEEZE \?L14
	...
	CALL YOUD-HAVE-TO,STR?139,PRSO
	RTRUE
?L15:	PRINTI "The tiny lizard writhes in your grasp and claws at your fingers, its pink mouth gasping for breath. You squeeze harder and harder until your fist trembles with the effort"
	PRINT PCR
	CALL1 CTHE-PRINT
...
?L23:	GETP PRSI,P?SIZE >STACK
	GRTR? STACK,3 /?L25
	CALL NOT-LIKELY,PRSI,STR?209
	RTRUE
?L25:	IN? PRSO,PLAYER \?L26
	CALL YOUD-HAVE-TO,STR?210,PRSO
	RTRUE
...
?L29:	INTBL? PRSA,TALKVERBS,NTVERBS >STACK \FALSE
	CALL1 CTHE-PRINT
	PRINTI " decides not to respond."
	CRLF
	RETURN 2

	.FUNCT SKINK-SCAMP
	CALL2 CTHE-PRINT,SKINK
	PRINTR " scampers out of the way."

	.FUNCT DSKINK-F
	EQUAL? PRSA,V?EXAMINE \?L1
	PRINTR "Did it just move a little? No; it's quite dead."
?L1:	EQUAL? PRSA,V?KILL,V?SQUEEZE \?L3
	CALL2 ITS-ALREADY,STR?211
	RTRUE
...
?L4:	EQUAL? PRSA,V?KISS \FALSE
	...
	PRINTI "squirming "
?L4:	PRINTD PRSO
	PRINTR " into your mouth, bite deep and swallow it with a satisfying gulp."
...
?L1:	EQUAL? PRSA,V?EXAMINE \?L6
	CALL1 CTHE-PRINT
	PRINTR " are bleached white from years in the sun. They range from bits of rib and skull to complete skeletons."
...
?L8:	FSET? KEY,NODESC \?L9
	...
	MOVE KEY,OSSUARY
	SET 'P-IT-OBJECT,KEY
	PRINTI "As you sift dispiritedly through the "
	PRINTD PRSO
	PRINTI ", a "
	PRINTD KEY
	PRINTR ", still clutched in a long-dead hand, catches your eye."
?L9:	PRINTI "Further sifting through the "
	PRINTD PRSO
	PRINTI " reveals nothing "
	CALL2 PICK-NEXT,YAWNS >STACK
	PRINT STACK
...
?L13:	EQUAL? PRSI,0,HANDS \?L12
	CALL1 CTHE-PRINT
	PRINTR " feel dry and brittle."
?L12:	EQUAL? PRSA,V?SMELL \?L14
	CALL1 CTHE-PRINT
	PRINTR " are completely odorless."
?L14:	EQUAL? PRSA,V?HIT,V?KICK,V?KNOCK \FALSE
	PRINTI "Bones clatter in all "
	PRINTD INTDIR
	PRINTR "s."
	...
	ZERO? NOW-PRSI? \FALSE
	EQUAL? PRSA,V?EXAMINE \?L3
	PRINTR "Its slender form reminds you of a crooked finger."
?L3:	EQUAL? PRSA,V?TAKE \?L4
	...
	PRINTD PRSO
	PRINTI " out from between the fingers."
	CRLF
	CALL1 UPDATE-SCORE
	RTRUE
...
?L9:	FSET SLOPE,OPENED
	...
	PRINTI "You slowly twist the key in the hole"
	PRINT PCR
	CALL2 CTHE-PRINT,GROUND
	PRINTI " under your feet is moving! You leap out of the way, and watch as a hidden slope opens up beneath the keyhole."
	CRLF
...
?L12:	FSET WIGHT,SEEN
	CRLF
	CALL2 CTHE-PRINT,WIGHT
	PRINTR " stomps its feet and howls with rage."
...
?L15:	INTBL? PRSA,MOVEVERBS,NMVERBS >STACK \FALSE
	...
	FSET? SLOPE,OPENED \FALSE
	PRINTR "The key is firmly locked into place."
...
?L8:	SET 'P-IT-OBJECT,NOT-HERE-OBJECT
	CALL1 CTHE-PRINT
	PRINTI " disappears into the dark "
	PRINTD PRSI
	PRINT PERIOD
	RTRUE
...
?L1:	EQUAL? PRSA,V?WALK-TO,V?FOLLOW \FALSE
	...
	INTBL? PRSA,TOUCHVERBS,NTOUCHES >STACK /?L5
	INTBL? PRSA,HURTVERBS,NHVERBS >STACK \FALSE
?L5:	CALL YOUD-HAVE-TO,STR?56,CAGE
	RTRUE
...
?L5:	EQUAL? PRSO,MEEP \?L7
	...
	PRINTD HANDS
	PRINTR ", but you grit your teeth and stuff the protesting bird into the cage."
?L7:	EQUAL? PRSO,LEM \?L8
	MOVE PRSO,PRSI
	CALL1 CTHE-PRINT
	PRINTI " sinks its teeth into your thumb when it sees the cage. But you jam it inside anyway."
	CRLF
...
?L1:	EQUAL? PRSA,V?EXAMINE \?L19
	PRINTI "The"
	CALL2 OPEN-CLOSED,PRSO
	PRINTI " is cunningly woven of brown and yellow wicker"
	CALL2 SEE-ANYTHING-IN?,PRSO >STACK
	ZERO? STACK /?L20
	PRINTI ". Peering between the slats, you see "
	CALL2 PRINT-CONTENTS,PRSO
?L20:	PRINT PERIOD
	RTRUE
?L19:	EQUAL? PRSA,V?OPEN,V?OPEN-WITH \FALSE
	...
	CRLF
	CALL2 CTHE-PRINT,MAGPIE
	PRINTI " flutters out of the cage and "
	ZERO? SUITED? /?L26
	CALL2 FREE-MAG,FILM
	RTRUE
...
?L32:	CALL1 EXIT-MAGPIE
	PRINTR "soars through the open door."
...
?L24:	IN? LEM,PRSO \TRUE
	...
	.FUNCT FREE-MAG,OBJ
	FCLEAR CAGE,OPENED
	PRINTI "circles around the inside of the "
	PRINTD OBJ
	PRINTR ". After considerable effort, you manage to stuff it back in the cage and slam the door shut."
	...
	PRINTR ", but shows no interest."
?L1:	EQUAL? PRSA,V?EXAMINE \?L6
	PRINTR "Its sharp little eyes stare back at you suspiciously."
...
?L9:	CALL1 CTHE-PRINT
	...
	CALL2 PICK-NEXT,STACK >STACK
	PRINT STACK
	PRINTI ", pretending not to understand."
	CRLF
	RETURN 2
...
?L12:	CALL1 VANISH
	...
	PRINTI " disappears into the "
	PRINTD PRSI
	PRINTI " in a greasy puff of steam"
	EQUAL? PRSO,PARASOL,SPADE \?L14
	PRINTI "; a startling result, for "
	CALL1 THE-PRINT
	PRINTI " was longer than the "
	PRINTD PRSI
	PRINTR " is deep."
...
?L1:	EQUAL? PRSA,V?EXAMINE \?L21
	...
	PRINTI "White "
	PRINTD STEAM
	PRINTI " writhe mysteriously from "
	CALL1 THE-PRINT
	PRINTR "'s depths."
?L22:	PRINTI "Your amateur conjuring doesn't seem to have damaged "
	CALL1 THE-PRINT
	PRINTR " very much."
?L21:	EQUAL? PRSA,V?LOOK-INSIDE,V?SEARCH \?L25
	FSET? EMERALD,NODESC \?L26
	CALL1 CTHE-PRINT
	PRINTI " is filled to the brim with dark, "
	PRINTD CWATER
	PRINT PERIOD
	RTRUE
...
?L41:	CALL1 CTHE-PRINT
	PRINTI " fills the "
	PRINTD COTTAGE
	PRINTR " with the odor of burned grease."
...
The last few drops of milk dribble into the "
	...
	PRINTI " begins to bubble and fume more furiously than ever. Steam fills the "
	PRINTD COTTAGE
	PRINTI " in a thick, oily cloud; and an ominous rumbling sound begins to rise from the "
	PRINTD CAULDRON
	PRINTI "'s depths."
	CRLF
?L1:	CALL1 UPDATE-SCORE
	...
	.FUNCT STEAM-F
	EQUAL? PRSA,V?SMELL,V?INHALE \?L1
	CALL2 WET-AND-OILY,STR?212
	RTRUE
?L1:	EQUAL? PRSA,V?EXAMINE,V?LOOK-INSIDE,V?SEARCH /?L4
	EQUAL? PRSA,V?BLOW-INTO \?L3
?L4:	CALL1 CTHE-PRINT
	PRINTI " twist in unspeakable shapes as they rise out of the "
	PRINTD CAULDRON
	PRINT PERIOD
	RTRUE
?L3:	EQUAL? PRSA,V?TOUCH,V?REACH-IN \?L5
	EQUAL? PRSI,0,HANDS \?L5
	CALL2 WET-AND-OILY,STR?213
	RTRUE
?L5:	INTBL? PRSA,TOUCHVERBS,NTOUCHES >STACK \FALSE
	CALL1 IMPOSSIBLE
	RTRUE
...
?L1:	EQUAL? PRSA,V?DRINK,V?TASTE \?L3
	PRINTI "You scald your tongue on the "
	PRINTD PRSO
	PRINTR ". Ouch!"
?L3:	EQUAL? PRSA,V?EAT,V?BITE \?L4
	CALL1 IMPOSSIBLE
...
?L6:	INTBL? PRSA,TOUCHVERBS,NTOUCHES >STACK \FALSE
	...
	.FUNCT SMELL-CWATER
	PRINTR "The hot, greasy odor makes your head spin."
	...
	CALL2 VANISH,HONEY
	CRLF
	PRINTI "At least you got that honey off your fingers"
	RTRUE
...
?L1:	EQUAL? PRSA,V?EXAMINE,V?LOOK-INSIDE,V?SEARCH \?L7
	CALL1 CTHE-PRINT
	PRINTR " is quite large, and of ancient design."
...
?L8:	EQUAL? PRSA,V?LOOK-INSIDE,V?LOOK-ON,V?SEARCH \?L9
	...
	PRINTI "a dark "
	PRINTD CHARON
	PRINTI " standing at the vessel's stern"
	IN? SHADES,DORY \?L10
	PRINT PTHE
	PRINTI "deck is nearly filled with silent "
	PRINTD SHADES
?L10:	PRINT PERIOD
	RTRUE
?L9:	CALL1 ENTERING? >STACK
...
?L17:	ZERO? IN-DORY? \?L18
	...
	RTRUE
?L18:	CALL1 EXIT-DORY
	PRINTR "You clamber out of the dory."
...
?L3:	EQUAL? HERE,ON-BEACH \?L4
	CALL2 CTHE-PRINT,CHARON
	PRINTR " shakes his head (a bit sadly, perhaps), and pushes you away from the dory."
?L4:	SET 'IN-DORY?,1
	SET 'OLD-HERE,0
	CALL2 CTHE-PRINT,DORY
	PRINTI " tips alarmingly as you climb aboard"
	EQUAL? STICKS,4,5 \?L6
	PRINTI "; one of the "
	PRINTD SHADES
	PRINTI " is nearly thrown out"
?L6:	PRINTI ".
...
?L11:	SET 'IN-DORY?,0
	...
	PRINTR " recognizes your vacation shorts and kicks you off his dory again."
?L12:	FSET CHARON,NOALL
	PRINTI " stares at your "
	PRINTD LONDON
	PRINTR " vacation shorts with barely concealed outrage. He makes a broad gesture with his oar, inviting you to debark at your earliest convenience; a well-placed kick sends you on your way."
?L9:	SET 'PATIENCE,3
	CALL QUEUE,I-CHARON,-1
	PRINTI " glances at the "
	PRINTD SHROUD
	PRINTR " you're wearing with silent approval, and stretches out his skeletal hand expectantly."
	...
	MOVE PRSO,HERE
	CALL1 CTHE-PRINT
	PRINTI " passes right through one of the "
	PRINTD PRSI
...
?L8:	CALL1 THE-PRINT
	...
	PRINTD PRSI
	PRINTI ". It gives you a look of pity, but "
	EQUAL? PRSA,V?SHOW \?L9
	PRINTR "remains silent."
?L9:	PRINTR "refuses to accept it."
...
?L16:	PRINTR " are stooped and emaciated, their sunken eyes dark with inscrutable emotions."
...
?L24:	PRINTR " encounters nothing but vapor."
?L17:	EQUAL? PRSA,V?WAVE-AT,V?BOW \?L25
	PRINT ONE-SHADE
	PRINTR "sadly mimics you."
?L25:	EQUAL? PRSA,V?KISS \?L26
	PRINT ONE-SHADE
	PRINTR "looks at you wistfully."
?L26:	INTBL? PRSA,TALKVERBS,NTVERBS >STACK \?L27
	PRINT ONE-SHADE
	PRINTI "turns at the "
	PRINTD SOUND
	PRINTI " of your voice. It gives you a reproachful look and lifts a skeletal finger to its lips."
	CRLF
	RETURN 2
...
?L14:	CALL1 NOT-CLEAN? >STACK
	...
	EQUAL? PRSA,V?PUT,V?THROW \FALSE
	CALL1 CTHE-PRINT
	PRINTR " would probably fall right out."
?L1:	EQUAL? PRSA,V?EXAMINE,V?LOOK-INSIDE,V?SEARCH \?L6
	FSET? PRSO,OPENED \?L7
	CALL1 LOOK-IN-MBOX
	RTRUE
...
?L3:	PRINTI "on"
?L5:	PRINT PTHE
	PRINTR "letters ""P"" and ""A"" are scrawled underneath."
...
The "
	PRINTD SPEAKER
	PRINTI " emits a burst of static, then "
...
?L4:	EQUAL? PRSI,0,HANDS \?L3
	CALL1 CTHE-PRINT
	PRINTR " has no ON or OFF position. All you can do is push it."
...
?L6:	PRINTI "These military "
	PRINTD TSWITCH
	PRINTR "es are built to resist such abuse."
...
?L1:	ZERO? NOW-PRSI? \FALSE
	...
	PRINTD PRSO
	PRINTR "; a bit old-fashioned, perhaps."
...
?L1:	EQUAL? PRSA,V?EXAMINE \?L4
	ZERO? IN \?L6
	CALL1 CTHE-PRINT
	PRINTR " stands in silhouette against the red morning."
?L6:	CALL1 V-LOOK
	RTRUE
...
?L5:	CALL1 VANISH
	...
	EQUAL? PRSO,PARASOL \?L8
	FSET? PRSO,OPENED \?L8
?L10:	PRINTI " floats away across the "
	PRINTD PRSI
	PRINTI "; it's soon"
	PRINT OUTASITE
	RTRUE
?L8:	PRINTR " sinks beneath the water."
?L1:	EQUAL? PRSA,V?EXAMINE,V?WATCH \?L13
	PRINTR "The tide is slowly rising."
?L13:	EQUAL? PRSA,V?LOOK-INSIDE,V?LOOK-ON,V?SEARCH /?L15
	EQUAL? PRSA,V?LOOK-BEHIND \?L14
?L15:	PRINTI "Little can be seen in the fiery reflections on the "
	PRINTD PRSO
	PRINT PERIOD
	RTRUE
?L14:	CALL1 ENTERING? >STACK
...
?L3:	EQUAL? PRSA,V?THROW,V?THROW-OVER /FALSE
	...
	EQUAL? PRSA,V?SEARCH,V?WATCH \?L1
?L3:	CALL1 CTHE-PRINT
	PRINTI " is just a barren crescent of sand, gradually shrinking away in the rising tide.

A lone "
	PRINTD CTREE
	PRINTI " stands near one end of the "
	PRINTD PRSO
	IN? COCO,PRSO \?L4
	PRINTI ". There's a "
	PRINTD COCO
	PRINTI " lying under the tree"
?L4:	PRINT PERIOD
	RTRUE
?L1:	CALL1 ENTERING? >STACK
	ZERO? STACK \?L9
...
?L1:	EQUAL? PRSA,V?EXAMINE,V?LOOK-ON,V?LOOK-INSIDE /?L7
	EQUAL? PRSA,V?SEARCH \?L6
?L7:	PRINTI "The tree is heavy with "
	PRINTD NUTS
	PRINT PERIOD
	RTRUE
...
?L1:	EQUAL? PRSA,V?EXAMINE,V?LOOK-INSIDE,V?SEARCH \?L6
	CALL1 CTHE-PRINT
	PRINTR " in the tree look plump and juicy."
?L6:	INTBL? PRSA,SEEVERBS,NSVERBS >STACK /FALSE
...
?L9:	FSET? PRSO,CHILLY \?L11
	PRINTI " floating in the water"
?L11:	PRINTR " looks especially plump and juicy."
...
?L17:	EQUAL? PRSA,V?HIT \?L21
	CALL1 DULL-THUD
	RTRUE
?L21:	CALL NOT-LIKELY,PRSI,STR?216
	RTRUE
?L13:	EQUAL? PRSA,V?SHAKE \FALSE
	PRINTR "You hear liquid slooshing around inside."

	.FUNCT SAY-MILK
	SET 'P-IT-OBJECT,MILK
	PRINTI "Pale "
	PRINTD MILK
	PRINTR " dribbles out of a crack in the shell."
...
?L13:	CALL2 CTHE-PRINT,COCO
	PRINTI " has a deep crack where you hit it"
	ZERO? DRIBBLE /?L14
	PRINTI ". Pale "
	PRINTD MILK
...
?L27:	EQUAL? PRSI,AXE,LUMP,SPADE \?L29
	...
	ZERO? DRIBBLE /?L30
	CALL1 KILL-MILK
	PRINTI ", with milk splattering everywhere"
?L30:	PRINT PERIOD
	RTRUE
?L29:	EQUAL? PRSA,V?HIT \?L33
	CALL1 DULL-THUD
	RTRUE
?L33:	CALL NOT-LIKELY,PRSI,STR?216
	RTRUE
?L25:	EQUAL? PRSA,V?CLOSE,V?REPAIR,V?REPLACE \FALSE
	...
	.FUNCT BEST-KARATE
	PRINTI "Your best karate technique has no effect on the "
	PRINTD PRSO
	PRINT PERIOD
	RTRUE
...
Nothing "
	...
	PRINTD MILK
	PRINTR " would make that difficult."
...
?L28:	PRINTR " and shakes its head vigorously."
?L26:	PRINTR ", nods eagerly and chatters."
...
?L32:	EQUAL? PRSA,V?WAVE-AT,V?POINT-AT \?L33
	CALL2 CTHE-PRINT,FLIPPER
	PRINTR " responds with a happy squeal."
...
?L41:	CALL1 FTOUCH? >STACK
	...
	.FUNCT FTOUCH?
	INTBL? PRSA,TOUCHVERBS,NTOUCHES >STACK \FALSE
	PRINTR "It's a little too far offshore."
...
?L6:	CALL2 CTHE-PRINT,FLIPPER
	...
	FSET? OBJ,CHILLY /?L11
	PRINTD OBJ
	PRINTR " on the islet and tries to nudge it with its snout. But the tide hasn't risen high enough yet."
?L11:	FCLEAR OBJ,CHILLY
	...
	PRINTI "floating "
	PRINTD OBJ
	PRINTI ", snatches it out of the "
	PRINTD LAGOON
	PRINTR " and tosses it into the sand at your feet."
?L9:	PRINTI " looks at "
	CALL2 THE-PRINT,OBJ
	PRINTR " and chatters mischievously."
...
?L3:	CALL1 VANISH
	...
	PRINTD PRSO
	PRINTI " and gives you a reproachful look"
	PRINT PCR
	CALL1 CTHE-PRINT
	PRINTI " splashes into the "
	PRINTD LAGOON
	EQUAL? PRSO,LEM,SKINK \?L4
	PRINTI ", struggles for a moment"
?L4:	PRINTI " and sinks"
	PRINT OUTASITE
	RTRUE
?L1:	EQUAL? PRSO,PARASOL \?L7
	FSET? PRSO,OPENED \?L7
	CALL1 VANISH
	PRINTI " tries to catch the open "
	PRINTD PRSO
	PRINTI " in its mouth, but fails.
...
?L7:	PRINTI " catches the flying "
	PRINTD PRSO
	PRINTR " in its mouth and skillfully tosses it back to you."
	...
	RANDOM 100 >STACK
	LESS? 50,STACK /?L5
	PRINTR " are more interested in snapping at you."
?L5:	PRINTI " peer suspiciously at "
	CALL1 THE-PRINT
	PRINTR ", but show no interest."
?L3:	EQUAL? PRSA,V?THROW,V?THROW-OVER,V?PUT-ON \FALSE
	MOVE PRSO,HERE
	CALL1 CTHEI-PRINT
	PRINTR " skillfully dodge out of the way."
...
?L10:	INTBL? PRSA,TALKVERBS,NTVERBS >STACK \?L11
	CALL1 CTHE-PRINT
	PRINTI " respond with a chorus of vicious snaps."
	CRLF
	RETURN 2
...
?L4:	PRINTI "You discover nothing "
	CALL2 PICK-NEXT,YAWNS >STACK
	PRINT STACK
	PRINTI " among the "
	PRINTD PRSO
...
?L6:	PRINTI "You hear a faint purring "
	PRINTD SOUND
	PRINT PERIOD
	RTRUE
...
?L8:	PRINTI "A chorus of anxious mewing"
	PRINT CHANGES
	RTRUE
?L7:	CALL1 ENTERING? >STACK
	ZERO? STACK \?L10
...
?L8:	CALL1 ENTERING? >STACK
	ZERO? STACK /?L14
	ZERO? S /?L15
	PRINTR "Patience. You'll be there soon."
...
?L19:	ZERO? S /?L20
	PRINTR "You're not in the city... yet."
?L20:	CALL1 V-WALK-AROUND
	RTRUE
...
?L24:	CALL1 IMPOSSIBLE
	...
	PRINTI "A child's "
	PRINTD SPILE
	PRINTI " covers the ground at your feet"
	JUMP ?L5
?L3:	PRINTI "You're standing in a child's "
	PRINTD SPILE
...
?L9:	PRINTI "Poking around in the "
	PRINTD PRSO
	PRINTI " reveals nothing "
	CALL2 PICK-NEXT,YAWNS >STACK
	PRINT STACK
...
?L12:	ZERO? IN-SAND? \?L13
	SET 'OLD-HERE,0
	SET 'IN-SAND?,1
	PRINTI "You climb back into the "
	PRINTD PRSO
	PRINT PERIOD
	RTRUE
?L13:	CALL1 ALREADY-IN
...
?L22:	PRINTI "This is hardly the time for frolicking in the "
	PRINTD PRSO
	PRINT PERIOD
	RTRUE
...
?L3:	EQUAL? PRSA,V?EXAMINE \?L5
	PRINTI "All you can see is a mound of dirt, with a dark "
	PRINTD SHELHOLE
...
?L19:	CALL2 DO-WALK,P?WEST
	...
	CALL1 WATCHING-SKY
	RTRUE
?L3:	PRINTR " are intent upon their work."
...
?L6:	EQUAL? PRSA,V?LISTEN \?L7
	EQUAL? MINUTES,1 /?L7
	CALL1 CTHE-PRINT
	PRINTR " mutter among themselves as they work."
...
?L1:	EQUAL? P-THEM-OBJECT,KIDS,TEACHERS \FALSE
	...
	.FUNCT WATCHING-SKY
	PRINTR " are watching the sky apprehensively."
	...
	CALL1 WATCHING-SKY
	JUMP ?L5
?L3:	PRINTI " tumble over one another as they leap to catch the elusive "
	PRINTD DFLIES
	PRINT PERIOD
...
?L11:	EQUAL? PRSA,V?LISTEN \?L12
	EQUAL? MINUTES,1 /?L12
	CALL1 CTHE-PRINT
	PRINTR " shout with delight as they play."
...
?L1:	EQUAL? PRSA,V?WAVE-AT,V?POINT-AT \?L6
	CALL1 CTHE-PRINT
	PRINTR " didn't notice your gesture."
?L6:	INTBL? PRSA,TALKVERBS,NTVERBS >STACK \?L7
	CALL1 CTHE-PRINT
	PRINTI " don't respond. They're a little too far away to hear you."
	CRLF
	RETURN 2
...
?L10:	INTBL? PRSA,TOUCHVERBS,NTOUCHES >STACK \FALSE
	...
	EQUAL? PRSA,V?EXAMINE,V?WATCH \?L3
	CALL1 CTHE-PRINT
	PRINTI " dart mischievously to and fro"
...
?L7:	EQUAL? PRSA,V?WALK-TO,V?FOLLOW \FALSE
	...
	PRINTI "The concrete "
	PRINTD SCHOOL
	PRINTR " appears to be a schoolhouse, somewhat the worse for neglect."
...
?L10:	EQUAL? PRSA,V?LOOK-OUTSIDE \FALSE
	...
	EQUAL? PRSA,V?EXAMINE \?L1
	CALL1 CTHE-PRINT
	PRINTR " are illustrated with clumsy drawings and Japanese writing."
?L1:	EQUAL? PRSA,V?READ,V?LOOK-ON \?L3
	PRINTI "The Japanese writing on the "
	PRINTD DECOR
	PRINTR " means nothing to you."
?L3:	INTBL? PRSA,TOUCHVERBS,NTOUCHES >STACK \FALSE
	CALL1 CANT-FROM-HERE
	RTRUE
	...
	PRINTI "A "
	PRINTD CCLOCK
	PRINTI " is visible in a classroom beyond the "
	PRINTD SCHOOL-WINDOWS
	PRINT PERIOD
	RTRUE
...
?L1:	EQUAL? PRSA,V?EXAMINE,V?WATCH \?L6
	CALL1 CTHE-PRINT
	PRINTI " are like little red pendulums as they arc "
	CALL1 BACK-AND-FORTH
	CRLF
	RTRUE
...
?L8:	PRINTR "The seats swing a little faster for a while."
?L7:	EQUAL? PRSA,V?ENTER,V?SIT,V?RIDE /?L10
	EQUAL? PRSA,V?CLIMB-ON,V?CLIMB-UP \?L9
?L10:	PRINTI "These "
	PRINTD PRSO
	PRINTR " are designed for bottoms far slimmer than yours."
?L9:	EQUAL? PRSA,V?STAND-ON,V?LIE-DOWN \FALSE
	...
	PRINTI "slowly back and forth in the humid breeze."
	RTRUE
...
?L9:	FSET? HERE,INDOORS \?L10
	CALL1 CANT-FROM-HERE
	RTRUE
?L10:	PRINTI "You can just make out two "
	PRINTD PRSO
	PRINTR " high overhead. No, there's another! They're flying southwest."
...
?L11:	PRINT CANT
	PRINTI "see any "
	PRINTD PEE
	PRINTR " here. But you sure can smell it."
?L10:	CALL1 CRUDITY
	RTRUE
...
?L6:	EQUAL? PRSA,V?EXAMINE \?L7
	PRINTI "It looks like a sixteen-foot version of the "
	PRINTD CRANE
...
?L10:	SET 'IN-SAND?,0
	...
	MOVE PRSO,ON-BIRD
	FSET PRSO,NODESC
	PRINTI "Gulping with fear, you climb into the crackling folds of the "
	PRINTD PRSO
	PRINTI "'s back.
...
With a powerful beat of its wings, the strange creature lifts away from the ground. Blowing sand obscures the view, but you can hear "
	PRINTD VOICES
	PRINTI " crying out in wonder. When the air clears, the "
	PRINTD PGROUND
	PRINTI " is far below"
	PRINT PCR
	CALL2 GOTO,ON-BIRD
...
?L8:	INTBL? PRSA,TALKVERBS,NTVERBS >STACK \?L13
	CALL1 CTHE-PRINT
	PRINTI " doesn't respond verbally. But you feel a wave of urgent emotion."
	CRLF
	RETURN 2
?L13:	CALL1 EXITING? >STACK
	ZERO? STACK \?L17
...
?L16:	INTBL? PRSA,HURTVERBS,NHVERBS >STACK \FALSE
	...
	.FUNCT REPROACH
	PRINTI "A wave of reproachful emotion"
	PRINT CHANGES
	RTRUE
	...
	EQUAL? PRSA,V?EXAMINE,V?WATCH \?L1
	CALL1 CTHE-PRINT
	PRINTI " is a delicate crescent, hovering just above the "
	PRINTD HORIZON
	PRINT PERIOD
	RTRUE
?L1:	CALL1 ENTERING? >STACK
...
?L1:	EQUAL? PRSA,V?EXAMINE,V?LOOK-ON \?L12
	CALL1 CTHE-PRINT
	PRINTI " is a central junction for the forest of "
	PRINTD GCABLES
...
?L4:	FSET? X5,OPENED \?L6
	PRINTI "A few moments of fumbling with the "
	PRINTD APANEL
	PRINTI " persuades you to leave the "
	PRINTD X5
	PRINTR " open."
?L6:	CALL2 ITS-ALREADY,STR?57
	RTRUE
...
?L10:	EQUAL? HERE,IN-SHACK \FALSE
	...
	CALL1 SEE-IN-X5? >STACK
	ZERO? STACK /?L14
	PRINTI "neatly packed with colored wires. Prominent among them are a "
	PRINTD RWIRE
	PRINTI ", a "
	PRINTD BWIRE
	PRINTI ", a "
...
?L19:	EQUAL? PRSI,0,HANDS \?L21
	...
	PRINTD APANEL
	PRINTR " with your fingers. But the screws hold it fast."
?L21:	EQUAL? PRSI,SDRIVER \?L22
	...
	ZERO? STACK /?L23
	CALL1 GET-WIRES
?L23:	PRINTI "You loosen the screws on the "
	PRINTD APANEL
	PRINTI ". It falls off the "
	PRINTD X5
	PRINTI " and clatters to the "
	PRINTD FLOOR
	PRINT PERIOD
	CALL2 UPDATE-SCORE,3
	RTRUE
?L22:	EQUAL? PRSI,SCOIN \?L26
	CALL1 CTHEI-PRINT
	PRINTI " won't fit the screws on the "
	PRINTD APANEL
	PRINT PERIOD
	RTRUE
?L26:	CALL NOT-LIKELY,PRSI,STR?223
	RTRUE
...
?L13:	INTBL? PRSA,MOVEVERBS,NMVERBS >STACK \FALSE
	...
	ZERO? NOW-PRSI? \FALSE
	EQUAL? PRSA,V?EXAMINE \?L3
	PRINTI "It's an ordinary 60-watt bulb, with a chain to turn it on and off"
	FSET? PRSO,LIGHTED \?L4
	PRINTI ". Its sullen glow fills the "
	PRINTD DSHADOW
	PRINTI "s cast by the harsh light outside"
?L4:	PRINT PERIOD
	RTRUE
?L3:	EQUAL? PRSA,V?LAMP-ON,V?LIGHT-WITH \?L7
	EQUAL? PRSI,0,HANDS \?L7
	FSET? PRSO,LIGHTED \?L8
	CALL2 ITS-ALREADY,STR?224
	RTRUE
...
?L3:	PRINTI "[You must refer to the wires by their color.]"
	CRLF
	RETURN NOT-HERE-OBJECT
?L1:	GET TABLE,0 >LEN
	ZERO? LEN /FALSE
...
?L13:	CALL UPDATE-SCORE,5,0
	CRLF
	SET 'WIN?,1
?L12:	PRINTI "You slide the blade of the "
	PRINTD PRSI
	PRINTI " under the "
	PRINTD PRSO
	PRINTI " and pull back on it as hard as you can. The thick insulation cracks under the strain, stretches, frays and splits...

"
	CALL2 ITALICIZE,STR?226
	PRINTI " A shower of sparks erupts from the "
	PRINTD X5
	PRINTI ". You lose your balance and fall backwards to the "
	PRINTD FLOOR
	PRINT PERIOD
	ZERO? WIN? /?L18
	CALL1 ENDGAME
...
?L8:	EQUAL? PRSI,AXE \?L24
	CALL1 AXE-TOO-BIG
	RTRUE
?L24:	CALL NOT-LIKELY,PRSI,STR?227
	RTRUE

	.FUNCT PULL-ON-WIRE
	PRINTI "You tug on the "
	PRINTD PRSO
	PRINTR ", bending it this way and that. But it stubbornly refuses to break."

	.FUNCT AXE-TOO-BIG
	CALL2 CTHE-PRINT,HOPENING
	PRINTI " in the "
	PRINTD X5
	PRINTI " is hardly big enough to get "
	PRINTD HANDS
	PRINTR " through, much less the axe."

	.FUNCT WIRES-F
	ZERO? NOW-PRSI? \FALSE
	EQUAL? PRSA,V?EXAMINE \?L3
	CALL1 CTHE-PRINT
	PRINTI " is tightly packed inside the "
	PRINTD X5
	PRINTI ". Four of them are easily distinguishable. There's a "
	PRINTD RWIRE
	PRINTI ", a "
	PRINTD BWIRE
	PRINTI ", a "
...
?L9:	EQUAL? PRSI,KNIFE \?L10
	CALL1 CTHEI-PRINT
	PRINTR " couldn't cut more than one wire at a time."
?L10:	CALL NOT-LIKELY,PRSO,STR?228
	RTRUE

	.FUNCT PULL-WIRES
	CALL1 CTHE-PRINT
	PRINTR " can be tugged only a few inches."
...
?L5:	CALL2 VOICE-MUTTERS,STR?229
...
?L10:	CALL2 VOICE-MUTTERS,STR?229
	PRINTI "Your "
	PRINTD PRSI
	PRINTI " cuts deep into "
	CALL1 SPARK
	RTRUE
?L9:	CALL NOT-LIKELY,PRSI,STR?230
	RTRUE

	.FUNCT SPARK
	PRINTI "one of the "
	PRINTD PRSO
	PRINTI ", creating an electric spark that finds its way "
	CALL1 RESULTING-BLAST
	RTRUE
	...
	EQUAL? PRSA,V?EXAMINE \?L1
	CALL1 CTHE-PRINT
	PRINTR " lies in a hopeless tangle at your feet."
?L1:	INTBL? PRSA,MOVEVERBS,NMVERBS >STACK \FALSE
	CALL2 HOPELESS-TANGLE,GROPES
	RTRUE

	.FUNCT HOPELESS-TANGLE,OBJ
	PRINTI "You try to sort out the "
	PRINTD OBJ
	PRINTR ", but it's a hopeless tangle."

	.FUNCT HARDWARE-F
	EQUAL? PRSA,V?EXAMINE \?L1
	CALL1 CTHE-PRINT
	PRINTI " is all tangled up in the "
	PRINTD GROPES
	PRINT PERIOD
	RTRUE
?L1:	INTBL? PRSA,MOVEVERBS,NMVERBS >STACK \FALSE
...
?L19:	EQUAL? HERE,TOWER-PLAT \?L21
	CALL2 DO-WALK,P?IN
	RTRUE
?L21:	CALL YOUD-HAVE-TO,STR?231,TOWER
	RTRUE
...
?L23:	CALL2 DO-WALK,P?EAST
	...
	ZERO? STACK /FALSE
	PRINTR "There's only one door here."
...
?L6:	CALL1 EXITING? >STACK
	...
	PRINTI "The words PLEASE WIPE FEET are scrawled across the top of the"
	CALL2 OPEN-CLOSED,PRSO
	PRINT PERIOD
	RTRUE
...
?L1:	EQUAL? PRSA,V?EXAMINE \?L4
	...
	RTRUE
?L6:	CALL1 CTHE-PRINT
	PRINTI " is squat and ugly, with adobe walls and a cheap tin roof"
...
?L12:	EQUAL? HERE,NEYARD \?L13
	PRINTI ". A"
	CALL OPEN-CLOSED,BROOM-DOOR,1
	PRINTI " leads west, and a deck stands"
	PRINT TOS
	PRINT PERIOD
	RTRUE
?L13:	EQUAL? HERE,ON-PORCH \?L14
	PRINTR ". Two doors lead inside."
?L14:	EQUAL? HERE,NERANCH,ERANCH,SERANCH \?L15
	PRINT PA
	PRINTR "deck is attached to the front."
?L15:	PRINT PERIOD
	RTRUE
...
?L30:	CALL1 V-WALK-AROUND
	...
	PRINTI "The gentle ramp leads "
	EQUAL? HERE,ERANCH \?L3
	PRINTI "up to the "
	PRINTD PORCH
	JUMP ?L5
?L3:	PRINTI "down to the front yard"
?L5:	PRINT PERIOD
	RTRUE
...
?L4:	CALL2 NOUN-USED?,W?BOTTOM >STACK
	...
	ZERO? IN \?L7
	PRINT CANT
	PRINTI "see the bottom from here."
	CRLF
	RETURN 2
?L7:	ZERO? NOW-PRSI? /?L13
	...
	MOVE PRSO,HERE
	CALL1 CTHE-PRINT
	PRINTR " slowly sinks to the bottom."
?L17:	EQUAL? PRSO,MEEP,LEM \?L19
	PRINTI "Seeing your intent, "
	CALL1 THE-PRINT
	PRINTR " squirms even harder."
...
?L31:	PRINTR " sinks into the murky water."
?L29:	PRINTI "You "
	PRINTB P-PRSA-WORD
	PRINTI " "
	CALL1 THE-PRINT
	PRINTI " over the side of the "
	PRINTD RESERVOIR
	PRINTR ". Splash!"
...
?L39:	CALL1 CTHE-PRINT
	PRINTR " resembles a big aboveground swimming pool, sixty feet long and thirty across, with tall concrete sides."
...
?L44:	CALL1 CTHE-PRINT
	...
	PRINTI " you're in"
?L46:	PRINTR " is filled to the brim with black, murky water."
...
?L81:	EQUAL? HERE,ON-CIST,IN-CIST \?L83
	PRINTR "You feel nothing but water."
...
?L86:	ZERO? WATER /FALSE
	...
	PRINTR "It doesn't look very clean."
...
?L1:	EQUAL? HERE,IN-CIST,ON-CIST /?L3
	PRINTI "You stand on tiptoe and peer into the "
	PRINTD RESERVOIR
	PRINTI ". But l"
	JUMP ?L4
?L3:	PRINTI "L"
?L4:	PRINTR "ittle can be seen beneath the murky water."
...
?L1:	EQUAL? PRSA,V?EXAMINE,V?LOOK-ON \?L4
	ZERO? ON \?L6
	CALL1 CTHE-PRINT
	PRINTI " is a squat, unsightly affair of beams and planks. A rickety "
	PRINTD MLADDER
	PRINTI " climbs the side to a "
...
?L9:	CALL1 CTHE-PRINT
	PRINTI " overlooks the edge of the adjacent "
	PRINTD RESERVOIR
	PRINTR ". Its planks are gray and rotten with age."
...
?L21:	EQUAL? PRSA,V?STAND-UNDER \?L25
	...
	PRINTR "That's what you're doing."
...
?L31:	CALL1 CANT-FROM-HERE
	...
	CALL1 CTHE-PRINT
	PRINTI " is a gray finger on the "
	PRINTD HORIZON
	PRINT PERIOD
	RTRUE
?L1:	EQUAL? PRSA,V?WALK-TO,V?FOLLOW \?L3
...
?L1:	EQUAL? HERE,TOWER-PLAT \?L3
	...
	PRINTD TPLAT
	PRINTR " makes it hard to see what's directly below."
?L3:	CALL2 CTHE-PRINT,GROUND
	PRINTR " is about fifty feet below."
...
?L10:	EQUAL? PRSA,V?CLIMB-UP \FALSE
	...
	ZERO? NOW-PRSI? \FALSE
	PRINTR "Don't worry. You won't fall."

	.FUNCT TROPES-F
	EQUAL? PRSA,V?EXAMINE,V?WATCH \?L1
	CALL1 CTHE-PRINT
	PRINTR " sway back and forth against the dark sky."
?L1:	INTBL? PRSA,TOUCHVERBS,NTOUCHES >STACK \FALSE
	CALL2 CTHE-PRINT,TROPES
	PRINTR " are out of your reach."

	.FUNCT NWROAD-F
	CALL HANDLE-DESERT-ROAD?,P?NW,STR?95,STR?96 >STACK
	ZERO? STACK /FALSE
	RTRUE

	.FUNCT SWROAD-F
	CALL HANDLE-DESERT-ROAD?,P?SW,STR?94,STR?97 >STACK
	ZERO? STACK /FALSE
	RTRUE

	.FUNCT SROAD-F
	CALL HANDLE-DESERT-ROAD?,P?SOUTH,STR?91,STR?98 >STACK
	ZERO? STACK /FALSE
	RTRUE
...
?L9:	CALL2 DO-WALK,STACK
	...
	CALL1 EXAMINING-ROAD? >STACK
	ZERO? STACK /?L1
	PRINTI "The road bends southeast, "
	PRINT INTO-DESERT
	PRINT PERIOD
	RTRUE
?L1:	CALL1 USING-ROAD? >STACK
...
?L3:	CALL1 EXITING? >STACK
	...
	CALL1 EXAMINING-ROAD? >STACK
	ZERO? STACK /?L1
	PRINTI "The road curves northwest, "
	PRINT INTO-DESERT
	PRINT PERIOD
	RTRUE
?L1:	CALL1 USING-ROAD? >STACK
...
?L3:	CALL1 EXITING? >STACK
	...
	ZERO? STACK /?L1
	CALL1 CTHE-PRINT
	PRINTI " leads southeast and northwest, "
	PRINT INTO-DESERT
	PRINT PERIOD
	RTRUE
?L1:	CALL1 USING-ROAD? >STACK
...
?L9:	CALL1 EXITING? >STACK
	...
	PRINT INTO-DESERT
	JUMP ?L8
?L5:	PRINTI "bends east along the north side of the "
	PRINTD SWALL
	JUMP ?L8
?L3:	PRINTI " bends "
	...
	JUMP ?L11
?L9:	PRINTI "nor"
?L11:	PRINTI "th, along the outside of the "
	PRINTD SWALL
?L8:	PRINT PERIOD
	RTRUE
?L1:	CALL1 USING-ROAD? >STACK
...
?L3:	CALL1 CTHE-PRINT
	PRINTI " are as rugged and formidable as the "
	PRINTD DMOUNTS
	PRINTR " beyond them."
?L1:	CALL1 ENTERING? >STACK
	ZERO? STACK \?L6
...
?L10:	CALL1 CANT-FROM-HERE
	...
	PRINTI " are much too steep and rugged to climb."
	CRLF
	RFALSE
...
?L5:	CALL1 CTHE-PRINT
	...
	MOVE PRSO,PRSI
	PRINTR " slips between the pages."
?L8:	GETP PRSO,P?SIZE >STACK
	GRTR? STACK,1 \?L10
	PRINTR " wouldn't fit in the book."
?L10:	PRINTI " falls out of the book and "
	CALL1 LANDS-AT-YOUR-FEET
	RTRUE
?L3:	EQUAL? PRSA,V?PUT-ON \FALSE
	CALL1 PRSO-SLIDES-OFF-PRSI
...
?L1:	EQUAL? PRSA,V?EXAMINE,V?LOOK-ON \?L14
	PRINTI "It's a cheap paperback called "
	CALL2 ITALICIZE,STR?233
	CRLF
	RTRUE
?L14:	EQUAL? PRSA,V?OPEN,V?OPEN-WITH,V?UNFOLD \?L15
	...
	PRINTI "A "
	PRINTD MARKER
	PRINTR " falls out of the book as you open it."
...
?L21:	FSET? PRSO,OPENED /?L23
	...
	CRLF
?L23:	PRINTR "You flip through the book, but nothing catches your eye."
...
?L1:	ZERO? D /?L5
	...
	PRINTI "You haven't seen any here."
	CRLF
	RETURN 2
?L5:	ZERO? NOW-PRSI? /?L9
	EQUAL? PRSA,V?PUT,V?PUT-ON \FALSE
...
?L9:	EQUAL? PRSA,V?EXAMINE,V?LOOK-ON,V?READ /?L14
	EQUAL? PRSA,V?SEARCH \?L13
?L14:	ZERO? D /?L15
	PRINTI "The diagram is a meaningless network of intersecting lines. The legend ""RD="
	GET WIRE-TYPES,0 >STACK
	PRINT STACK
	PRINTI " BL="
	GET WIRE-TYPES,1 >STACK
...
?L15:	CALL NOUN-USED?,W?POETRY,W?STANZA,W?POEM >STACK
	ZERO? STACK /?L20
	PRINTI "It's a send-up of a famous Emerson poem."
	CRLF
	FSET? PRSO,SEEN /TRUE
	FSET PRSO,SEEN
	...
	RETURN 2
?L20:	CALL1 CTHE-PRINT
	PRINTI " seems to have been used as a bookmark. A stanza of poetry is typed on "
	IN? PRSO,PLAYER \?L27
	FSET PRSO,TOUCHED
	PRINTR "one side. The other side is covered with some kind of diagram."
?L27:	PRINTR "the side you can see."
?L13:	EQUAL? PRSA,V?TURN,V?SPIN \FALSE
	...
	PRINTD HANDS
	PRINTR "s."
?L31:	CALL YOUD-HAVE-TO,STR?139,PRSO
	RTRUE

	.FUNCT SAY-SCRIBBLED
	PRINTR "scribbled across the bottom."
...
?L8:	CALL1 CANT-FROM-HERE
	...
	.FUNCT WITH-BINOS
	PRINTI "Peering closely, you can see that "
	RTRUE
...
?L61:	EQUAL? PRSA,V?LOOK-THRU \FALSE
	IN? PRSI,PLAYER /?L17
	CALL YOUD-HAVE-TO,STR?139,PRSI
	RTRUE
...
?L24:	CALL1 CTHEI-PRINT
	PRINTR " won't focus that closely."
?L22:	EQUAL? BSEEN,PRSO /?L25
	SET 'BSEEN,PRSO
	PRINTI "You focus the binoculars on "
	CALL1 THE-PRINT
	PRINT PCR
?L25:	EQUAL? PRSO,SBUNK,SBENTRY \?L27
	PRINTI "The inside of the "
	PRINTD PRSO
	PRINTI " is only about twenty feet square. Every inch is crowded with technicians, tending racks filled with electrical "
	PRINTD MIKE
	PRINT PCR
	PRINTI "One technician is hunched over a stool, clutching a microphone. The tension in his grasp is reflected on every face"
	PRINT PCR
	SET 'P-IT-OBJECT,BBOX
	FSET? BBOX,SEEN /?L29
	FSET BBOX,SEEN
	MOVE BBOX,S100
	PRINTI "As your eyes take in the maze of "
	PRINTD MIKE
	PRINTI ", you notice a long wooden box, similar to the one you saw under the "
	PRINTD TOWER
	JUMP ?L31
?L29:	PRINTI "There's a long wooden box lying across the "
	PRINTD FLOOR
?L31:	CALL1 MENTION-TKEY
	...
	CRLF
	PRINT CTHEMEEP
	PRINTI "cranes its neck and peers into the "
	PRINTD SBUNK
	PRINTI ", its sharp eyes keen with interest."
	CRLF
...
?L45:	EQUAL? PRSO,SPOT,SLIGHT \?L46
	CALL1 CTHE-PRINT
	PRINTR " appears very bright."
?L46:	EQUAL? PRSO,GDESERT,DMOUNTS,FHILLS \?L47
	CALL1 WITH-BINOS
	CALL1 THE-PRINT
	CALL1 IS-ARE
	PRINTR "barren and featureless."
...
?L13:	EQUAL? PRSA,V?EXAMINE,V?LOOK-ON \?L52
	PRINTR "The binoculars are of standard Army issue, with a strap for wearing."
...
?L53:	EQUAL? PRSA,V?TAKE \?L54
	...
	CALL2 ITALICIZE,STR?234
	PRINTI " makes you draw "
	PRINTD HANDS
	PRINTI " back in alarm. You hold "
	PRINTD BREATH
	PRINTI " as the "
	PRINTD LANDING
	PRINTI " sways uncertainly for a moment, back and forth"
	CALL1 ALL-IS-STILL
	CRLF
	PRINTI "Slowly, carefully, you stretch your arm towards the "
	PRINTD PRSO
	PRINTI ".."
	PRINT PCR
	CALL1 SPILL-MILL
...
?L19:	CALL2 DEQUEUE,I-MILL
	...
	SET 'BREATH-HELD?,1
?L22:	CALL2 ITALICIZE,STR?194
	PRINTI " The "
	PRINTD LANDING
	PRINTI " tips wildly under your feet. You manage a brief, hysterical shriek..."
	CALL1 CARRIAGE-RETURNS
	PRINTI "... and your mouth fills with water"
	PRINT PCR
	CALL2 GOTO,IN-CIST
...
?L11:	FSET? PRSO,CHILLY \?L13
	...
	JUMP ?L14
?L13:	PRINTI " Cremat"
?L14:	PRINTR "ed, as a matter of fact."
...
?L11:	PRINTI "you see "
	...
	JUMP ?L6
?L4:	PRINTI "off the"
?L6:	PRINTR " box and lands at your feet."
...
?L1:	EQUAL? PRSA,V?EXAMINE,V?LOOK-ON \?L11
	PRINTI "The"
	CALL2 OPEN-CLOSED,PRSO
	PRINTI " is several feet in length"
	ZERO? L /?L12
	PRINTI ", and secured with a steel "
	PRINTD PADLOCK
...
?L23:	EQUAL? PRSI,0,HANDS \?L25
	...
	CALL YOUD-HAVE-TO,STR?71,PADLOCK
	RTRUE
?L26:	CALL1 OPEN-BOX
	RTRUE
...
?L29:	EQUAL? PRSI,AXE,SPADE \?L33
	CALL1 HURT-BOX
	RTRUE
?L33:	CALL NOT-LIKELY,PRSI,STR?235
	RTRUE
...
?L36:	EQUAL? PRSI,TKEY \?L38
	...
	CALL1 OPEN-BOX
	RTRUE
?L38:	CALL NOT-LIKELY,PRSI,STR?236
	RTRUE
...
?L41:	IN? MEEP,PRSO \?L43
	CALL YOUD-HAVE-TO,STR?172,MEEP
	RTRUE
?L43:	FCLEAR PRSO,OPENED
	FCLEAR PRSO,CONTAINER
	FSET PRSO,SURFACE
	CALL MOVE-ALL,PRSO,IN-BOX
	PRINTR "You swing the lid of the box shut."
...
?L47:	EQUAL? PRSI,LUMP,AXE,SPADE \?L50
	CALL1 HURT-BOX
	RTRUE
?L50:	CALL NOT-LIKELY,PRSI,STR?237
	RTRUE
?L45:	EQUAL? PRSA,V?LOCK \?L52
	ZERO? PRSI /?L52
	ZERO? L /?L53
	CALL2 ITS-ALREADY,STR?238
	RTRUE
?L53:	EQUAL? PRSI,TKEY \?L55
	PRINT DONT
	PRINTR "need the key to do that."
...
?L56:	EQUAL? PRSI,HANDS \?L64
	...
	PRINT PERIOD
	RTRUE
?L64:	CALL NOT-LIKELY,PRSI,STR?239
	RTRUE
...
?L67:	CALL1 PRSO-TOO-BIG
	...
	.FUNCT HURT-BOX
	PRINTI "You'd probably damage the box's contents"
	PRINT IF-YOU-DID
	RTRUE

	.FUNCT BOX-NOT-LOCKED
	PRINTR "The box isn't locked."
...
?L8:	SET 'OBJ,NXT
	JUMP ?L1
?L3:	ZERO? CNT \?L11
	PRINTI "You swing open the lid of the box"
	JUMP ?L13
?L11:	EQUAL? CNT,1 \?L14
	CALL2 CTHE-PRINT,1ST
	JUMP ?L16
?L14:	PRINTI "Everything"
?L16:	PRINTI " slides off the lid of the box as you swing it open"
?L13:	FSET BOX,OPENED
	FSET BOX,CONTAINER
	FCLEAR BOX,SURFACE
...
?L5:	GETP PRSO,P?SIZE >STACK
	...
	JUMP ?L9
?L7:	IN? TKEY,PRSI \?L8
	CALL YOUD-HAVE-TO,STR?172,TKEY
	RTRUE
?L8:	CALL1 CTHE-PRINT
	PRINTI " doesn't fit"
?L9:	PRINTI " into the "
...
?L1:	EQUAL? PRSA,V?EXAMINE \?L11
	...
	PRINTI "open "
?L12:	PRINTD PRSO
	PRINTR " is a formidable hunk of hardened steel."
...
?L20:	CALL1 HOW?
	RTRUE
?L19:	CALL NOT-LIKELY,PRSI,STR?240
	RTRUE
...
?L28:	FSET PRSO,LOCKED
	...
	FSET PRSO,NOALL
	CRLF
	PRINTR "The box is locked again."
...
?L34:	CALL1 BOX-LOCKED? >STACK
	ZERO? STACK /?L33
	CALL1 CTHE-PRINT
	PRINTR " is firmly locked onto the box."
...
?L1:	MOVE TKEY,PADLOCK
	PRINTI "You slip the key into the "
	PRINTD PADLOCK
	PRINTI ". It"
?L3:	PRINTI " unlocks with a smart little snap."
	CRLF
...
?L1:	EQUAL? PRSA,V?EXAMINE,V?LOOK-ON,V?LOOK-INSIDE /?L7
	EQUAL? PRSA,V?SEARCH \?L6
?L7:	CALL1 CTHE-PRINT
	PRINTI " is covered with a bewildering array of "
	PRINTD METERS
	PRINTI ", clustered around a heavy-duty "
	PRINTD BREAKER
	PRINT PERIOD
	RTRUE
...
?L3:	CALL1 CTHE-PRINT
	PRINTI " on the "
	PRINTD PANEL
	PRINTR " blink and twitch in response to invisible impulses. Their purpose is obscure."
...
?L6:	CALL FIRMLY-ATTACHED,PRSO,PANEL
	...
	PRINTD PRSO
	PRINTI " looks like something out of a Frankenstein movie. Its broad handle is "
	FSET? PRSO,OPENED \?L4
	PRINTR "open."
?L4:	PRINTR "closed."
...
?L8:	EQUAL? PRSI,0,HANDS \?L7
	...
	RTRUE
?L9:	FSET PRSO,OPENED
	PRINTI "You lift the handle of the "
	PRINTD PRSO
	PRINT PERIOD
	RTRUE
...
?L13:	EQUAL? PRSI,0,HANDS \?L12
	...
	FCLEAR PRSO,OPENED
	FSET PRSO,BORING
	PRINTI "You close the handle of the "
	PRINTD PRSO
	PRINT PERIOD
	CALL1 HEAR-BAKER? >STACK
	ZERO? STACK /TRUE
...
""The kid's keepin' an eye on it, "
	...
	LESS? MINUTES,29 \?L19
	PRINTI " before the sequencer takes over"
?L19:	PRINTI ", we're gonna have to scrub.""

""Roger, "
	PRINTD BAKER
	PRINTI ". Lotta crossed fingers up here."""
	CRLF
	CALL1 UPDATE-SCORE
	RTRUE
?L14:	CALL2 ITS-ALREADY,STR?57
	RTRUE
...
?L28:	CALL FIRMLY-ATTACHED,PRSO,PANEL
	...
	PRINT CANT
	PRINTI "see him from where you are now."
	CRLF
	RETURN 2
	...
	PRINTI "The square "
	PRINTD PRSO
	PRINTI " is built of heavy timber, covered with a thick layer of earth on the north side. "
	CALL1 SEE-SBENTRY
	RTRUE
?L1:	CALL1 HANDLE-SBUNK? >STACK
	...
	CALL1 CTHE-PRINT
	PRINTI " appears to be crowded with men and "
	PRINTD MIKE
	PRINTR ". But you can't see much detail from where you're standing."
?L1:	EQUAL? PRSA,V?LISTEN \?L3
	CALL1 HEAR-SBUNK
	RTRUE
?L3:	CALL1 ENTERING? >STACK
...
?L1:	CALL1 HANDLE-SBUNK? >STACK
	...
	.FUNCT SEE-SBENTRY
	PRINTI "Bright light spills across the "
	PRINTD GDESERT
	PRINTI " from the open south "
	PRINTD SBENTRY
	PRINT PERIOD
	RTRUE
...
?L5:	EQUAL? PRSA,V?PUT \?L6
	...
	RTRUE
?L6:	EQUAL? PRSA,V?THROW,V?THROW-OVER \FALSE
	CALL VOICE-MUTTERS,STR?241,0
	RTRUE
?L1:	EQUAL? PRSA,V?EXAMINE \?L9
	PRINTR "It's a nondescript metal structure, just large enough to hide behind."
...
?L10:	CALL1 CTHE-PRINT
	PRINTI " is in the "
	PRINTD PADLOCK
	PRINTR " dangling from the open box's lid."
...
?L8:	CALL2 CTHE-PRINT,BBOX
	PRINTI " is virtually identical to the one you saw under the "
	PRINTD TOWER
	CALL1 MENTION-TKEY
	RTRUE
...
?L5:	INTBL? PRSA,TOUCHVERBS,NTOUCHES >STACK \FALSE
	...
	EQUAL? PRSA,V?EXAMINE,V?SEARCH \?L1
	CALL1 CTHE-PRINT
	PRINTR " are closed and sealed with tape."
...
?L10:	CALL1 CTHE-PRINT
	PRINTR " are stubborn and hard to move. You soon abandon the effort."
...
?L13:	INTBL? PRSA,HURTVERBS,NHVERBS >STACK \FALSE
	...
	PRINTI "A "
	PRINTD WBENCH
	PRINTI " covered with loose sheets of "
	PRINTD BPAPER
	PRINTI " runs along the north wall. "
	...
	PRINTI " and other "
	PRINTD DEBRIS
	PRINTI " scattered across the paper."
	RTRUE
...
?L3:	EQUAL? PRSA,V?PUT-UNDER,V?PUT-BEHIND,V?STAND-UNDER \FALSE
	PRINTI "There's no room under the "
	PRINTD PRSI
	PRINT PERIOD
	RTRUE
...
?L8:	EQUAL? PRSA,V?EXAMINE,V?LOOK-ON \?L9
	CALL1 CTHE-PRINT
	PRINTI " is covered with sheets of "
	PRINTD BPAPER
...
?L8:	FSET? SDRIVER,NODESC \?L9
	...
	FCLEAR HANDS,TOOL
	PRINTI "As you lift the edge of the paper a "
	PRINTD SDRIVER
	PRINTR " rolls out from underneath and lands on your foot. Ouch!"
?L9:	PRINTI "You lift the paper again, but find nothing "
	CALL2 PICK-NEXT,YAWNS >STACK
	PRINT STACK
	PRINT PERIOD
	RTRUE
...
?L3:	CALL NOT-LIKELY,WBENCH,STR?242
	RTRUE
?L1:	INTBL? PRSA,HURTVERBS,NHVERBS >STACK \FALSE
	...
	EQUAL? PRSA,V?RAISE \FALSE
?L3:	PRINTI "You sift through the "
	PRINTD PRSO
	PRINTI " on the "
	PRINTD WBENCH
...
?L1:	EQUAL? HERE,IN-CLOSET \?L5
	...
	PRINTI "Luckily, the "
	PRINTD SNAKE
	PRINTI " is on the other side of the "
	PRINTD CLOSET-DOOR
	PRINT PERIOD
	RETURN 2
?L5:	ZERO? NOW-PRSI? /?L8
	EQUAL? PRSA,V?THROW,V?THROW-OVER \?L9
	PRINTI "You raise your arm to throw "
	CALL1 THE-PRINT
	PRINT PERIOD
	RTRUE
?L9:	EQUAL? PRSA,V?GIVE,V?SHOW,V?FEED \FALSE
	CALL2 SNAKE-RESPONSE,STR?243
	RTRUE
?L8:	EQUAL? PRSA,V?EXAMINE \?L13
	PRINTR "All you can see are those tiny black eyes, glaring."
...
?L15:	PRINTI "You draw closer to the "
	PRINTD PRSO
	PRINTI ", "
...
?L40:	EQUAL? PRSA,V?WATCH \FALSE
	...
	PRINTI "Your "
	PRINT STR
	PRINTR " elicits a brief, angry rattle."
...
?L18:	EQUAL? PRSA,V?REPAIR \FALSE
	...
	PRINTI " is "
	FSET? PRSO,OPENED \?L4
	PRINTR "pulled out to its full length."
?L4:	PRINTI "pushed down into the "
	PRINTD WTK
	PRINT PERIOD
	RTRUE
...
?L8:	FSET? PRSO,OPENED \?L9
	CALL1 CTHE-PRINT
	PRINTR " is already pulled out as far as it can go."
?L9:	FSET PRSO,OPENED
	PRINTI "You pull the "
	PRINTD PRSO
	PRINTI " out of the "
	PRINTD WTK
	PRINTR ", extending it to its full length."
...
?L13:	FSET? PRSO,OPENED \?L14
	...
	RTRUE
?L14:	CALL1 CTHE-PRINT
	PRINTR " is already pushed in as far as it can go."
...
?L3:	EQUAL? P-NUMBER,F \FALSE
	...
	.FUNCT FIDDLE
	PRINTI "You fiddle aimlessly with the "
	PRINTD PRSO
	PRINT PERIOD
	RTRUE
...
?L5:	LOC PRSO >STACK
	...
	PRINTI "[To adjust "
	CALL1 THE-PRINT
	PRINTI ", simply move it to the desired "
	PRINTD INTNUM
	PRINTI "; for example, "
...
?L9:	PRINTI "You squeeze the "
	...
	PRINTR ". Nothing happens; so you release it."
?L15:	PRINT PCR
	FSET PRSO,SEEN
	CALL1 TOUCH-WBUTTON
	RTRUE
...
?L20:	CALL FIRMLY-ATTACHED,PRSO,WTK
	RTRUE
?L18:	EQUAL? PRSA,V?REPAIR \FALSE
	CALL NOT-LIKELY,PRSI,STR?252
	RTRUE

	.FUNCT TOUCH-WBUTTON
	CALL2 ITALICIZE,STR?253
	PRINTI " A painful electric shock shoots up your arm"
	IN? WTK,PLAYER \?L1
	PRINT PTHE
	PRINTD WTK
	PRINTI " falls from your grasp and "
...
?L4:	EQUAL? PRSA,V?EXAMINE \?L12
	...
	CALL1 V-LOOK
	RTRUE
?L13:	PRINTI "The body of the jeep is caked with mud; it's obviously been used a lot lately. The door facing you is "
...
?L23:	EQUAL? PRSA,V?THROUGH,V?STAND-UNDER \?L24
	...
	CALL1 CANT-FROM-HERE
	RTRUE
?L25:	PRINTR "Better not. You might get your vacation clothes dirty."
...
?L33:	EQUAL? PRSA,V?RIDE,V?USE \?L38
	...
	CALL1 NOT-IN
	RTRUE
?L39:	CALL YOUD-HAVE-TO,STR?254,JEEP
	RTRUE
...
?L45:	EQUAL? PRSI,TKEY \?L46
	PRINTR "You test the key in the jeep's ignition. No; it's much too small."
?L46:	CALL NOT-LIKELY,PRSI,STR?255
	RTRUE
...
?L50:	EQUAL? PRSA,V?REPAIR \FALSE
	PRINTI "There's not much you could fix with just "
	CALL2 PRINTA,PRSI
	PRINT PERIOD
	RTRUE
...
?L13:	EQUAL? PRSA,V?CLIMB-OVER,V?CLIMB-ON,V?CLIMB-UP \FALSE
	PRINTI "You climb gracelessly over the door of the jeep."
	CRLF
	CRLF
	EQUAL? HERE,N75 \?L18
	PUSH IN-JEEP
...
?L3:	EQUAL? PRSA,V?EXAMINE \?L4
	...
	PRINTD PRSO
	PRINTR " seems familiar. Maybe it's the wand he's holding."
?L4:	EQUAL? PRSA,V?LOOK-BEHIND,V?LOOK-UNDER,V?LISTEN /?L7
	EQUAL? PRSA,V?SMELL /?L7
	INTBL? PRSA,TOUCHVERBS,NTOUCHES >STACK \?L6
?L7:	PRINT CANT
	PRINTI "do that to an image in a "
	PRINTD PRSO
	PRINT PERIOD
	RTRUE
...
?L16:	PRINTI "The black-and-white "
	PRINTD PRSO
	PRINTR " shows a boy staring at the camera."
?L15:	INTBL? PRSA,TALKVERBS,NTVERBS >STACK \?L17
	PRINTI "The boy just stares back at you."
	CRLF
	RETURN 2
...
?L1:	RETURN RADIO
	...
	EQUAL? PRSA,V?EXAMINE,V?LOOK-ON \?L3
	CALL1 RADIO-BOLTED
	PRINTI " This is probably just as well, because it's big and awkward, probably too heavy to carry. Among its many controls are an oversized dial and a "
	PRINTD RSWITCH
	PRINT PERIOD
	RTRUE
...
?L6:	EQUAL? PRSA,V?TURN-TO,V?TUNE-TO \FALSE
	...
	.FUNCT RADIO-BOLTED
	PRINTI "The radio is firmly bolted to the floor of the jeep."
	RTRUE
	...
	PRINTI " on the "
	PRINTD RADIO
	PRINTI " is marked POWER, and is turned "
	FSET? PRSO,OPENED \?L4
	PRINTR "off."
?L4:	PRINTR "on."
...
?L1:	FSET RSWITCH,OPENED
	...
	PRINTD PRSO
	PRINTI " is brightly illuminated by light spilling from the "
	PRINTD SLIGHT
	PRINTR "s. Anyone looking this way will probably see you if you get much closer."
?L1:	CALL1 EXITING? >STACK
	ZERO? STACK /?L3
	CALL1 NOT-IN
	RTRUE
...
?L4:	CALL1 ENTERING? >STACK
	...
	CALL2 DO-WALK,P?NW
	RTRUE
?L6:	CALL YOUD-HAVE-TO,STR?82,JEEP
	RTRUE
...
?L9:	LESS? SECONDS,45 \?L11
	...
	JUMP ?L12
?L11:	PRINTI "ten"
?L12:	PRINTI " seconds,"" crackles the "
	PRINTD WTK
	PRINT PERIOD
?L7:	CRLF
	ZERO? ST \?L14
...
?L14:	CALL1 ST-QUOTE
	HLIGHT H-ITALIC
?L16:	PRINTI "You should be proud of "
	PRINTD ME
	PRINTI "."
	HLIGHT H-NORMAL
	ZERO? ST \?L17
	...
	JUMP ?L19
?L17:	CALL1 ST-QUOTE
?L19:	PRINTI " Where is that voice coming from? "
	ZERO? ST \?L20
	PRINTI """"
	JUMP ?L22
?L20:	CALL1 ST-QUOTE
	HLIGHT H-ITALIC
?L22:	PRINTI "This gadget would've blown New Mexico right off the map if you hadn't stopped it. Imagine the embarrassment."
	HLIGHT H-NORMAL
	ZERO? ST \?L23
	PRINTI """"
	JUMP ?L25
...
?L26:	CALL1 ARTICULATES
	PRINTI "It's not as scary the second time"
	PRINT PCR
	ZERO? ST \?L33
	PRINTI """"
	JUMP ?L35
?L33:	CALL1 ST-QUOTE
	HLIGHT H-ITALIC
?L35:	PRINTI "Of course, there's the problem of causality,"
	HLIGHT H-NORMAL
	ZERO? ST \?L36
	PRINTI """"
	JUMP ?L38
?L36:	CALL1 ST-QUOTE
?L38:	PRINTI " continues the voice. "
	ZERO? ST \?L39
	PRINTI """"
	JUMP ?L41
?L39:	CALL1 ST-QUOTE
	HLIGHT H-ITALIC
?L41:	PRINTI "If Harry doesn't get his A-bomb, the future that created "
	ZERO? ST \?L42
	CALL2 ITALICIZE,STR?256
	JUMP ?L44
?L42:	HLIGHT H-NORMAL
	PRINTI "you"
	HLIGHT H-ITALIC
?L44:	PRINTI " cannot occur. And you can't sabotage the test if you're never born, can you?"
	HLIGHT H-NORMAL
	ZERO? ST \?L45
	PRINTI """"
	JUMP ?L47
...
?L47:	CRLF
	...
	LESS? SECONDS,30 \?L50
	PRINTI "Minus ten seconds. Nine, eight, seven"
	JUMP ?L53
...
?L53:	PRINTI "."""
	CRLF
	CRLF
?L48:	PRINTI "The voice chuckles amiably. "
	ZERO? ST \?L55
	PRINTI """"
	JUMP ?L57
?L55:	CALL1 ST-QUOTE
	HLIGHT H-ITALIC
?L57:	PRINTI "Not to worry, though. Nature doesn't know the word 'paradox.' Gotta bleed off that quantum steam somehow. Why, I wouldn't be surprised to see a good-sized "
	ZERO? ST \?L58
	CALL2 ITALICIZE,STR?257
	JUMP ?L60
?L58:	HLIGHT H-NORMAL
	PRINTI "bang"
	HLIGHT H-ITALIC
?L60:	PRINTI " every time they shoot off one of these gizmos. Just enough fireworks to keep the historians happy."
	HLIGHT H-NORMAL
	ZERO? ST \?L61
	PRINTI """"
	JUMP ?L63
...
?L69:	GET BWOMAN-SUBJECTS,CNT >TBL
	...
	ZERO? INTRO? /?L1
	CRLF
	PRINTI "Sharp words between the superpowers. Tanks in East Berlin. And now, reports the BBC, rumors of a satellite blackout. It's enough to spoil your continental breakfast.

But the world will have to wait. This is the last day of your $599 "
	PRINTD LONDON
	PRINTI " Getaway Package, and you're determined to soak up as much of that authentic English ambience as you can. So you've left the tour bus behind, ditched the camera and escaped to Hyde Park for a contemplative stroll through the "
	PRINTD GARDENS
	PRINT PCR
?L1:	CALL1 V-LOOK
	ZERO? TR? /TRUE
...
?L3:	CALL1 CTHE-PRINT
	...
	PRINTI " or "
	PRINTD SBENTRY
	PRINTR "s you can see from here."
...
?L9:	CALL1 NOT-IN
	...
	EQUAL? PRSA,V?EXAMINE \?L1
	CALL1 CTHE-PRINT
	PRINTI "'s powerful beam slices over your head, towards a point on the northeast "
	PRINTD HORIZON
	PRINT PERIOD
	RTRUE
?L1:	EQUAL? PRSA,V?LOOK-INSIDE,V?WATCH \?L3
	PRINTR "The glare makes your eyes hurt."
...
?L10:	PRINTI ", but it falls short and "
	CALL1 LANDS-AT-YOUR-FEET
	RTRUE
?L8:	EQUAL? PRSA,V?THROW-OVER \?L11
	CALL1 VANISH
	PRINTI ". It disappears behind the "
	PRINTD BHOUSE
	PRINT PERIOD
	RTRUE
?L11:	GETP PRSO,P?MASS >STACK
	GRTR? STACK,2 \?L12
	PRINT PCR
	CALL2 ITALICIZE,STR?260
	PRINTI " The powerful beam of the "
	PRINTD PRSI
	PRINTI " flickers and dies"
	CALL1 HEAR-BAKER? >STACK
	ZERO? STACK /?L13
	PRINTI ". ""Damn!"" curses the "
	PRINTD WTK
?L13:	PRINT PERIOD
	IN? DOG,W100 \?L16
	CRLF
	PRINTI "As your eyes adjust to the gloom, you hear a deep, menacing growl. You turn and find "
	PRINTD ME
	PRINTI " one inch away from the longest set of choppers you've ever seen."
	CRLF
	CALL1 DOG-ALERT
	RTRUE
?L16:	CALL1 HINGE-SQUEAK
	RTRUE
?L12:	CALL1 VANISH
	PRINTI ". It skitters off the rim and slides harmlessly"
	PRINT OUTASITE
	RTRUE
?L4:	INTBL? PRSA,TOUCHVERBS,NTOUCHES >STACK \FALSE
	CALL2 CTHE-PRINT,SLIGHT
	PRINTR " is out of your reach."

	.FUNCT AKC
	PRINTR " a commotion worthy of an American Kennel Club convention."

	.FUNCT HOLD-IT
	CRLF
	PRINTI """Hold it!"" The shout doesn't say anything about a gun. But you raise "
	PRINTD HANDS
	PRINTR "s over your head, just to be safe."
	...
	PRINTD SLIGHT
	PRINTR "'s glare. ""You... you some kinda spy or somethin'?"""

	.FUNCT POLICE-CONVERGE
	CRLF
	PRINTI "A faint rumble begins to drift "
	EQUAL? HERE,IN-SHACK \?L1
	PRINTI "in from outside. You crawl over to the exit, peek around the "
	PRINTD CORNER
	PRINTI " and "
	JUMP ?L3
?L1:	PRINTI "across the "
	PRINTD GDESERT
	PRINTI ". You peer between the girders to "
?L3:	PRINTI "scan the "
	PRINTD HORIZON
	PRINTI ".
...
Headlights. "
	...
	PRINTI " of them, converging on the "
	PRINTD TOWER
	PRINTI " from several "
	PRINTD INTDIR
	PRINTI "s at once, and just minutes away!

White with panic, you "
	EQUAL? HERE,IN-SHACK,TOWER-PLAT,ON-TOWER \?L4
	EQUAL? HERE,IN-SHACK \?L6
	PRINTI "leap out of the shack and "
?L6:	PRINTI "scramble down the "
	PRINTD TLADDER
	PRINTI " as fast as you can. But your "
	FSET? RBOOT,WORN \?L9
	FSET? GBOOT,WORN \?L11
	PRINTI "boots slip"
	JUMP ?L15
...
?L9:	FSET? GBOOT,WORN \?L14
	...
	PRINTI " slips"
	JUMP ?L15
?L14:	PRINTI "vacation sneakers slip"
?L15:	PRINTI " out from under you about ten rungs from the bottom; and you regain consciousness "
	JUMP ?L16
?L4:	EQUAL? HERE,AT-ZERO \?L17
	PRINTI "slam the box shut and "
?L17:	PRINTI "crawl off to hide in the "
	PRINTD GDESERT
	PRINTI ". But you bowl headfirst into a Joshua tree, and your "
	FSET? SHROUD,WORN \?L20
	PRINTD SHROUD
	PRINTI " snags"
	JUMP ?L22
?L20:	PRINTI "vacation shorts snag"
?L22:	PRINTI " on a prickly pear bush "
?L16:	PRINTI "just as seventeen jeeps screech to a halt around the "
	PRINTD TOWER
	PRINT PERIOD
	CALL1 SURROUNDED
	RTRUE
	...
	.FUNCT SURROUNDED
	CRLF
	PRINTI "Within moments you're surrounded by a dozen MPs, armed and trigger-happy. "
	CALL1 EXCUSES
	RTRUE

	.FUNCT EXCUSES
	PRINTI "They answer your polite explanations with curt accusations, punctuated by a few well-placed kicks.
...
Eventually you're dragged off to meet somebody they call the Lieutenant, who'll deal with you, you're promised, right after a very important test is concluded. But the Lieutenant never appears. Minutes later, he's obliterated by a multigigaton atomic blast, along with "
	...
	.FUNCT MUCH-OF
	PRINTI "much of the state of New Mexico."
	CALL1 JIGS-UP
	RTRUE

	.FUNCT MAP-F
	EQUAL? PRSA,V?EXAMINE,V?LOOK-ON,V?READ \?L1
	PRINTI "[This is the map included in your "
	CALL2 ITALICIZE,STR?37
	PRINTR " package.]"
?L1:	ZERO? NOW-PRSI? \FALSE
	INTBL? PRSA,MOVEVERBS,NMVERBS >STACK \FALSE
...
?L3:	CALL1 CTHE-PRINT
	PRINTI " is a boxlike affair of steel girders, about fifty feet high. The enormous "
	PRINTD JUMBO
	PRINTR " hanging inside fills much of its open interior."
?L1:	CALL1 HANDLE-JUMBO? >STACK
	...
	PRINTI "There isn't enough room between the "
	PRINTD JUMBO
	PRINTR " and the ground to do that."
...
?L6:	PRINTI "It doesn't look as if there's any way to climb onto "
	CALL1 THE-PRINT
	PRINT PERIOD
	RTRUE
?L4:	CALL1 EXITING? >STACK
...
?L7:	ZERO? NOW-PRSI? \FALSE
	...
	PRINTR "You hear a faint ring of steel."
...
?L1:	EQUAL? PRSA,V?EXAMINE,V?SEARCH,V?LOOK-ON \?L6
	PRINTI "Why would anyone hang a giant "
	PRINTD PRSO
	PRINTI " in the middle of nowhere like this? There don't seem to be any "
	PRINTD HOPENING
	PRINTI "s, "
	PRINTD WINDOWS
	PRINTR " or markings of any kind; as far as you can tell, the thing is utterly useless."
...
?L7:	CALL1 HANDLE-JUMBO? >STACK
	...
	.FUNCT JUMBO-CLOSED
	PRINTI "If there's any way into this oversized "
	PRINTD JUMBO
	PRINTR ", you sure can't find it."
...
?L7:	EQUAL? PRSA,V?PUT-BEHIND,V?THROW-OVER \FALSE
	...
	SET 'P-IT-OBJECT,NOT-HERE-OBJECT
	CALL1 CTHE-PRINT
	PRINTI " falls somewhere behind the "
	PRINTD PRSI
	PRINT PERIOD
	RTRUE
?L5:	EQUAL? PRSA,V?EXAMINE \?L11
	CALL1 CTHE-PRINT
	PRINTI " is three or four feet high. It completely surrounds the "
	PRINTD RANCH
	PRINT PERIOD
	RTRUE
...
?L29:	EQUAL? HERE,NERANCH,NEYARD \?L31
	PRINTI "You "
	JUMP ?L32
?L31:	PRINTI "Despite the presence of the "
...
?L38:	CALL1 CTHE-PRINT
	PRINTR " is too narrow for such gymnastics."
...
?L1:	EQUAL? PRSA,V?EXAMINE,V?LOOK-INSIDE,V?WATCH \?L6
	CALL1 CTHE-PRINT
	ZERO? RAID? \?L7
	PRINTR " stare back at you haughtily."
?L7:	PRINTI " are scattering in every "
	PRINTD INTDIR
	PRINT PERIOD
	RTRUE
...
?L10:	CALL1 TOUCH-T? >STACK
	ZERO? STACK /?L13
	PRINTR "The very idea!"
?L13:	EQUAL? PRSA,V?COUNT \FALSE
	PRINTI "There are almost as many "
	PRINTD PRSO
	PRINTI " as there are "
	PRINTD CHILDREN
	PRINT PERIOD
...
?L3:	PRINTR "to acknowledge your presence."

	.FUNCT CHILDREN-F
	EQUAL? PRSA,V?EXAMINE,V?LOOK-INSIDE,V?WATCH \?L1
	ZERO? RAID? \?L3
	PRINTR "It makes you smile to watch them play."
?L3:	CALL1 CTHE-PRINT
	PRINTI " are as frightened as their "
	PRINTD NANNIES
	PRINT PERIOD
	RTRUE
...
?L1:	EQUAL? PRSA,V?EXAMINE,V?LOOK-INSIDE,V?WATCH \?L6
	ZERO? RAID? \?L7
	CALL1 CTHE-PRINT
	PRINTR " look a lot like you do."
?L7:	PRINTI "The terrified "
	PRINTD PRSO
	PRINTI " are stumbling in every "
	PRINTD INTDIR
	PRINT PERIOD
	RTRUE
?L6:	INTBL? PRSA,TALKVERBS,NTVERBS >STACK \?L10
...
?L10:	CALL1 TOUCH-T? >STACK
	ZERO? STACK /?L13
	PRINTI "A tourist whacks you over the head with a Japanese camera"
	ZERO? RAID? /?L14
...
?L13:	EQUAL? PRSA,V?COUNT \FALSE
	...
	PRINTR " shy away from you. They certainly aren't very friendly."
?L1:	CALL1 TOO-BUSY-RUNNING
	RTRUE

	.FUNCT BABIES-F
	EQUAL? PRSA,V?LISTEN \?L1
	PRINTR "This is supposed to be a vacation."
?L1:	CALL1 HANDLE-BABES? >STACK
	ZERO? STACK \TRUE
...
?L6:	CALL1 TOUCH-T? >STACK
	ZERO? STACK /FALSE
	PRINTI "A nanny whacks you over the head with her "
	PRINTD PARASOL
	ZERO? RAID? /?L10
	PRINTI " as she runs past"
?L10:	PRINTR ". Ouch!"
...
?L1:	CALL1 TOO-BUSY-RUNNING
	...
	PRINTR "Everybody's too busy running to heed you."
...
?L6:	PRINTD NANNIES
	...
	EQUAL? PRSA,V?SEARCH \?L1
?L3:	PRINTI "The surrounding trees sway in the brisk "
	CALL1 SAY-WIND
	PRINT PERIOD
	RTRUE
?L1:	EQUAL? PRSA,V?LISTEN \?L4
	CALL1 CTHE-PRINT
	PRINTI " hiss and groan in the "
	CALL1 SAY-WIND
	PRINT PERIOD
	RTRUE
...
?L6:	ZERO? NOW-PRSI? \?L5
	PRINTI "Tree-climbing is strictly prohibited in the "
	PRINTD GARDENS
	PRINTI "; except for "
	PRINTD CHILDREN
	PRINTR ", of course."
...
?L6:	CALL NOUN-USED?,W?BATTERIES,W?BATTERY >STACK
	...
	PRINTI "access the "
	PRINTD LAMP
	PRINTR "'s batteries. They're sealed inside."
...
?L33:	PRINTD PRSO
	PRINTI " is more than a foot long. Its switch "
	CALL1 SWITCH-STATE
...
?L47:	EQUAL? PRSA,V?POINT-AT,V?SHINE-AT \FALSE
	...
	PRINTI " towards "
	CALL1 THEI-PRINT
	PRINTI ", but its dim beam reveals nothing "
	CALL2 PICK-NEXT,YAWNS >STACK
	PRINT STACK
	PRINT PERIOD
	RTRUE
?L50:	CALL1 CTHE-PRINT
	...
	.FUNCT LAMP-SEALED
	CALL2 CTHE-PRINT,LAMP
	PRINTR " is hermetically sealed. It can't be opened."
...
?L1:	PRINTI "off"
	...
	.FUNCT MUNG-LAMP
	FSET? LAMP,CHILLY \?L1
	PRINTI "This has little effect on the broken "
	PRINTD LAMP
	PRINT PERIOD
	RTRUE
?L1:	FSET LAMP,CHILLY
	...
	CALL2 ITALICIZE,STR?262
	PRINTI " and goes out."
	CRLF
	CALL1 KILL-LAMP
	RTRUE
?L4:	CALL2 ITALICIZE,STR?263
	CRLF
	RTRUE
...
?L1:	CALL2 CTHE-PRINT,LAMP
	PRINTR "'s switch is already off."

	.FUNCT TURN-ON-LAMP
	FSET? LAMP,SHADOWY \?L1
	CALL2 CTHE-PRINT,LAMP
	PRINTR "'s switch is already turned on."
...
?L4:	CALL QUEUE,I-HARDHAT,-1
	FSET LAMP,LIGHTED
	PRINTD LAMP
	PRINTI " emits a warm, yellow beam."
	CRLF
	ZERO? LIT? \TRUE
	SET 'LIT?,1
	SET 'OLD-HERE,0
...
?L1:	EQUAL? PRSA,V?EXAMINE,V?WATCH,V?LOOK-INSIDE \?L5
	...
	JUMP ?L8
?L6:	PRINTD TOWER
?L8:	PRINTR " in a raw white glare."
?L5:	EQUAL? PRSA,V?SEARCH,V?FOLLOW,V?FIND \FALSE
	EQUAL? HERE,IN-SHACK \?L10
	CALL1 CANT-FROM-HERE
	RTRUE
?L10:	CALL1 CTHE-PRINT
	PRINTI " seems to originate from a point on the southwest "
	PRINTD HORIZON
	PRINT PERIOD
	RTRUE
	...
	RTRUE
?L1:	EQUAL? PRSA,V?LISTEN \?L3
	PRINTR "You pause, listening intently."
?L3:	EQUAL? PRSA,V?WALK-TO,V?FOLLOW,V?FIND \FALSE
	...
	PRINTI "The explosion that created this "
	PRINTD PRSO
	PRINTR " seems to have obliterated all evidence of its cause."
...
?L4:	PRINTI "A cursory exploration of the "
	PRINTD PRSO
	PRINTR " turns up nothing but scorched rubble. You soon abandon your search and return to the paved road."
...
?L6:	PRINTI "The map shows a network of boxes connected by lines and arrows, with many erasures and scrawled additions. Something about the pattern is maddeningly familiar; but you "
	FSET? PRSO,SEEN \?L7
	PRINTI "still "
?L7:	PRINTI "can't put your finger on where you've seen it before."
	CRLF
	FSET? PRSO,SEEN /?L10
	FSET PRSO,SEEN
	JUMP ?L12
?L10:	EQUAL? OLDCNT,MAPCNT /?L12
	CRLF
	PRINTI "As you ponder over the map, you discover a number of hasty squiggles that you didn't notice the first time you looked."
	CRLF
...
?L5:	INTBL? PRSA,MOVEVERBS,NMVERBS >STACK \FALSE
	...
	EQUAL? CONTEXT,M-OBJDESC \FALSE
	PRINTI "The biggest book you've ever seen lies open on a "
	PRINTD PEDESTAL
	PRINTI " in the "
	PRINTD CORNER
	PRINTI "."
	...
	EQUAL? PRSA,V?EXAMINE,V?SEARCH \?L1
	CALL1 CTHE-PRINT
	PRINTR " sags under the weight of the heavy book."
...
?L3:	ZERO? NOW-PRSI? /FALSE
	EQUAL? PRSA,V?PUT,V?PUT-ON \FALSE
	PRINTI "The giant book completely covers the "
	PRINTD PRSI
	PRINT PERIOD
	RTRUE
...
?L3:	EQUAL? PRSA,V?EXAMINE \?L7
	PRINTI "The open book is so wide, it's impossible to touch both edges with your arms outstretched. Its thousands of "
	PRINTD PAGES
	PRINTR " form a two-foot heap on either side of the spine; the rich binding probably required the cooperation of twenty calves."
...
?L10:	CALL1 HANDLE-BOOK? >STACK
	...
	INTBL? PRSA,MOVEVERBS,NMVERBS >STACK \FALSE
?L14:	PRINTI "It'd take a dozen muscular librarians to budge "
	CALL2 ITALICIZE,STR?264
	PRINTR " volume."
...
?L11:	PRINTI "You flip aimlessly through the "
	PRINTD PRSO
	PRINT PERIOD
	RTRUE
...
?L12:	CALL1 HANDLE-BOOK? >STACK
	...
	.FUNCT AND-RUIN
	PRINTR "And ruin this magnificent volume? For shame."

	.FUNCT HANDLE-BOOK?
	ZERO? NOW-PRSI? \FALSE
	EQUAL? PRSA,V?TOUCH,V?KISS,V?SQUEEZE \?L3
	CALL2 CTHE-PRINT,PAGES
	PRINTR " feel smooth and creamy."
?L3:	EQUAL? PRSA,V?SMELL \?L4
	PRINTI "The dusty "
	PRINTD PAGES
...
?L5:	EQUAL? PRSA,V?CLOSE,V?FOLD \FALSE
	...
	PRINTD PRSO
	PRINTR " shut, but it's like trying to move a pallet of Cleveland telephone directories."

	.FUNCT READ-TOME
	INC 'STUDY
	PRINTI "It's hard to divine the purpose of the calligraphy. Every page begins with a descriptive heading ("""
	CALL2 PICK-NEXT,HEADINGS >STACK
	PRINT STACK
	PRINTI ","" for instance) followed by a list of imperatives (prayers? formulae?), each preceded by an arrow-shaped glyph.
...
?L9:	PRINTI "Book of Hours"
	EQUAL? STUDY,1 \?L15
	PRINTI ", and begins to study it"
?L15:	PRINTI "."" The last few incantations read:
...
?L5:	IGRTR? 'PTR,LEN \?L3
	...
	PRINTI "All that's left of the book and "
	PRINTD PEDESTAL
	PRINTI " is a "
	PRINTD CINDERS
	PRINTI "."
...
?L11:	PRINTI "You poke halfheartedly through the "
	PRINTD PRSO
	PRINTI ", but find nothing "
	CALL2 PICK-NEXT,YAWNS >STACK
	PRINT STACK
...
?L10:	EQUAL? PRSA,V?TOUCH,V?KISS,V?SQUEEZE \?L12
	PRINTR "The cinders feel cool and crisp."
?L12:	EQUAL? PRSA,V?KICK,V?HIT,V?BLOW-INTO \?L13
	PRINTR "Cinders scatter all over the place."
?L13:	EQUAL? PRSA,V?COUNT \?L14
	CALL1 IMPOSSIBLE
	RTRUE
?L14:	INTBL? PRSA,MOVEVERBS,NMVERBS >STACK \FALSE
	PRINTR "Cool, useless cinders fall between your fingers."
	...
	CALL1 VANISH
	CALL1 CTHE-PRINT
	PRINTR " slips down the drain and disappears."
?L1:	EQUAL? PRSA,V?EXAMINE,V?LOOK-ON,V?LOOK-INSIDE /?L7
	EQUAL? PRSA,V?SEARCH \?L6
?L7:	PRINTI "The porcelain is stained with big, disgusting patches of brown and green mildew"
	FIRST? PRSO >STACK \?L8
	PRINTI ". "
	PRINT YOU-SEE
	CALL2 PRINT-CONTENTS,PRSO
...
?L3:	CALL1 ENTERING? >STACK
	...
	EQUAL? PRSA,V?STAND-ON,V?LIE-DOWN \?L4
?L6:	CALL1 CTHE-PRINT
	PRINTR " isn't big enough for such nonsense."
?L4:	CALL1 EXITING? >STACK
	ZERO? STACK /?L7
	CALL NOT-IN,PRSO,1
	RTRUE
?L7:	INTBL? PRSA,MOVEVERBS,NMVERBS >STACK \FALSE
	...
	.FUNCT KNIFE-F
	EQUAL? PRSA,V?EXAMINE,V?LOOK-ON \FALSE
	PRINTR "The blade is still reasonably sharp."

	.FUNCT GIBINOS-F
	EQUAL? PRSA,V?EXAMINE \?L1
	CALL1 CTHE-PRINT
	PRINTR " are trained on the road leading south."
?L1:	INTBL? PRSA,TOUCHVERBS,NTOUCHES >STACK \FALSE
	CALL1 CANT-FROM-HERE
	RTRUE
...
?L1:	EQUAL? PRSA,V?EXAMINE \?L7
	CALL1 CTHE-PRINT
	PRINTI " looks like a drinking straw made of plywood, six feet square and miles long. Its purpose is obscure, but it probably connects the "
	PRINTD MIKE
	PRINTI " in the "
	PRINTD SCHOOL
	PRINTI " to some remote part of the "
	PRINTD LAGOON
	PRINT PERIOD
	RTRUE
...
?L12:	EQUAL? PRSA,V?LISTEN \FALSE
	...
	PRINTR "You hear the mutter of idling engines."
...
?L1:	CLEAR -1
	...
	PRINTI "Testing"
	CURSET 6,4
	PRINTI "Gary Brennan    Amy Briggs    Suzanne Frank    Max Buxton    Liz Cyr-Jones"
	CURSET 8,13
	PRINTI "Packaging"
	CURSET 8,33
	...
	PRINTI "Map & Crane"
	CURSET 14,53
	PRINTI "Production Coordinator"
	CURSET 15,9
	PRINTI "Geoff Hodgkinson       Meredith Lightbown        Angela Raup"
	CURSET 17,28
	PRINTI "Microcomputer Interpreters"
	CURSET 18,19
	PRINTI "Duncan Blanchard    Ed Black    Linde Simpson"
	CURSET 19,12
	PRINTI "Andy Kaluzniacki    Paul Gross    Mike Morton    Richard Lay"
	CURSET 21,18
	PRINTI "Interactive Fiction Plus(TM) Development System"
	CURSET 22,21
	PRINTI "Marc Blank    Dave Lebling    Stu Galley"
	SCREEN S-TEXT
	INPUT 1 >X
	CALL1 V-$0024REFRESH
	CALL1 V-LOOK
